...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["ProntSaude_____app_grid_sec_users_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["ProntSaude_____app_grid_sec_users_groups"]);
   }
