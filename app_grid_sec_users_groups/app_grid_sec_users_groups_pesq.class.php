...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_btns_grid_hint'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_sec_users'] ?></TITLE>
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_btns_grid_hint'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_sec_users'] ?></div>
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "ProntSaude/app_grid_sec_users_groups";
