<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['app_grid_sec_users_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["login"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["login"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["login"] : "" . $this->Nm_lang['lang_sec_users_fld_login'] . "";
   $tab_ger_campos['usrname'] = "on";
   $tab_def_campos['usrname'] = "usrname";
   $tab_labels["usrname"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["usrname"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["usrname"] : "" . $this->Nm_lang['lang_sec_users_fld_usrname'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["email"] : "" . $this->Nm_lang['lang_sec_users_fld_email'] . "";
   $tab_ger_campos['usractive'] = "on";
   $tab_def_campos['usractive'] = "usractive";
   $tab_labels["usractive"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["usractive"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["usractive"] : "" . $this->Nm_lang['lang_sec_users_fld_usractive'] . "";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_btns_grid_hint'] ?> - <?php echo $this->Nm_lang['lang_tbl_sec_users'] ?></TITLE>
