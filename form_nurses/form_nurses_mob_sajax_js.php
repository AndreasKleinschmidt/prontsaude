  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_nurses_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idnurse
  function do_ajax_form_nurses_mob_validate_idnurse()
  {
    var nomeCampo_idnurse = "idnurse";
    var var_idnurse = scAjaxGetFieldHidden(nomeCampo_idnurse);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_nurses_mob_validate_idnurse(var_idnurse, var_script_case_init, do_ajax_form_nurses_mob_validate_idnurse_cb);
  } // do_ajax_form_nurses_mob_validate_idnurse

  function do_ajax_form_nurses_mob_validate_idnurse_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_nurses_mob_validate_idnurse_cb

  // ---------- Validate namenurse
  function do_ajax_form_nurses_mob_validate_namenurse()
  {
    var nomeCampo_namenurse = "namenurse";
    var var_namenurse = scAjaxGetFieldText(nomeCampo_namenurse);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_nurses_mob_validate_namenurse(var_namenurse, var_script_case_init, do_ajax_form_nurses_mob_validate_namenurse_cb);
  } // do_ajax_form_nurses_mob_validate_namenurse

  function do_ajax_form_nurses_mob_validate_namenurse_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "namenurse";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_nurses_mob_validate_namenurse_cb

  // ---------- Validate login
  function do_ajax_form_nurses_mob_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldSelect(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_nurses_mob_validate_login(var_login, var_script_case_init, do_ajax_form_nurses_mob_validate_login_cb);
  } // do_ajax_form_nurses_mob_validate_login

  function do_ajax_form_nurses_mob_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_nurses_mob_validate_login_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_nurses_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_nurses_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idnurse = scAjaxGetFieldHidden("idnurse");
    var var_namenurse = scAjaxGetFieldText("namenurse");
    ...
    scAjaxProcOn();
    x_ajax_form_nurses_mob_submit_form(var_idnurse, var_namenurse, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_nurses_mob_submit_form_cb);
  } // do_ajax_form_nurses_mob_submit_form

  function do_ajax_form_nurses_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_nurses_mob_submit_form_cb_after_alert);
  } // do_ajax_form_nurses_mob_submit_form_cb
  function do_ajax_form_nurses_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_nurses_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_nurses_mob_navigate_form()
  {
    perform_ajax_form_nurses_mob_navigate_form();
  }

  function perform_ajax_form_nurses_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_idnurse = document.F2.idnurse.value;
    ...
    scAjaxProcOn();
    x_ajax_form_nurses_mob_navigate_form(var_idnurse, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_nurses_mob_navigate_form_cb);
  } // do_ajax_form_nurses_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_nurses_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_nurses_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.idnurse.value = scAjaxGetKeyValue("idnurse");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_nurses_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_nurses_mob_navigate_form_cb
  function do_ajax_form_nurses_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_nurses_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_nurses_mob_navigate_form_cb_after_alert

  function sc_hide_form_nurses_mob_form()
  {
  ...
  ajax_field_list[0] = "idnurse";
  ajax_field_list[1] = "namenurse";
  ...
  var ajax_error_list = {
    "idnurse": {"label": "<?php echo $this->Ini->Nm_lang['lang_nurses_fld_idnurse'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "namenurse": {"label": "<?php echo $this->Ini->Nm_lang['lang_nurses_fld_namenurse'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  ajax_field_mult["idnurse"][1] = "idnurse";
  ajax_field_mult["namenurse"][1] = "namenurse";
  ajax_field_mult["login"][1] = "login";

  var ajax_field_id = {
    "idnurse": new Array("hidden_field_label_idnurse", "hidden_field_data_idnurse"),
    "namenurse": new Array("hidden_field_label_namenurse", "hidden_field_data_namenurse"),
