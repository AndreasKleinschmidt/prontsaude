  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_nurses" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idnurse
  function do_ajax_form_nurses_validate_idnurse()
  {
    var nomeCampo_idnurse = "idnurse";
    var var_idnurse = scAjaxGetFieldHidden(nomeCampo_idnurse);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_nurses_validate_idnurse(var_idnurse, var_script_case_init, do_ajax_form_nurses_validate_idnurse_cb);
  } // do_ajax_form_nurses_validate_idnurse

  function do_ajax_form_nurses_validate_idnurse_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_nurses_validate_idnurse_cb

  // ---------- Validate namenurse
  function do_ajax_form_nurses_validate_namenurse()
  {
    var nomeCampo_namenurse = "namenurse";
    var var_namenurse = scAjaxGetFieldText(nomeCampo_namenurse);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_nurses_validate_namenurse(var_namenurse, var_script_case_init, do_ajax_form_nurses_validate_namenurse_cb);
  } // do_ajax_form_nurses_validate_namenurse

  function do_ajax_form_nurses_validate_namenurse_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_nurses_validate_namenurse_cb

  // ---------- Validate login
  function do_ajax_form_nurses_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldSelect(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_nurses_validate_login(var_login, var_script_case_init, do_ajax_form_nurses_validate_login_cb);
  } // do_ajax_form_nurses_validate_login

  function do_ajax_form_nurses_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_nurses_validate_login_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_nurses_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_nurses_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_nurses_submit_form(var_idnurse, var_namenurse, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_nurses_submit_form_cb);
  } // do_ajax_form_nurses_submit_form

  function do_ajax_form_nurses_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_nurses_submit_form_cb_after_alert);
  } // do_ajax_form_nurses_submit_form_cb
  function do_ajax_form_nurses_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_nurses_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_nurses_navigate_form()
  {
    perform_ajax_form_nurses_navigate_form();
  }

  function perform_ajax_form_nurses_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_nurses_navigate_form(var_idnurse, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_nurses_navigate_form_cb);
  } // do_ajax_form_nurses_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_nurses']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_nurses_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_nurses_navigate_form_cb_after_alert);
  } // do_ajax_form_nurses_navigate_form_cb
  function do_ajax_form_nurses_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_nurses_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_nurses_navigate_form_cb_after_alert

  function sc_hide_form_nurses_form()
  {
