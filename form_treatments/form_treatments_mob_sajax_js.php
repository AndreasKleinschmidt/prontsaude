  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_treatments_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_treatments_mob_form();
        }
...
?>
  ...
  // ---------- Validate idtreatments
  function do_ajax_form_treatments_mob_validate_idtreatments()
  {
    var nomeCampo_idtreatments = "idtreatments";
    var var_idtreatments = scAjaxGetFieldHidden(nomeCampo_idtreatments);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatments_mob_validate_idtreatments(var_idtreatments, var_script_case_init, do_ajax_form_treatments_mob_validate_idtreatments_cb);
  } // do_ajax_form_treatments_mob_validate_idtreatments

  function do_ajax_form_treatments_mob_validate_idtreatments_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idtreatments";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatments_mob_validate_idtreatments_cb

  // ---------- Validate treatments_descr
  function do_ajax_form_treatments_mob_validate_treatments_descr()
  {
    var nomeCampo_treatments_descr = "treatments_descr";
    var var_treatments_descr = scAjaxGetFieldText(nomeCampo_treatments_descr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatments_mob_validate_treatments_descr(var_treatments_descr, var_script_case_init, do_ajax_form_treatments_mob_validate_treatments_descr_cb);
  } // do_ajax_form_treatments_mob_validate_treatments_descr

  function do_ajax_form_treatments_mob_validate_treatments_descr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "treatments_descr";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatments_mob_validate_treatments_descr_cb

  // ---------- Validate treatments_descr_pt
  function do_ajax_form_treatments_mob_validate_treatments_descr_pt()
  {
    var nomeCampo_treatments_descr_pt = "treatments_descr_pt";
    var var_treatments_descr_pt = scAjaxGetFieldText(nomeCampo_treatments_descr_pt);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatments_mob_validate_treatments_descr_pt(var_treatments_descr_pt, var_script_case_init, do_ajax_form_treatments_mob_validate_treatments_descr_pt_cb);
  } // do_ajax_form_treatments_mob_validate_treatments_descr_pt

  function do_ajax_form_treatments_mob_validate_treatments_descr_pt_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "treatments_descr_pt";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatments_mob_validate_treatments_descr_pt_cb

  // ---------- Validate treatments_descr_es
  function do_ajax_form_treatments_mob_validate_treatments_descr_es()
  {
    var nomeCampo_treatments_descr_es = "treatments_descr_es";
    var var_treatments_descr_es = scAjaxGetFieldText(nomeCampo_treatments_descr_es);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatments_mob_validate_treatments_descr_es(var_treatments_descr_es, var_script_case_init, do_ajax_form_treatments_mob_validate_treatments_descr_es_cb);
  } // do_ajax_form_treatments_mob_validate_treatments_descr_es

  function do_ajax_form_treatments_mob_validate_treatments_descr_es_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "treatments_descr_es";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatments_mob_validate_treatments_descr_es_cb

  // ---------- Validate treatments_color
  function do_ajax_form_treatments_mob_validate_treatments_color()
  {
    var nomeCampo_treatments_color = "treatments_color";
    var var_treatments_color = scAjaxGetFieldText(nomeCampo_treatments_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatments_mob_validate_treatments_color(var_treatments_color, var_script_case_init, do_ajax_form_treatments_mob_validate_treatments_color_cb);
  } // do_ajax_form_treatments_mob_validate_treatments_color

  function do_ajax_form_treatments_mob_validate_treatments_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "treatments_color";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatments_mob_validate_treatments_color_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_treatments_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_treatments_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idtreatments = scAjaxGetFieldHidden("idtreatments");
    var var_treatments_descr = scAjaxGetFieldText("treatments_descr");
    var var_treatments_descr_pt = scAjaxGetFieldText("treatments_descr_pt");
    var var_treatments_descr_es = scAjaxGetFieldText("treatments_descr_es");
    var var_treatments_color = scAjaxGetFieldText("treatments_color");
    ...
    scAjaxProcOn();
    x_ajax_form_treatments_mob_submit_form(var_idtreatments, var_treatments_descr, var_treatments_descr_pt, var_treatments_descr_es, var_treatments_color, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_treatments_mob_submit_form_cb);
  } // do_ajax_form_treatments_mob_submit_form

  function do_ajax_form_treatments_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_treatments_mob_submit_form_cb_after_alert);
  } // do_ajax_form_treatments_mob_submit_form_cb
  function do_ajax_form_treatments_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_treatments_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_treatments_mob_navigate_form()
  {
    perform_ajax_form_treatments_mob_navigate_form();
  }

  function perform_ajax_form_treatments_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_idtreatments = document.F2.idtreatments.value;
    ...
    scAjaxProcOn();
    x_ajax_form_treatments_mob_navigate_form(var_idtreatments, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_treatments_mob_navigate_form_cb);
  } // do_ajax_form_treatments_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_treatments_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_treatments_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.idtreatments.value = scAjaxGetKeyValue("idtreatments");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_treatments_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_treatments_mob_navigate_form_cb
  function do_ajax_form_treatments_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_treatments_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_treatments_mob_navigate_form_cb_after_alert

  function sc_hide_form_treatments_mob_form()
  {
  ...
  ajax_field_list[0] = "idtreatments";
  ajax_field_list[1] = "treatments_descr";
  ajax_field_list[2] = "treatments_descr_pt";
  ajax_field_list[3] = "treatments_descr_es";
  ajax_field_list[4] = "treatments_color";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idtreatments": {"label": "<?php echo $this->Ini->Nm_lang['lang_treatments_fld_idtreatments'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "treatments_descr": {"label": "<?php echo $this->Ini->Nm_lang['lang_treatments_fld_treatments_descr'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "treatments_descr_pt": {"label": "<?php echo $this->Ini->Nm_lang['lang_treatments_fld_treatments_descr'] ?> pt", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "treatments_descr_es": {"label": "<?php echo $this->Ini->Nm_lang['lang_treatments_fld_treatments_descr'] ?> es", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "treatments_color": {"label": "<?php echo $this->Ini->Nm_lang['lang_treatments_fld_treatments_color'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "idtreatments": new Array(),
    "treatments_descr": new Array(),
    "treatments_descr_pt": new Array(),
    "treatments_descr_es": new Array(),
    "treatments_color": new Array()
  };
  ajax_field_mult["idtreatments"][1] = "idtreatments";
  ajax_field_mult["treatments_descr"][1] = "treatments_descr";
  ajax_field_mult["treatments_descr_pt"][1] = "treatments_descr_pt";
  ajax_field_mult["treatments_descr_es"][1] = "treatments_descr_es";
  ajax_field_mult["treatments_color"][1] = "treatments_color";

  var ajax_field_id = {
    "idtreatments": new Array("hidden_field_label_idtreatments", "hidden_field_data_idtreatments"),
    "treatments_descr": new Array("hidden_field_label_treatments_descr", "hidden_field_data_treatments_descr"),
    "treatments_descr_pt": new Array("hidden_field_label_treatments_descr_pt", "hidden_field_data_treatments_descr_pt"),
    "treatments_descr_es": new Array("hidden_field_label_treatments_descr_es", "hidden_field_data_treatments_descr_es"),
    "treatments_color": new Array("hidden_field_label_treatments_color", "hidden_field_data_treatments_color")
  };

  var ajax_read_only = {
    "idtreatments": "on",
    "treatments_descr": "off",
    "treatments_descr_pt": "off",
    "treatments_descr_es": "off",
    "treatments_color": "off"
  };
