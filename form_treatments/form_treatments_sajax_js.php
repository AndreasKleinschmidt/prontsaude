  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_treatments" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_treatments_validate_idtreatments()
  {
    var nomeCampo_idtreatments = "idtreatments";
    var var_idtreatments = scAjaxGetFieldHidden(nomeCampo_idtreatments);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatments_validate_idtreatments(var_idtreatments, var_script_case_init, do_ajax_form_treatments_validate_idtreatments_cb);
  } // do_ajax_form_treatments_validate_idtreatments

  function do_ajax_form_treatments_validate_idtreatments_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatments_validate_idtreatments_cb

  // ---------- Validate treatments_descr
  function do_ajax_form_treatments_validate_treatments_descr()
  {
    var nomeCampo_treatments_descr = "treatments_descr";
    var var_treatments_descr = scAjaxGetFieldText(nomeCampo_treatments_descr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatments_validate_treatments_descr(var_treatments_descr, var_script_case_init, do_ajax_form_treatments_validate_treatments_descr_cb);
  } // do_ajax_form_treatments_validate_treatments_descr

  function do_ajax_form_treatments_validate_treatments_descr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatments_validate_treatments_descr_cb

  // ---------- Validate treatments_descr_pt
  function do_ajax_form_treatments_validate_treatments_descr_pt()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatments_validate_treatments_descr_pt(var_treatments_descr_pt, var_script_case_init, do_ajax_form_treatments_validate_treatments_descr_pt_cb);
  } // do_ajax_form_treatments_validate_treatments_descr_pt

  function do_ajax_form_treatments_validate_treatments_descr_pt_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatments_validate_treatments_descr_pt_cb

  // ---------- Validate treatments_descr_es
  function do_ajax_form_treatments_validate_treatments_descr_es()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatments_validate_treatments_descr_es(var_treatments_descr_es, var_script_case_init, do_ajax_form_treatments_validate_treatments_descr_es_cb);
  } // do_ajax_form_treatments_validate_treatments_descr_es

  function do_ajax_form_treatments_validate_treatments_descr_es_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatments_validate_treatments_descr_es_cb

  // ---------- Validate treatments_color
  function do_ajax_form_treatments_validate_treatments_color()
  {
    var nomeCampo_treatments_color = "treatments_color";
    var var_treatments_color = scAjaxGetFieldText(nomeCampo_treatments_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_treatments_validate_treatments_color(var_treatments_color, var_script_case_init, do_ajax_form_treatments_validate_treatments_color_cb);
  } // do_ajax_form_treatments_validate_treatments_color

  function do_ajax_form_treatments_validate_treatments_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_treatments_validate_treatments_color_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_treatments_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_treatments_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_treatments_submit_form(var_idtreatments, var_treatments_descr, var_treatments_descr_pt, var_treatments_descr_es, var_treatments_color, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_treatments_submit_form_cb);
  } // do_ajax_form_treatments_submit_form

  function do_ajax_form_treatments_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_treatments_submit_form_cb_after_alert);
  } // do_ajax_form_treatments_submit_form_cb
  function do_ajax_form_treatments_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_treatments_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_treatments_navigate_form()
  {
    perform_ajax_form_treatments_navigate_form();
  }

  function perform_ajax_form_treatments_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_treatments_navigate_form(var_idtreatments, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_treatments_navigate_form_cb);
  } // do_ajax_form_treatments_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_treatments']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_treatments_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_treatments_navigate_form_cb_after_alert);
  } // do_ajax_form_treatments_navigate_form_cb
  function do_ajax_form_treatments_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_treatments_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_treatments_navigate_form_cb_after_alert

  function sc_hide_form_treatments_form()
  {
