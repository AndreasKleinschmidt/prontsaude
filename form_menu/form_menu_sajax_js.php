...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scAjaxElementDisplay(sElement, sAction)
  {
    ...
    if (document.getElementById(sElement))
    {
      ...
      {
        $('#' + sElement).show();
        $('#' + sElement).css('display', 'inline-block');
      }
      if (document.getElementById(sElement + "_dumb"))
      {
        ...
        {
          $('#' + sElement + "_dumb").show();
          $('#' + sElement + "_dumb").css('display', 'inline-block');
        }
        else
        {
          $('#' + sElement + "_dumb").hide();
...
?>
  ...
  // ---------- Validate id_
  function do_ajax_form_menu_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_menu_validate_id__cb);
  } // do_ajax_form_menu_validate_id_

  function do_ajax_form_menu_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_validate_id__cb

  // ---------- Validate parent_
  function do_ajax_form_menu_validate_parent_(iNumLinha)
  {
    var nomeCampo_parent_ = "parent_" + iNumLinha;
    var var_parent_ = scAjaxGetFieldText(nomeCampo_parent_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_validate_parent_(var_parent_, iNumLinha, var_script_case_init, do_ajax_form_menu_validate_parent__cb);
  } // do_ajax_form_menu_validate_parent_

  function do_ajax_form_menu_validate_parent__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "parent_" + iLineNumber;
    }
    else
    {
      sFieldValid = "parent_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_validate_parent__cb

  // ---------- Validate link_
  function do_ajax_form_menu_validate_link_(iNumLinha)
  {
    var nomeCampo_link_ = "link_" + iNumLinha;
    var var_link_ = scAjaxGetFieldText(nomeCampo_link_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_validate_link_(var_link_, iNumLinha, var_script_case_init, do_ajax_form_menu_validate_link__cb);
  } // do_ajax_form_menu_validate_link_

  function do_ajax_form_menu_validate_link__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_validate_link__cb

  // ---------- Validate link_params_
  function do_ajax_form_menu_validate_link_params_(iNumLinha)
  {
    var nomeCampo_link_params_ = "link_params_" + iNumLinha;
    var var_link_params_ = scAjaxGetFieldText(nomeCampo_link_params_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_validate_link_params_(var_link_params_, iNumLinha, var_script_case_init, do_ajax_form_menu_validate_link_params__cb);
  } // do_ajax_form_menu_validate_link_params_

  function do_ajax_form_menu_validate_link_params__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "link_params_" + iLineNumber;
    }
    else
    {
      sFieldValid = "link_params_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_validate_link_params__cb

  // ---------- Validate description_
  function do_ajax_form_menu_validate_description_(iNumLinha)
  {
    var nomeCampo_description_ = "description_" + iNumLinha;
    var var_description_ = scAjaxGetFieldText(nomeCampo_description_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_validate_description_(var_description_, iNumLinha, var_script_case_init, do_ajax_form_menu_validate_description__cb);
  } // do_ajax_form_menu_validate_description_

  function do_ajax_form_menu_validate_description__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_validate_description__cb

  // ---------- Validate description_pt_br_
  function do_ajax_form_menu_validate_description_pt_br_(iNumLinha)
  {
    var nomeCampo_description_pt_br_ = "description_pt_br_" + iNumLinha;
    var var_description_pt_br_ = scAjaxGetFieldText(nomeCampo_description_pt_br_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_validate_description_pt_br_(var_description_pt_br_, iNumLinha, var_script_case_init, do_ajax_form_menu_validate_description_pt_br__cb);
  } // do_ajax_form_menu_validate_description_pt_br_

  function do_ajax_form_menu_validate_description_pt_br__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "description_pt_br_" + iLineNumber;
    }
    else
    {
      sFieldValid = "description_pt_br_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_validate_description_pt_br__cb

  // ---------- Validate description_es_
  function do_ajax_form_menu_validate_description_es_(iNumLinha)
  {
    var nomeCampo_description_es_ = "description_es_" + iNumLinha;
    var var_description_es_ = scAjaxGetFieldText(nomeCampo_description_es_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_validate_description_es_(var_description_es_, iNumLinha, var_script_case_init, do_ajax_form_menu_validate_description_es__cb);
  } // do_ajax_form_menu_validate_description_es_

  function do_ajax_form_menu_validate_description_es__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "description_es_" + iLineNumber;
    }
    else
    {
      sFieldValid = "description_es_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_validate_description_es__cb

  // ---------- Validate node_order_
  function do_ajax_form_menu_validate_node_order_(iNumLinha)
  {
    var nomeCampo_node_order_ = "node_order_" + iNumLinha;
    var var_node_order_ = scAjaxGetFieldText(nomeCampo_node_order_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_validate_node_order_(var_node_order_, iNumLinha, var_script_case_init, do_ajax_form_menu_validate_node_order__cb);
  } // do_ajax_form_menu_validate_node_order_

  function do_ajax_form_menu_validate_node_order__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "node_order_" + iLineNumber;
    }
    else
    {
      sFieldValid = "node_order_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_validate_node_order__cb

  // ---------- Validate is_active_
  function do_ajax_form_menu_validate_is_active_(iNumLinha)
  {
    var nomeCampo_is_active_ = "is_active_" + iNumLinha;
    var var_is_active_ = scAjaxGetFieldCheckbox(nomeCampo_is_active_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_validate_is_active_(var_is_active_, iNumLinha, var_script_case_init, do_ajax_form_menu_validate_is_active__cb);
  } // do_ajax_form_menu_validate_is_active_

  function do_ajax_form_menu_validate_is_active__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "is_active_" + iLineNumber;
    }
    else
    {
      sFieldValid = "is_active_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_validate_is_active__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_menu_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_menu_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_menu_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_menu_add_new_line_cb);
  } // do_ajax_form_menu_add_new_line

  function do_ajax_form_menu_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_menu_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_menu_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_menu_backup_line_cb);
  } // do_ajax_form_menu_backup_line

  function do_ajax_form_menu_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_menu_backup_line_cb

  function do_ajax_form_menu_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_menu_cancel_insert

  function do_ajax_form_menu_cancel_update(iSeqVert)
  {
    do_ajax_form_menu_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_menu_cancel_update

  function do_ajax_form_menu_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_menu_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_menu_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_menu_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_menu_table_refresh_cb);
  } //  do_ajax_form_menu_table_refresh

  function do_ajax_form_menu_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_menu_table_refresh_cb_after_alert);
  } // do_ajax_form_menu_table_refresh_cb
  function do_ajax_form_menu_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_menu_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_menu_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_menu_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_parent_ = scAjaxGetFieldText("parent_" + iNumLinha);
    var var_link_ = scAjaxGetFieldText("link_" + iNumLinha);
    var var_link_params_ = scAjaxGetFieldText("link_params_" + iNumLinha);
    var var_description_ = scAjaxGetFieldText("description_" + iNumLinha);
    var var_description_pt_br_ = scAjaxGetFieldText("description_pt_br_" + iNumLinha);
    var var_description_es_ = scAjaxGetFieldText("description_es_" + iNumLinha);
    var var_node_order_ = scAjaxGetFieldText("node_order_" + iNumLinha);
    var var_is_active_ = scAjaxGetFieldCheckbox("is_active_" + iNumLinha, ";");
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_menu_submit_form(var_id_, var_parent_, var_link_, var_link_params_, var_description_, var_description_pt_br_, var_description_es_, var_node_order_, var_is_active_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_menu_submit_form_cb);
  } // do_ajax_form_menu_submit_form

  function do_ajax_form_menu_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_menu_submit_form_cb_after_alert);
  } // do_ajax_form_menu_submit_form_cb
  function do_ajax_form_menu_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_menu_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_menu_navigate_form()
  {
    perform_ajax_form_menu_navigate_form();
  }

  function perform_ajax_form_menu_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_menu_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_menu_navigate_form_cb);
  } // do_ajax_form_menu_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_menu']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_menu_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxClearErrors()
    scResetFormChanges()
    $("#sc-ui-checkbox-is_active_-control").prop("checked", false);
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_menu_navigate_form_cb_after_alert);
  } // do_ajax_form_menu_navigate_form_cb
  function do_ajax_form_menu_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_menu_navigate_form_cb_after_alert

    function sc_form_menu_get_last_line_number()
    {
    ...
    } //sc_form_menu_get_last_line_number

  function sc_hide_form_menu_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "parent_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "link_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "link_params_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "description_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "description_pt_br_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "description_es_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "node_order_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "is_active_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_menu_fld_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["parent_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_menu_fld_parent'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["link_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_menu_fld_link'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["link_params_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_menu_fld_link_params'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["description_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_menu_fld_description'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["description_pt_br_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_menu_fld_description_pt_br'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["description_es_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_menu_fld_description_es'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["node_order_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_menu_fld_node_order'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["is_active_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_menu_fld_is_active'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["parent_"][iNumLinha] = "parent_" + iNumLinha;
    ajax_field_mult["link_"][iNumLinha] = "link_" + iNumLinha;
    ajax_field_mult["link_params_"][iNumLinha] = "link_params_" + iNumLinha;
    ajax_field_mult["description_"][iNumLinha] = "description_" + iNumLinha;
    ajax_field_mult["description_pt_br_"][iNumLinha] = "description_pt_br_" + iNumLinha;
    ajax_field_mult["description_es_"][iNumLinha] = "description_es_" + iNumLinha;
    ajax_field_mult["node_order_"][iNumLinha] = "node_order_" + iNumLinha;
    ajax_field_mult["is_active_"][iNumLinha] = "is_active_" + iNumLinha;
    ajax_field_id["id_" + iNumLinha] = new Array("hidden_field_label_id_", "hidden_field_data_id_" + iNumLinha);
    ajax_field_id["parent_" + iNumLinha] = new Array("hidden_field_label_parent_", "hidden_field_data_parent_" + iNumLinha);
    ajax_field_id["link_" + iNumLinha] = new Array("hidden_field_label_link_", "hidden_field_data_link_" + iNumLinha);
    ajax_field_id["link_params_" + iNumLinha] = new Array("hidden_field_label_link_params_", "hidden_field_data_link_params_" + iNumLinha);
    ajax_field_id["description_" + iNumLinha] = new Array("hidden_field_label_description_", "hidden_field_data_description_" + iNumLinha);
    ajax_field_id["description_pt_br_" + iNumLinha] = new Array("hidden_field_label_description_pt_br_", "hidden_field_data_description_pt_br_" + iNumLinha);
    ajax_field_id["description_es_" + iNumLinha] = new Array("hidden_field_label_description_es_", "hidden_field_data_description_es_" + iNumLinha);
    ajax_field_id["node_order_" + iNumLinha] = new Array("hidden_field_label_node_order_", "hidden_field_data_node_order_" + iNumLinha);
    ajax_field_id["is_active_" + iNumLinha] = new Array("hidden_field_label_is_active_", "hidden_field_data_is_active_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["parent_" + iNumLinha] = "off";
    ajax_error_count["link_" + iNumLinha] = "off";
    ajax_error_count["link_params_" + iNumLinha] = "off";
    ajax_error_count["description_" + iNumLinha] = "off";
    ajax_error_count["description_pt_br_" + iNumLinha] = "off";
    ajax_error_count["description_es_" + iNumLinha] = "off";
    ajax_error_count["node_order_" + iNumLinha] = "off";
    ajax_error_count["is_active_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["parent_" + iNumLinha] = "off";
    ajax_read_only["link_" + iNumLinha] = "off";
    ajax_read_only["link_params_" + iNumLinha] = "off";
    ajax_read_only["description_" + iNumLinha] = "off";
    ajax_read_only["description_pt_br_" + iNumLinha] = "off";
    ajax_read_only["description_es_" + iNumLinha] = "off";
    ajax_read_only["node_order_" + iNumLinha] = "off";
    ajax_read_only["is_active_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["parent_" + iNumLinha] = "on";
    ajax_read_only["link_" + iNumLinha] = "on";
    ajax_read_only["link_params_" + iNumLinha] = "on";
    ajax_read_only["description_" + iNumLinha] = "on";
    ajax_read_only["description_pt_br_" + iNumLinha] = "on";
    ajax_read_only["description_es_" + iNumLinha] = "on";
    ajax_read_only["node_order_" + iNumLinha] = "on";
    ajax_read_only["is_active_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["parent_" + iNumLinha] = null;
    ajax_error_list["link_" + iNumLinha] = null;
    ajax_error_list["link_params_" + iNumLinha] = null;
    ajax_error_list["description_" + iNumLinha] = null;
    ajax_error_list["description_pt_br_" + iNumLinha] = null;
    ajax_error_list["description_es_" + iNumLinha] = null;
    ajax_error_list["node_order_" + iNumLinha] = null;
    ajax_error_list["is_active_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "parent_": new Array(),
    "link_": new Array(),
    "link_params_": new Array(),
    "description_": new Array(),
    "description_pt_br_": new Array(),
    "description_es_": new Array(),
    "node_order_": new Array(),
    "is_active_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["parent_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["parent_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["parent_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["parent_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["parent_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["link_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["link_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["link_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["link_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["link_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["link_params_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["link_params_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["link_params_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["link_params_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["link_params_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["description_pt_br_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["description_pt_br_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["description_pt_br_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["description_pt_br_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["description_pt_br_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["description_es_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["description_es_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["description_es_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["description_es_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["description_es_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["node_order_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["node_order_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["node_order_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["node_order_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["node_order_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["is_active_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["is_active_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["is_active_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["is_active_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["is_active_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['parent_'])) ? $this->nmgp_cmp_readonly['parent_'] : 'off';
?>
    scAjaxFieldRead("parent_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['link_'])) ? $this->nmgp_cmp_readonly['link_'] : 'off';
?>
    scAjaxFieldRead("link_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['link_params_'])) ? $this->nmgp_cmp_readonly['link_params_'] : 'off';
?>
    scAjaxFieldRead("link_params_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['description_pt_br_'])) ? $this->nmgp_cmp_readonly['description_pt_br_'] : 'off';
?>
    scAjaxFieldRead("description_pt_br_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['description_es_'])) ? $this->nmgp_cmp_readonly['description_es_'] : 'off';
?>
    scAjaxFieldRead("description_es_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['node_order_'])) ? $this->nmgp_cmp_readonly['node_order_'] : 'off';
?>
    scAjaxFieldRead("node_order_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['is_active_'])) ? $this->nmgp_cmp_readonly['is_active_'] : 'off';
?>
    scAjaxFieldRead("is_active_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_" + iSeq, "on");
    scAjaxFieldRead("parent_" + iSeq, "on");
    scAjaxFieldRead("link_" + iSeq, "on");
    scAjaxFieldRead("link_params_" + iSeq, "on");
    scAjaxFieldRead("description_" + iSeq, "on");
    scAjaxFieldRead("description_pt_br_" + iSeq, "on");
    scAjaxFieldRead("description_es_" + iSeq, "on");
    scAjaxFieldRead("node_order_" + iSeq, "on");
    scAjaxFieldRead("is_active_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["parent_" + iRow] || "on" == ajax_error_count["link_" + iRow] || "on" == ajax_error_count["link_params_" + iRow] || "on" == ajax_error_count["description_" + iRow] || "on" == ajax_error_count["description_pt_br_" + iRow] || "on" == ajax_error_count["description_es_" + iRow] || "on" == ajax_error_count["node_order_" + iRow] || "on" == ajax_error_count["is_active_" + iRow]))
    {
      ...
      $("#hidden_field_data_parent_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_link_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_link_params_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_description_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_description_pt_br_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_description_es_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_node_order_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_is_active_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["parent_" + iRow] && "off" == ajax_error_count["link_" + iRow] && "off" == ajax_error_count["link_params_" + iRow] && "off" == ajax_error_count["description_" + iRow] && "off" == ajax_error_count["description_pt_br_" + iRow] && "off" == ajax_error_count["description_es_" + iRow] && "off" == ajax_error_count["node_order_" + iRow] && "off" == ajax_error_count["is_active_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["parent_" + iRow] = "off";
        ajax_error_count["link_" + iRow] = "off";
        ajax_error_count["link_params_" + iRow] = "off";
        ajax_error_count["description_" + iRow] = "off";
        ajax_error_count["description_pt_br_" + iRow] = "off";
        ajax_error_count["description_es_" + iRow] = "off";
        ajax_error_count["node_order_" + iRow] = "off";
        ajax_error_count["is_active_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_parent_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_link_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_link_params_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_description_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_description_pt_br_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_description_es_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_node_order_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_is_active_" + iRow).removeClass("scFormErrorLine");
    }
  }
