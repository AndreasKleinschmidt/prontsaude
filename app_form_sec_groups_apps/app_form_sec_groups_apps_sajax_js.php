...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_error_list["app_name_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_groups_apps_fld_app_name'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["priv_access_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_access'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["priv_insert_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_insert'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["priv_delete_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_delete'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["priv_update_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_update'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["priv_export_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_export'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["priv_print_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_groups_apps_fld_priv_print'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
