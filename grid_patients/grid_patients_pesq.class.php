...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_patient_name')
      {
          $patient_name = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_patient_name($patient_name);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_patient_name($patient_name)
   {
      $patient_name = substr($this->Db->qstr($patient_name), 1, -1);
            $patient_name_look = (is_string($patient_name) ? substr($this->Db->qstr($patient_name), 1, -1) : $patient_name); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct patient_name from " . $this->Ini->nm_tabela . " where  patient_name like '%" . $patient_name . "%' order by patient_name"; 
      unset($cmp1,$cmp2);
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_tbl_patients'] ?></TITLE>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_patient_name_cond#NMF#' + search_get_sel_txt('SC_patient_name_cond') + '@NMF@';
  str_out += 'SC_patient_name#NMF#' + search_get_text('SC_patient_name') + '@NMF@';
  str_out += 'id_ac_patient_name#NMF#' + search_get_title('select2-id_ac_patient_name-container') + '@NMF@';
  str_out += 'SC_patient_gender_cond#NMF#' + search_get_sel_txt('SC_patient_gender_cond') + '@NMF@';
  str_out += 'SC_patient_gender#NMF#' + search_get_select('SC_patient_gender') + '@NMF@';
  str_out += 'SC_patient_blood_cond#NMF#' + search_get_sel_txt('SC_patient_blood_cond') + '@NMF@';
  str_out += 'SC_patient_blood#NMF#' + search_get_checkbox('SC_patient_blood') + '@NMF@';
  str_out += 'SC_patient_birthdate_cond#NMF#' + search_get_sel_txt('SC_patient_birthdate_cond') + '@NMF@';
  str_out += 'SC_patient_birthdate_dia#NMF#' + search_get_sel_txt('SC_patient_birthdate_dia') + '@NMF@';
  str_out += 'SC_patient_birthdate_mes#NMF#' + search_get_sel_txt('SC_patient_birthdate_mes') + '@NMF@';
  str_out += 'SC_patient_birthdate_ano#NMF#' + search_get_sel_txt('SC_patient_birthdate_ano') + '@NMF@';
  str_out += 'SC_patient_birthdate_input_2_dia#NMF#' + search_get_sel_txt('SC_patient_birthdate_input_2_dia') + '@NMF@';
  str_out += 'SC_patient_birthdate_input_2_mes#NMF#' + search_get_sel_txt('SC_patient_birthdate_input_2_mes') + '@NMF@';
  str_out += 'SC_patient_birthdate_input_2_ano#NMF#' + search_get_sel_txt('SC_patient_birthdate_input_2_ano') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-patient_name").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_patient_name",
      max_itens: "10",
   ...
   $("#SC_patient_name").val(e.params.data.id);
  });
 });
</script>
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_tbl_patients'] ?></div>
...
<?php
   ...
   {
      global 
             $patient_name_cond, $patient_name, $patient_name_autocomp,
             $patient_gender_cond, $patient_gender,
             $patient_blood_cond, $patient_blood,
             $patient_birthdate_cond, $patient_birthdate, $patient_birthdate_dia, $patient_birthdate_mes, $patient_birthdate_ano, $patient_birthdate_input_2_dia, $patient_birthdate_input_2_mes, $patient_birthdate_input_2_ano,
      ...
      $this->New_label['idpatient'] = "" . $this->Ini->Nm_lang['lang_patients_fld_idpatient'] . "";
      $this->New_label['patient_phone'] = "" . $this->Ini->Nm_lang['lang_patients_fld_patient_phone'] . "";
      $this->New_label['patient_email'] = "" . $this->Ini->Nm_lang['lang_patients_fld_patient_email'] . "";
      $this->New_label['patient_address'] = "" . $this->Ini->Nm_lang['lang_patients_fld_patient_address'] . "";
      ...
      { 
          ...
          $patient_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_name']; 
          $patient_name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_name_cond']; 
          $patient_gender = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_gender']; 
          $patient_gender_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_gender_cond']; 
          $patient_blood = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_blood']; 
          $patient_blood_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_blood_cond']; 
          $patient_birthdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_dia']; 
          $patient_birthdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_mes']; 
          $patient_birthdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_ano']; 
          $patient_birthdate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_input_2_dia']; 
          $patient_birthdate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_input_2_mes']; 
          $patient_birthdate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_input_2_ano']; 
          $patient_birthdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['NM_operador']; 
      } 
      if (!isset($patient_name_cond) || empty($patient_name_cond))
      {
         $patient_name_cond = "qp";
      }
      if (!isset($patient_gender_cond) || empty($patient_gender_cond))
      {
         $patient_gender_cond = "eq";
      }
      if (!isset($patient_blood_cond) || empty($patient_blood_cond))
      {
         $patient_blood_cond = "qp";
      }
      if (!isset($patient_birthdate_cond) || empty($patient_birthdate_cond))
      {
         $patient_birthdate_cond = "eq";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_patient_name = (in_array($patient_name_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_patient_gender = (in_array($patient_gender_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_patient_blood = (in_array($patient_blood_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_patient_birthdate = (in_array($patient_birthdate_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_patient_name = ('bw' == $patient_name_cond) ? $display_aberto : $display_fechado;
      $str_display_patient_gender = ('bw' == $patient_gender_cond) ? $display_aberto : $display_fechado;
      $str_display_patient_blood = ('bw' == $patient_blood_cond) ? $display_aberto : $display_fechado;
      $str_display_patient_birthdate = ('bw' == $patient_birthdate_cond) ? $display_aberto : $display_fechado;

      // patient_blood
      if (is_array($patient_blood) && !empty($patient_blood))
      {
         $tmp_array = array();
         $patient_blood_val_str = "";
         foreach ($patient_blood as $tmp_val_cmp)
         {
            if ("" != $patient_blood_val_str)
            {
               $patient_blood_val_str .= ",";
            }
            ...
            $patient_blood_val_str .= "'$tmp_val_cmp'";
         }
         $patient_blood = $tmp_array;
      }
      else
      {
         $patient_blood_val_str = "''";
      }
      if (!isset($patient_name) || $patient_name == "")
      {
          $patient_name = "";
      }
      if (isset($patient_name) && !empty($patient_name))
      {
         $tmp_pos = (is_string($patient_name)) ? strpos($patient_name, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $patient_name = substr($patient_name, 0, $tmp_pos);
         }
      }
      if (!isset($patient_gender) || $patient_gender == "")
      {
          $patient_gender = "";
      }
      if (isset($patient_gender) && !empty($patient_gender))
      {
         $tmp_pos = (is_string($patient_gender)) ? strpos($patient_gender, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $patient_gender = substr($patient_gender, 0, $tmp_pos);
         }
      }
      if (!isset($patient_blood) || $patient_blood == "")
      {
          $patient_blood = array();
      }
      if (!isset($patient_birthdate) || $patient_birthdate == "")
      {
          $patient_birthdate = "";
      }
      if (isset($patient_birthdate) && !empty($patient_birthdate))
      {
         $tmp_pos = (is_string($patient_birthdate)) ? strpos($patient_birthdate, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $patient_birthdate = substr($patient_birthdate, 0, $tmp_pos);
         }
      }
?>
 <?php
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_patient_name_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['patient_name'])) ? $this->New_label['patient_name'] : "" . $this->Ini->Nm_lang['lang_patients_fld_patient_name'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_patient_name_cond" name="patient_name_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_patient_name" <?php echo $str_hide_patient_name?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['patient_name'])) ? $this->New_label['patient_name'] : "" . $this->Ini->Nm_lang['lang_patients_fld_patient_name'] . "";
 $nmgp_tab_label .= "patient_name?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $patient_name_look = (is_string($patient_name) ? substr($this->Db->qstr($patient_name), 1, -1) : $patient_name); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct patient_name from " . $this->Ini->nm_tabela . " where patient_name = '$patient_name_look' order by patient_name"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$patient_name]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$patient_name];
      }
      else
      {
          $sAutocompValue = $patient_name;
      }
?>
<INPUT  type="text" id="SC_patient_name" name="patient_name" value="<?php echo NM_encode_input($patient_name) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-patient_name" id="id_ac_patient_name" name="patient_name_autocomp"><?php if ('' !=  $patient_name) { ?><option value="<?php echo $patient_name ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_patient_gender_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['patient_gender'])) ? $this->New_label['patient_gender'] : "" . $this->Ini->Nm_lang['lang_patients_fld_patient_gender'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_patient_gender_cond" name="patient_gender_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_patient_gender" <?php echo $str_hide_patient_gender?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['patient_gender'])) ? $this->New_label['patient_gender'] : "" . $this->Ini->Nm_lang['lang_patients_fld_patient_gender'] . "";
 $nmgp_tab_label .= "patient_gender?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_gender'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_gender'][] = "M";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_gender'][] = "F";
 ?>

 <SELECT class="scFilterObjectEven" id="SC_patient_gender"  name="patient_gender"  size="1">
 <OPTION value=""></option>
 <OPTION value="M##@@<?php echo $this->Ini->Nm_lang['lang_male'] ?>"<?php if ($patient_gender == "M") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_male'] ?></option>
 <OPTION value="F##@@<?php echo $this->Ini->Nm_lang['lang_female'] ?>"<?php if ($patient_gender == "F") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_female'] ?></option>
 </SELECT>
      ...
      <TD id='SC_patient_blood_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['patient_blood'])) ? $this->New_label['patient_blood'] : "" . $this->Ini->Nm_lang['lang_patients_fld_patient_blood'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_patient_blood_cond" name="patient_blood_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_patient_blood" <?php echo $str_hide_patient_blood?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['patient_blood'])) ? $this->New_label['patient_blood'] : "" . $this->Ini->Nm_lang['lang_patients_fld_patient_blood'] . "";
 $nmgp_tab_label .= "patient_blood?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  if (!isset($patient_blood)) {$patient_blood = explode(";", $patient_blood);}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_blood'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_blood'][] = "A-";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_blood'][] = "A+";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_blood'][] = "B-";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_blood'][] = "B+";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_blood'][] = "AB-";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_blood'][] = "AB+";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_blood'][] = "O-";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_blood'][] = "O+";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px; border-spacing: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_patient_blood" name="patient_blood[]" value="A-##@@A-"  <?php if (in_array("A-", $patient_blood))  { echo " checked" ;} ?>>A-</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_patient_blood" name="patient_blood[]" value="A+##@@A+"  <?php if (in_array("A+", $patient_blood))  { echo " checked" ;} ?>>A+</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_patient_blood" name="patient_blood[]" value="B-##@@B-"  <?php if (in_array("B-", $patient_blood))  { echo " checked" ;} ?>>B-</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_patient_blood" name="patient_blood[]" value="B+##@@B+"  <?php if (in_array("B+", $patient_blood))  { echo " checked" ;} ?>>B+</TD>
</TR>
<TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_patient_blood" name="patient_blood[]" value="AB-##@@AB-"  <?php if (in_array("AB-", $patient_blood))  { echo " checked" ;} ?>>AB-</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_patient_blood" name="patient_blood[]" value="AB+##@@AB+"  <?php if (in_array("AB+", $patient_blood))  { echo " checked" ;} ?>>AB+</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_patient_blood" name="patient_blood[]" value="O-##@@O-"  <?php if (in_array("O-", $patient_blood))  { echo " checked" ;} ?>>O-</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_patient_blood" name="patient_blood[]" value="O+##@@O+"  <?php if (in_array("O+", $patient_blood))  { echo " checked" ;} ?>>O+</TD>
</TR><TR>
 <TD colspan=4>
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_all.gif" ALIGN="absmiddle" onClick="nm_marca_check('patient_blood', 'N'); return false;" style="cursor: pointer">&nbsp;
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('patient_blood', 'N'); return false;" style="cursor: pointer">
 </TD>
</TR></TABLE>
      ...
      <TD id='SC_patient_birthdate_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['patient_birthdate'])) ? $this->New_label['patient_birthdate'] : "" . $this->Ini->Nm_lang['lang_patients_fld_patient_birthdate'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_patient_birthdate_cond" name="patient_birthdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_patient_birthdate'), this, 'patient_birthdate')">
       <OPTION value="eq" <?php if ("eq" == $patient_birthdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $patient_birthdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $patient_birthdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $patient_birthdate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_patient_birthdate" <?php echo $str_hide_patient_birthdate?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['patient_birthdate'])) ? $this->New_label['patient_birthdate'] : "" . $this->Ini->Nm_lang['lang_patients_fld_patient_birthdate'] . "";
 $nmgp_tab_label .= "patient_birthdate?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_patient_birthdate_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_patient_birthdate_dia" name="patient_birthdate_dia" value="<?php echo NM_encode_input($patient_birthdate_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
...
<?php
  ...
  {
?>
<span id='id_date_part_patient_birthdate_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_patient_birthdate_mes" name="patient_birthdate_mes" value="<?php echo NM_encode_input($patient_birthdate_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_patient_birthdate_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_patient_birthdate_ano" name="patient_birthdate_ano" value="<?php echo NM_encode_input($patient_birthdate_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
       ...
       <TR valign="top">
        <TD id="id_vis_patient_birthdate"  <?php echo $str_display_patient_birthdate; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<span id='id_date_part_patient_birthdate_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_patient_birthdate_input_2_dia" name="patient_birthdate_input_2_dia" value="<?php echo NM_encode_input($patient_birthdate_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_patient_birthdate_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_patient_birthdate_input_2_mes" name="patient_birthdate_input_2_mes" value="<?php echo NM_encode_input($patient_birthdate_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_patient_birthdate_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_patient_birthdate_input_2_ano" name="patient_birthdate_input_2_ano" value="<?php echo NM_encode_input($patient_birthdate_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.patient_name_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_patient_name'), document.F1.patient_name_cond, 'patient_name');
   document.F1.patient_name.value = "";
   document.F1.patient_name_autocomp.value = "";
   $('#select2-id_ac_patient_name-container').html('<?php echo $this->Val_init_patient_name['desc'] ?>');;
   document.F1.patient_gender_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_patient_gender'), document.F1.patient_gender_cond, 'patient_gender');
   document.F1.patient_gender.value = "";
   document.F1.patient_blood_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_patient_blood'), document.F1.patient_blood_cond, 'patient_blood');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'patient_blood[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
   document.F1.patient_birthdate_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_patient_birthdate'), document.F1.patient_birthdate_cond, 'patient_birthdate');
   document.F1.patient_birthdate_dia.value = "";
   document.F1.patient_birthdate_mes.value = "";
   document.F1.patient_birthdate_ano.value = "";
   document.F1.patient_birthdate_input_2_dia.value = "";
   document.F1.patient_birthdate_input_2_mes.value = "";
   document.F1.patient_birthdate_input_2_ano.value = "";
   Sc_carga_select2('all');
 }
 function Sc_carga_select2(Field)
 {
    if (Field == 'all' || Field == 'patient_gender') {
       Sc_carga_select2_patient_gender();
    }
 }
 function Sc_carga_select2_patient_gender()
 {
  $("#SC_patient_gender").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
 ...
 {
    $('#SC_patient_birthdate_dia').bind('change', function() {sc_grid_patients_valida_dia(this)});
    $('#SC_patient_birthdate_input_2_dia').bind('change', function() {sc_grid_patients_valida_dia(this)});
    $('#SC_patient_birthdate_input_2_mes').bind('change', function() {sc_grid_patients_valida_mes(this)});
    $('#SC_patient_birthdate_mes').bind('change', function() {sc_grid_patients_valida_mes(this)});
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "ProntSaude/grid_patients";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_patient_name_cond'] = 'cond';
      $tp_fields['SC_patient_name'] = 'text_aut';
      $tp_fields['id_ac_patient_name'] = 'select2_aut';
      $tp_fields['SC_patient_gender_cond'] = 'cond';
      $tp_fields['SC_patient_gender'] = 'select';
      $tp_fields['SC_patient_blood_cond'] = 'cond';
      $tp_fields['SC_patient_blood'] = 'checkbox';
      $tp_fields['SC_patient_birthdate_cond'] = 'cond';
      $tp_fields['SC_patient_birthdate_dia'] = 'text';
      $tp_fields['SC_patient_birthdate_mes'] = 'text';
      $tp_fields['SC_patient_birthdate_ano'] = 'text';
      $tp_fields['SC_patient_birthdate_input_2_dia'] = 'text';
      $tp_fields['SC_patient_birthdate_input_2_mes'] = 'text';
      $tp_fields['SC_patient_birthdate_input_2_ano'] = 'text';
   ...
   {
      global $patient_name_cond, $patient_name, $patient_name_autocomp,
             $patient_gender_cond, $patient_gender,
             $patient_blood_cond, $patient_blood,
             $patient_birthdate_cond, $patient_birthdate, $patient_birthdate_dia, $patient_birthdate_mes, $patient_birthdate_ano, $patient_birthdate_input_2_dia, $patient_birthdate_input_2_mes, $patient_birthdate_input_2_ano, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($patient_name_autocomp) && empty($patient_name))
      {
          $patient_name = $patient_name_autocomp;
      }
      $patient_name_cond_salva = $patient_name_cond; 
      if (!isset($patient_name_input_2) || $patient_name_input_2 == "")
      {
          $patient_name_input_2 = $patient_name;
      }
      $patient_gender_cond_salva = $patient_gender_cond; 
      if (!isset($patient_gender_input_2) || $patient_gender_input_2 == "")
      {
          $patient_gender_input_2 = $patient_gender;
      }
      $patient_blood_cond_salva = $patient_blood_cond; 
      if (!isset($patient_blood_input_2) || $patient_blood_input_2 == "")
      {
          $patient_blood_input_2 = $patient_blood;
      }
      $patient_birthdate_cond_salva = $patient_birthdate_cond; 
      if (!isset($patient_birthdate_input_2_dia) || $patient_birthdate_input_2_dia == "") {
          $patient_birthdate_input_2_dia = $patient_birthdate_dia;
      }
      if (!isset($patient_birthdate_input_2_mes) || $patient_birthdate_input_2_mes == "") {
          $patient_birthdate_input_2_mes = $patient_birthdate_mes;
      }
      if (!isset($patient_birthdate_input_2_ano) || $patient_birthdate_input_2_ano == "") {
          $patient_birthdate_input_2_ano = $patient_birthdate_ano;
      }
      $tmp_pos = (is_string($patient_gender)) ? strpos($patient_gender, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $patient_gender;
      }
      else {
          $L_lookup = substr($patient_gender, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_gender'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_patients_fld_patient_gender'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      if (is_array($patient_blood)) {
          foreach ($patient_blood as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['psq_check_ret']['patient_blood'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_patients_fld_patient_blood'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_name'] = $patient_name; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_name_cond'] = $patient_name_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_gender'] = $patient_gender; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_gender_cond'] = $patient_gender_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_blood'] = $patient_blood; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_blood_cond'] = $patient_blood_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_dia'] = $patient_birthdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_mes'] = $patient_birthdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_ano'] = $patient_birthdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_input_2_dia'] = $patient_birthdate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_input_2_mes'] = $patient_birthdate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_input_2_ano'] = $patient_birthdate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_cond'] = $patient_birthdate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['dyn_search']  = array(); 
    ...
    if ($patient_name != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['patient_name'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['patient_name'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['patient_name'] = $patient_name;
      }
      $Conteudo = $patient_gender;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['patient_gender'] = $Conteudo;
      $this->cmp_formatado['patient_blood'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_blood'];
      $this->cmp_formatado['patient_blood_input_2'] = $patient_blood_input_2;
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($patient_name) || $patient_name_cond == "nu" || $patient_name_cond == "nn" || $patient_name_cond == "ep" || $patient_name_cond == "ne")
      {
         $this->monta_condicao("patient_name", $patient_name_cond, $patient_name, "", "patient_name", "VARCHAR", false);
      }

      //----- $patient_gender
      $this->Date_part = false;
      if (isset($patient_gender))
      {
         $this->monta_condicao("patient_gender", $patient_gender_cond, $patient_gender, "", "patient_gender", "VARCHAR", false);
      }
      ...
      $nm_aspas = "'";
      if ($patient_blood_cond == "nu" || $patient_blood_cond == "nn" || $patient_blood_cond == "ep" || $patient_blood_cond == "ne")
      {
          $patient_blood = array();
      }
      if (is_array($patient_blood) && count($patient_blood) != 0)
      {
         foreach ($patient_blood as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
                unset($patient_blood[$i]);
            }
         }
      }
      if (is_array($patient_blood) && count($patient_blood) != 0)
      {
         $this->and_or();
         if ($patient_blood_cond == "df" || $patient_blood_cond == "np")
         {
             $this->comando        .= " patient_blood not in (";
             $this->comando_sum    .= " patients.patient_blood not in (";
             $this->comando_filtro .= " patient_blood not in (";
         }
         else
         {
             $this->comando        .= " patient_blood in (";
             $this->comando_sum    .= " patients.patient_blood in (";
             $this->comando_filtro .= " patient_blood in (";
         }
         $x                     = count($patient_blood);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($patient_blood as $i => $dados)
         {
         ...
         $Lang_descr_final = isset($Lang_descr[$patient_blood_cond]) ? $Lang_descr[$patient_blood_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['cond_pesq'] .= $nmgp_tab_label['patient_blood'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($patient_blood) && ($patient_blood_cond == "nu" || $patient_blood_cond == "nn" || $patient_blood_cond == "ep" || $patient_blood_cond == "ne"))
      {
         $this->monta_condicao("patient_blood", $patient_blood_cond, "", "", "patient_blood", "VARCHAR", false);
      }

      //----- $patient_birthdate
      $this->Date_part = false;
      if ($patient_birthdate_cond != "bi_TP" && $Res_comp != 'calend')
      {
          $patient_birthdate_cond = strtoupper($patient_birthdate_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $patient_birthdate_ano;
          $Dtxt .= $patient_birthdate_mes;
          $Dtxt .= $patient_birthdate_dia;
          $val[0]['ano'] = $patient_birthdate_ano;
          $val[0]['mes'] = $patient_birthdate_mes;
          $val[0]['dia'] = $patient_birthdate_dia;
          if ($patient_birthdate_cond == "BW")
          {
              $val[1]['ano'] = $patient_birthdate_input_2_ano;
              $val[1]['mes'] = $patient_birthdate_input_2_mes;
              $val[1]['dia'] = $patient_birthdate_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $patient_birthdate_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $patient_birthdate_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $patient_birthdate = $val[0];
          $this->cmp_formatado['patient_birthdate'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['patient_birthdate'], "YYYY-MM-DD");
          $this->cmp_formatado['patient_birthdate'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($patient_birthdate_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $patient_birthdate_input_2     = $val[1];
              $this->cmp_formatado['patient_birthdate_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['campos_busca']['patient_birthdate_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['patient_birthdate_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['patient_birthdate_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $patient_birthdate_cond == "NU" || $patient_birthdate_cond == "NN"|| $patient_birthdate_cond == "EP"|| $patient_birthdate_cond == "NE")
          {
              $this->monta_condicao("patient_birthdate", $patient_birthdate_cond, $patient_birthdate, $patient_birthdate_input_2, 'patient_birthdate', 'DATE');
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_patients']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
