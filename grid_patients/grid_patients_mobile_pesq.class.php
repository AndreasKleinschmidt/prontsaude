...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "patient_birthdate";$Nm_numeric[] = "idpatient";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_patient_name"  <?php echo $str_hide_patient_name?>><?php
      if ($patient_name != "")
      {
      $patient_name_look = (is_string($patient_name) ? substr($this->Db->qstr($patient_name), 1, -1) : $patient_name); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_patient_gender"  <?php echo $str_hide_patient_gender?>> 
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_patient_blood"  <?php echo $str_hide_patient_blood?>> 
<?php
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_patient_birthdate_cond" name="patient_birthdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_patient_birthdate'), this, 'patient_birthdate')">
      ...
      <br><span id="id_hide_patient_birthdate"  <?php echo $str_hide_patient_birthdate?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
         <br />
        <SPAN id="id_vis_patient_birthdate"  <?php echo $str_display_patient_birthdate; ?> class="scFilterFieldFontEven">
