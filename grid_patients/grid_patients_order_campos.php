<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_patients']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['idpatient'] = "on";
   $tab_def_campos['idpatient'] = "idpatient";
   $tab_labels["idpatient"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patients']['labels']["idpatient"])) ? $_SESSION['sc_session'][$sc_init]['grid_patients']['labels']["idpatient"] : "" . $this->Nm_lang['lang_patients_fld_idpatient'] . "";
   $tab_ger_campos['patient_name'] = "on";
   $tab_def_campos['patient_name'] = "patient_name";
   $tab_labels["patient_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patients']['labels']["patient_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_patients']['labels']["patient_name"] : "" . $this->Nm_lang['lang_patients_fld_patient_name'] . "";
   $tab_ger_campos['patient_birthdate'] = "on";
   $tab_def_campos['patient_birthdate'] = "patient_birthdate";
   $tab_labels["patient_birthdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patients']['labels']["patient_birthdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_patients']['labels']["patient_birthdate"] : "" . $this->Nm_lang['lang_patients_fld_patient_birthdate'] . "";
   $tab_ger_campos['patient_gender'] = "on";
   $tab_def_campos['patient_gender'] = "patient_gender";
   $tab_labels["patient_gender"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patients']['labels']["patient_gender"])) ? $_SESSION['sc_session'][$sc_init]['grid_patients']['labels']["patient_gender"] : "" . $this->Nm_lang['lang_patients_fld_patient_gender'] . "";
   $tab_ger_campos['patient_blood'] = "on";
   $tab_def_campos['patient_blood'] = "patient_blood";
   $tab_labels["patient_blood"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patients']['labels']["patient_blood"])) ? $_SESSION['sc_session'][$sc_init]['grid_patients']['labels']["patient_blood"] : "" . $this->Nm_lang['lang_patients_fld_patient_blood'] . "";
   $tab_ger_campos['patient_phone'] = "on";
   $tab_def_campos['patient_phone'] = "patient_phone";
   $tab_labels["patient_phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patients']['labels']["patient_phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_patients']['labels']["patient_phone"] : "" . $this->Nm_lang['lang_patients_fld_patient_phone'] . "";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_tbl_patients'] ?></TITLE>
