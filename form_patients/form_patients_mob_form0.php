...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
else
{
    ...
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['link_info']['remove_background']) {
...
<input type="hidden" name="idpatient" value="<?php  echo $this->form_encode_input($this->idpatient) ?>">
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['fast_search'][2] : "";
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_patient_name_line" id="hidden_field_data_patient_name" style="<?php echo $sStyleHidden_patient_name; ?>vertical-align: top;"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_patient_name_label" style=""><span id="id_label_patient_name"><?php echo $this->nm_new_label['patient_name']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['php_cmp_required']['patient_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['php_cmp_required']['patient_name'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></span><br>
...
<?php $sStyleHidden_patient_name_dumb = ('' == $sStyleHidden_patient_name) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_patient_name_dumb" style="<?php echo $sStyleHidden_patient_name_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_patient_birthdate_line" id="hidden_field_data_patient_birthdate" style="<?php echo $sStyleHidden_patient_birthdate; ?>vertical-align: top;"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_patient_birthdate_label" style=""><span id="id_label_patient_birthdate"><?php echo $this->nm_new_label['patient_birthdate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_patient_gender_line" id="hidden_field_data_patient_gender" style="<?php echo $sStyleHidden_patient_gender; ?>vertical-align: top;"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_patient_gender_label" style=""><span id="id_label_patient_gender"><?php echo $this->nm_new_label['patient_gender']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['Lookup_patient_gender'][] = 'M'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['Lookup_patient_gender'][] = 'F'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_patient_blood_line" id="hidden_field_data_patient_blood" style="<?php echo $sStyleHidden_patient_blood; ?>vertical-align: top;"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_patient_blood_label" style=""><span id="id_label_patient_blood"><?php echo $this->nm_new_label['patient_blood']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['Lookup_patient_blood'][] = 'A-'; ?>
 <option  value="A+" <?php  if ($this->patient_blood == "A+") { echo " selected" ;} ?>>A+</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['Lookup_patient_blood'][] = 'A+'; ?>
 <option  value="B-" <?php  if ($this->patient_blood == "B-") { echo " selected" ;} ?>>B-</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['Lookup_patient_blood'][] = 'B-'; ?>
 <option  value="B+" <?php  if ($this->patient_blood == "B+") { echo " selected" ;} ?>>B+</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['Lookup_patient_blood'][] = 'B+'; ?>
 <option  value="AB-" <?php  if ($this->patient_blood == "AB-") { echo " selected" ;} ?>>AB-</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['Lookup_patient_blood'][] = 'AB-'; ?>
 <option  value="AB+" <?php  if ($this->patient_blood == "AB+") { echo " selected" ;} ?>>AB+</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['Lookup_patient_blood'][] = 'AB+'; ?>
 <option  value="O-" <?php  if ($this->patient_blood == "O-") { echo " selected" ;} ?>>O-</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['Lookup_patient_blood'][] = 'O-'; ?>
 <option  value="O+" <?php  if ($this->patient_blood == "O+") { echo " selected" ;} ?>>O+</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['Lookup_patient_blood'][] = 'O+'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_patient_phone_line" id="hidden_field_data_patient_phone" style="<?php echo $sStyleHidden_patient_phone; ?>vertical-align: top;"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_patient_phone_label" style=""><span id="id_label_patient_phone"><?php echo $this->nm_new_label['patient_phone']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_patient_email_line" id="hidden_field_data_patient_email" style="<?php echo $sStyleHidden_patient_email; ?>vertical-align: top;"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_patient_email_label" style=""><span id="id_label_patient_email"><?php echo $this->nm_new_label['patient_email']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_patient_address_line" id="hidden_field_data_patient_address" style="<?php echo $sStyleHidden_patient_address; ?>vertical-align: top;"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_patient_address_label" style=""><span id="id_label_patient_address"><?php echo $this->nm_new_label['patient_address']; ?></span></span><br>
<?php
...
<?php $sStyleHidden_patient_address_dumb = ('' == $sStyleHidden_patient_address) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_patient_address_dumb" style="<?php echo $sStyleHidden_patient_address_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_events'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_events'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['grid_events_patiente_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_events'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['grid_events_patiente_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['grid_events_patiente_script_case_init'] ]['grid_events_patiente']['embutida_form_full']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['grid_events_patiente_script_case_init'] ]['grid_events_patiente']['embutida_form']       = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['grid_events_patiente_script_case_init'] ]['grid_events_patiente']['embutida_pai']        = "form_patients_mob";
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['grid_events_patiente_script_case_init'] ]['grid_events_patiente']['embutida_form_parms'] = "var_patiente*scin" . $this->nmgp_dados_form['idpatient'] . "*scoutSC_glo_par_var_doctor*scinvar_doctor*scoutSC_glo_par_usr_group_id*scinusr_group_id*scoutSC_glo_par_usr_login*scinusr_login*scoutSC_glo_par_lang*scinlang*scoutvar_patiente_name*scin" . $this->nmgp_dados_form['patient_name'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_cab*scinN*scout";
 if (isset($this->Ini->sc_lig_md5["grid_events_patiente"]) && $this->Ini->sc_lig_md5["grid_events_patiente"] == "S") {
     $Parms_Lig  = "var_patiente*scin" . $this->nmgp_dados_form['idpatient'] . "*scoutSC_glo_par_var_doctor*scinvar_doctor*scoutSC_glo_par_usr_group_id*scinusr_group_id*scoutSC_glo_par_usr_login*scinusr_login*scoutSC_glo_par_lang*scinlang*scoutvar_patiente_name*scin" . $this->nmgp_dados_form['patient_name'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_cab*scinN*scout";
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_patients_mob@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
     $Md5_Lig  = "var_patiente*scin" . $this->nmgp_dados_form['idpatient'] . "*scoutSC_glo_par_var_doctor*scinvar_doctor*scoutSC_glo_par_usr_group_id*scinusr_group_id*scoutSC_glo_par_usr_login*scinusr_login*scoutSC_glo_par_lang*scinlang*scoutvar_patiente_name*scin" . $this->nmgp_dados_form['patient_name'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_cab*scinN*scout";
 }
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_patients_mob_empty.htm' : $this->Ini->link_grid_events_patiente_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
 foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['grid_events_patiente_script_case_init'] ]['grid_events_patiente'] as $i => $v)
 {
     $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['grid_events_patiente_script_case_init'] ]['grid_events_patiente'][$i] = $v;
 }
if (isset($this->Ini->sc_lig_target['C_@scinf_events']) && 'nmsc_iframe_liga_grid_events_patiente' != $this->Ini->sc_lig_target['C_@scinf_events'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_events'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['grid_events_patiente_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
