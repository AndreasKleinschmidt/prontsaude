<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="idpatient" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idpatient']); ?>">
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_patients_mob']['where_detal']))
  {
?>  
