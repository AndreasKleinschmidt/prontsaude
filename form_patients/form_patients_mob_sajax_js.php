...
?>
  ...
  function do_ajax_form_patients_mob_validate_patient_name()
  {
    var nomeCampo_patient_name = "patient_name";
    var var_patient_name = scAjaxGetFieldText(nomeCampo_patient_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_patient_name(var_patient_name, var_script_case_init, do_ajax_form_patients_mob_validate_patient_name_cb);
  } // do_ajax_form_patients_mob_validate_patient_name

  function do_ajax_form_patients_mob_validate_patient_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "patient_name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_patient_name_cb

  // ---------- Validate patient_birthdate
  function do_ajax_form_patients_mob_validate_patient_birthdate()
  {
    var nomeCampo_patient_birthdate = "patient_birthdate";
    var var_patient_birthdate = scAjaxGetFieldText(nomeCampo_patient_birthdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_patient_birthdate(var_patient_birthdate, var_script_case_init, do_ajax_form_patients_mob_validate_patient_birthdate_cb);
  } // do_ajax_form_patients_mob_validate_patient_birthdate

  function do_ajax_form_patients_mob_validate_patient_birthdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "patient_birthdate";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_patient_birthdate_cb

  // ---------- Validate patient_gender
  function do_ajax_form_patients_mob_validate_patient_gender()
  {
    var nomeCampo_patient_gender = "patient_gender";
    var var_patient_gender = scAjaxGetFieldRadio(nomeCampo_patient_gender);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_patient_gender(var_patient_gender, var_script_case_init, do_ajax_form_patients_mob_validate_patient_gender_cb);
  } // do_ajax_form_patients_mob_validate_patient_gender

  function do_ajax_form_patients_mob_validate_patient_gender_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "patient_gender";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_patient_gender_cb

  // ---------- Validate patient_blood
  function do_ajax_form_patients_mob_validate_patient_blood()
  {
    var nomeCampo_patient_blood = "patient_blood";
    var var_patient_blood = scAjaxGetFieldSelect(nomeCampo_patient_blood);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_patient_blood(var_patient_blood, var_script_case_init, do_ajax_form_patients_mob_validate_patient_blood_cb);
  } // do_ajax_form_patients_mob_validate_patient_blood

  function do_ajax_form_patients_mob_validate_patient_blood_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "patient_blood";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_patient_blood_cb

  // ---------- Validate patient_phone
  function do_ajax_form_patients_mob_validate_patient_phone()
  {
    var nomeCampo_patient_phone = "patient_phone";
    var var_patient_phone = scAjaxGetFieldText(nomeCampo_patient_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_patient_phone(var_patient_phone, var_script_case_init, do_ajax_form_patients_mob_validate_patient_phone_cb);
  } // do_ajax_form_patients_mob_validate_patient_phone

  function do_ajax_form_patients_mob_validate_patient_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "patient_phone";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_patient_phone_cb

  // ---------- Validate patient_email
  function do_ajax_form_patients_mob_validate_patient_email()
  {
    var nomeCampo_patient_email = "patient_email";
    var var_patient_email = scAjaxGetFieldText(nomeCampo_patient_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_patient_email(var_patient_email, var_script_case_init, do_ajax_form_patients_mob_validate_patient_email_cb);
  } // do_ajax_form_patients_mob_validate_patient_email

  function do_ajax_form_patients_mob_validate_patient_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "patient_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_patient_email_cb

  // ---------- Validate patient_address
  function do_ajax_form_patients_mob_validate_patient_address()
  {
    var nomeCampo_patient_address = "patient_address";
    var var_patient_address = scAjaxGetFieldText(nomeCampo_patient_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_patient_address(var_patient_address, var_script_case_init, do_ajax_form_patients_mob_validate_patient_address_cb);
  } // do_ajax_form_patients_mob_validate_patient_address

  function do_ajax_form_patients_mob_validate_patient_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "patient_address";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_patient_address_cb

  // ---------- Validate events
  function do_ajax_form_patients_mob_validate_events()
  {
    var nomeCampo_events = "events";
    var var_events = scAjaxGetFieldText(nomeCampo_events);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_mob_validate_events(var_events, var_script_case_init, do_ajax_form_patients_mob_validate_events_cb);
  } // do_ajax_form_patients_mob_validate_events

  function do_ajax_form_patients_mob_validate_events_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "events";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_mob_validate_events_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_patients_mob_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_patient_name = scAjaxGetFieldText("patient_name");
    var var_patient_birthdate = scAjaxGetFieldText("patient_birthdate");
    var var_patient_gender = scAjaxGetFieldRadio("patient_gender");
    var var_patient_blood = scAjaxGetFieldSelect("patient_blood");
    var var_patient_phone = scAjaxGetFieldText("patient_phone");
    var var_patient_email = scAjaxGetFieldText("patient_email");
    var var_patient_address = scAjaxGetFieldText("patient_address");
    var var_idpatient = scAjaxGetFieldText("idpatient");
    ...
    scAjaxProcOn();
    x_ajax_form_patients_mob_submit_form(var_patient_name, var_patient_birthdate, var_patient_gender, var_patient_blood, var_patient_phone, var_patient_email, var_patient_address, var_idpatient, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_patients_mob_submit_form_cb);
...
?>
  ...
  var scStatusDetail = {};
  scStatusDetail["grid_events_patiente"] = "off";
  ...
  function perform_ajax_form_patients_mob_navigate_form()
  {
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_idpatient = document.F2.idpatient.value;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_events_patiente"] = "on";
    x_ajax_form_patients_mob_navigate_form(var_idpatient, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_patients_mob_navigate_form_cb);
...
?>
  function do_ajax_form_patients_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.idpatient.value = scAjaxGetKeyValue("idpatient");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_events_patiente"] && "nmsc_iframe_liga_grid_events_patiente" != scMasterDetailIframe["nmsc_iframe_liga_grid_events_patiente"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_events_patiente"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_events_patiente').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
...
?>
  ...
  {
    if ("off" == scStatusDetail["grid_events_patiente"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "patient_name";
  ajax_field_list[1] = "patient_birthdate";
  ajax_field_list[2] = "patient_gender";
  ajax_field_list[3] = "patient_blood";
  ajax_field_list[4] = "patient_phone";
  ajax_field_list[5] = "patient_email";
  ajax_field_list[6] = "patient_address";
  ajax_field_list[7] = "events";
  ...
  var ajax_error_list = {
    "patient_name": {"label": "<?php echo $this->Ini->Nm_lang['lang_patients_fld_patient_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "patient_birthdate": {"label": "<?php echo $this->Ini->Nm_lang['lang_patients_fld_patient_birthdate'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "patient_gender": {"label": "<?php echo $this->Ini->Nm_lang['lang_patients_fld_patient_gender'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "patient_blood": {"label": "<?php echo $this->Ini->Nm_lang['lang_patients_fld_patient_blood'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "patient_phone": {"label": "<?php echo $this->Ini->Nm_lang['lang_patients_fld_patient_phone'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "patient_email": {"label": "<?php echo $this->Ini->Nm_lang['lang_patients_fld_patient_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "patient_address": {"label": "<?php echo $this->Ini->Nm_lang['lang_patients_fld_patient_address'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "events": {"label": "events", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "patient_birthdate": new Array(),
    "patient_gender": new Array(),
    "patient_blood": new Array(),
    "patient_phone": new Array(),
    "patient_email": new Array(),
    "patient_address": new Array(),
    "events": new Array()
  };
  ajax_field_mult["patient_name"][1] = "patient_name";
  ajax_field_mult["patient_birthdate"][1] = "patient_birthdate";
  ajax_field_mult["patient_gender"][1] = "patient_gender";
  ajax_field_mult["patient_blood"][1] = "patient_blood";
  ajax_field_mult["patient_phone"][1] = "patient_phone";
  ajax_field_mult["patient_email"][1] = "patient_email";
  ajax_field_mult["patient_address"][1] = "patient_address";
  ajax_field_mult["events"][1] = "events";

  var ajax_field_id = {
    "patient_name": new Array("hidden_field_label_patient_name", "hidden_field_data_patient_name"),
    "patient_birthdate": new Array("hidden_field_label_patient_birthdate", "hidden_field_data_patient_birthdate"),
    "patient_gender": new Array("hidden_field_label_patient_gender", "hidden_field_data_patient_gender"),
    "patient_blood": new Array("hidden_field_label_patient_blood", "hidden_field_data_patient_blood"),
    "patient_phone": new Array("hidden_field_label_patient_phone", "hidden_field_data_patient_phone"),
    "patient_email": new Array("hidden_field_label_patient_email", "hidden_field_data_patient_email"),
    "patient_address": new Array("hidden_field_label_patient_address", "hidden_field_data_patient_address"),
    "events": new Array("hidden_field_label_events", "hidden_field_data_events")
  };

  var ajax_read_only = {
    "patient_name": "off",
    "patient_birthdate": "off",
    "patient_gender": "off",
    "patient_blood": "off",
    "patient_phone": "off",
    "patient_email": "off",
