...
?>
  ...
  function do_ajax_form_patients_validate_patient_name()
  {
    var nomeCampo_patient_name = "patient_name";
    var var_patient_name = scAjaxGetFieldText(nomeCampo_patient_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_patient_name(var_patient_name, var_script_case_init, do_ajax_form_patients_validate_patient_name_cb);
  } // do_ajax_form_patients_validate_patient_name

  function do_ajax_form_patients_validate_patient_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_patient_name_cb

  // ---------- Validate patient_birthdate
  function do_ajax_form_patients_validate_patient_birthdate()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_patient_birthdate(var_patient_birthdate, var_script_case_init, do_ajax_form_patients_validate_patient_birthdate_cb);
  } // do_ajax_form_patients_validate_patient_birthdate

  function do_ajax_form_patients_validate_patient_birthdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_patient_birthdate_cb

  // ---------- Validate patient_gender
  function do_ajax_form_patients_validate_patient_gender()
  {
    var nomeCampo_patient_gender = "patient_gender";
    var var_patient_gender = scAjaxGetFieldRadio(nomeCampo_patient_gender);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_patient_gender(var_patient_gender, var_script_case_init, do_ajax_form_patients_validate_patient_gender_cb);
  } // do_ajax_form_patients_validate_patient_gender

  function do_ajax_form_patients_validate_patient_gender_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_patient_gender_cb

  // ---------- Validate patient_blood
  function do_ajax_form_patients_validate_patient_blood()
  {
    var nomeCampo_patient_blood = "patient_blood";
    var var_patient_blood = scAjaxGetFieldSelect(nomeCampo_patient_blood);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_patient_blood(var_patient_blood, var_script_case_init, do_ajax_form_patients_validate_patient_blood_cb);
  } // do_ajax_form_patients_validate_patient_blood

  function do_ajax_form_patients_validate_patient_blood_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_patient_blood_cb

  // ---------- Validate patient_phone
  function do_ajax_form_patients_validate_patient_phone()
  {
    var nomeCampo_patient_phone = "patient_phone";
    var var_patient_phone = scAjaxGetFieldText(nomeCampo_patient_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_patient_phone(var_patient_phone, var_script_case_init, do_ajax_form_patients_validate_patient_phone_cb);
  } // do_ajax_form_patients_validate_patient_phone

  function do_ajax_form_patients_validate_patient_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_patient_phone_cb

  // ---------- Validate patient_email
  function do_ajax_form_patients_validate_patient_email()
  {
    var nomeCampo_patient_email = "patient_email";
    var var_patient_email = scAjaxGetFieldText(nomeCampo_patient_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_patient_email(var_patient_email, var_script_case_init, do_ajax_form_patients_validate_patient_email_cb);
  } // do_ajax_form_patients_validate_patient_email

  function do_ajax_form_patients_validate_patient_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_patient_email_cb

  // ---------- Validate patient_address
  function do_ajax_form_patients_validate_patient_address()
  {
    var nomeCampo_patient_address = "patient_address";
    var var_patient_address = scAjaxGetFieldText(nomeCampo_patient_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_patient_address(var_patient_address, var_script_case_init, do_ajax_form_patients_validate_patient_address_cb);
  } // do_ajax_form_patients_validate_patient_address

  function do_ajax_form_patients_validate_patient_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_patient_address_cb

  // ---------- Validate events
  function do_ajax_form_patients_validate_events()
  {
    var nomeCampo_events = "events";
    var var_events = scAjaxGetFieldText(nomeCampo_events);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patients_validate_events(var_events, var_script_case_init, do_ajax_form_patients_validate_events_cb);
  } // do_ajax_form_patients_validate_events

  function do_ajax_form_patients_validate_events_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "events";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patients_validate_events_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_patients_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_patients_submit_form(var_patient_name, var_patient_birthdate, var_patient_gender, var_patient_blood, var_patient_phone, var_patient_email, var_patient_address, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_patients_submit_form_cb);
...
?>
  ...
  function perform_ajax_form_patients_navigate_form()
  {
    ...
    x_ajax_form_patients_navigate_form(var_idpatient, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_patients_navigate_form_cb);
