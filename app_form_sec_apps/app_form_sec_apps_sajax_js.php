...
?>
  ...
  var ajax_error_list = {
    "app_name": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_apps_fld_app_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "description": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_apps_fld_description'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
