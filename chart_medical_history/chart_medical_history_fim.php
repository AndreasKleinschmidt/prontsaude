...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["ProntSaude_____chart_medical_history"]))
   {
      unset($_SESSION['session_sec_aplicacao']["ProntSaude_____chart_medical_history"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_medical_history']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_medical_history']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_medical_history']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_medical_history']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_medical_history']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_medical_history</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_medical_history']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_medical_history']['embutida_filho'] as $ind => $sc_init)
          {
