<?php
@session_start() ;
$_SESSION['scriptcase']['chart_medical_history']['sc_process_barr'] = true;
require_once('../chart_medical_history/index.php');
unset($_SESSION['scriptcase']['chart_medical_history']['sc_process_barr']);
$ExportCtrl = new chart_medical_history_export_control;
$ExportCtrl->Export_barr();

class chart_medical_history_export_control
{
