...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_nursery_events/grid_nursery_events_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_nursery_events_res_xls.class.php");
              $this->Res_xls = new grid_nursery_events_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_nursery_events.zip";
          $this->Arquivo   .= "_grid_nursery_events" . $this->Xls_tp;
          $this->Tit_doc    = "grid_nursery_events" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['grid_nursery_events']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_nursery_events']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_edit_rec()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->edit_rec, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->edit_rec, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- doctor_iddoctor
   function NM_export_doctor_iddoctor()
   {
         ...
         if (is_numeric($this->look_doctor_iddoctor))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_doctor_iddoctor);
         $this->Xls_col++;
   }
   //----- patients_idpatient
   function NM_export_patients_idpatient()
   {
         ...
         if (is_numeric($this->look_patients_idpatient))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_patients_idpatient);
         $this->Xls_col++;
   }
   //----- complaints
   function NM_export_complaints()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->complaints, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->complaints, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- prescription
   function NM_export_prescription()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->prescription, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->prescription, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- nursery_datetime
   function NM_export_nursery_datetime()
   {
      ...
      if (!empty($this->nursery_datetime))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nursery_datetime, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nursery_datetime, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- evt_status
   function NM_export_evt_status()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->evt_status, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->evt_status, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- idhistory
   function NM_export_idhistory()
   {
         ...
         if (is_numeric($this->idhistory))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->idhistory);
         $this->Xls_col++;
   }
   //----- history_datetime
   function NM_export_history_datetime()
   {
      ...
      if (!empty($this->history_datetime))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->history_datetime, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->history_datetime, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- diagnosis
   function NM_export_diagnosis()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->diagnosis, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->diagnosis, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- edit_rec
   function NM_sub_cons_edit_rec()
   {
         $this->edit_rec = NM_charset_to_utf8($this->edit_rec);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->edit_rec;
   ...
   //----- doctor_iddoctor
   function NM_sub_cons_doctor_iddoctor()
   {
         $this->look_doctor_iddoctor = NM_charset_to_utf8($this->look_doctor_iddoctor);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_doctor_iddoctor;
   ...
   //----- patients_idpatient
   function NM_sub_cons_patients_idpatient()
   {
         $this->look_patients_idpatient = NM_charset_to_utf8($this->look_patients_idpatient);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_patients_idpatient;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- complaints
   function NM_sub_cons_complaints()
   {
         $this->complaints = html_entity_decode($this->complaints, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->complaints = strip_tags($this->complaints);
         $this->complaints = NM_charset_to_utf8($this->complaints);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->complaints;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- prescription
   function NM_sub_cons_prescription()
   {
         $this->prescription = html_entity_decode($this->prescription, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->prescription = strip_tags($this->prescription);
         $this->prescription = NM_charset_to_utf8($this->prescription);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->prescription;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- nursery_datetime
   function NM_sub_cons_nursery_datetime()
   {
      if (!empty($this->nursery_datetime))
      {
         if (substr($this->nursery_datetime, 10, 1) == "-") 
         ...
         $this->nursery_datetime = NM_charset_to_utf8($this->nursery_datetime);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nursery_datetime;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- evt_status
   function NM_sub_cons_evt_status()
   {
         $this->evt_status = html_entity_decode($this->evt_status, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->evt_status = strip_tags($this->evt_status);
         $this->evt_status = NM_charset_to_utf8($this->evt_status);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->evt_status;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- idhistory
   function NM_sub_cons_idhistory()
   {
         $this->idhistory = NM_charset_to_utf8($this->idhistory);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->idhistory;
   ...
   //----- history_datetime
   function NM_sub_cons_history_datetime()
   {
      if (!empty($this->history_datetime))
      {
         if (substr($this->history_datetime, 10, 1) == "-") 
         ...
         $this->history_datetime = NM_charset_to_utf8($this->history_datetime);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->history_datetime;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- diagnosis
   function NM_sub_cons_diagnosis()
   {
         $this->diagnosis = html_entity_decode($this->diagnosis, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->diagnosis = strip_tags($this->diagnosis);
         $this->diagnosis = NM_charset_to_utf8($this->diagnosis);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->diagnosis;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_nursery_events'] ?> :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_nursery_events']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
