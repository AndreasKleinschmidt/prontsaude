...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["ProntSaude_____grid_nursery_events"]))
   {
      unset($_SESSION['session_sec_aplicacao']["ProntSaude_____grid_nursery_events"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['refresh']['grid_nursery_events']))
   {
       unset($_SESSION['scriptcase']['refresh']['grid_nursery_events']);
   }
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_nursery_events']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_nursery_events']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_nursery_events']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_nursery_events']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_nursery_events']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_nursery_events</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_nursery_events']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_nursery_events']['embutida_filho'] as $ind => $sc_init)
          {
