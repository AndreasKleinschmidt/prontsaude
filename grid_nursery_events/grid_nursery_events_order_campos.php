...
<?php
   ...
   $Ord_Cmp = new grid_nursery_events_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_nursery_events_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['edit_rec'] = "edit_rec";
   }
   else
   {
       $tab_def_campos['edit_rec'] = "";
   }
   $tab_labels["edit_rec"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["edit_rec"])) ? $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["edit_rec"] : "";
   $tab_ger_campos['doctor_iddoctor'] = "on";
   $tab_def_campos['doctor_iddoctor'] = "doctor_iddoctor";
   $tab_labels["doctor_iddoctor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["doctor_iddoctor"])) ? $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["doctor_iddoctor"] : "" . $this->Nm_lang['lang_medical_history_fld_doctor_iddoctor'] . "";
   $tab_ger_campos['patients_idpatient'] = "on";
   $tab_def_campos['patients_idpatient'] = "patients_idpatient";
   $tab_labels["patients_idpatient"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["patients_idpatient"])) ? $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["patients_idpatient"] : "" . $this->Nm_lang['lang_medical_history_fld_patients_idpatient'] . "";
   $tab_ger_campos['complaints'] = "on";
   $tab_def_campos['complaints'] = "complaints";
   $tab_labels["complaints"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["complaints"])) ? $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["complaints"] : "" . $this->Nm_lang['lang_medical_history_fld_complaints'] . "";
   $tab_ger_campos['prescription'] = "on";
   $tab_def_campos['prescription'] = "prescription";
   $tab_labels["prescription"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["prescription"])) ? $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["prescription"] : "" . $this->Nm_lang['lang_medical_history_fld_prescription'] . "";
   $tab_ger_campos['nursery_datetime'] = "on";
   $tab_def_campos['nursery_datetime'] = "nursery_datetime";
   $tab_labels["nursery_datetime"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["nursery_datetime"])) ? $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["nursery_datetime"] : "" . $this->Nm_lang['lang_medical_history_fld_nursery_datetime'] . "";
   $tab_ger_campos['evt_status'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['evt_status'] = "evt_status";
   }
   else
   {
       $tab_def_campos['evt_status'] = "";
   }
   $tab_labels["evt_status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["evt_status"])) ? $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['labels']["evt_status"] : "" . $this->Nm_lang['lang_event_fld_idevent_status'] . "";
   $tab_ger_campos['edit_rec'] = "none";
   $tab_ger_campos['evt_status'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_nursery_events_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_nursery_events']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
