...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_grid_nursery_events').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_grid_nursery_events').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_grid_nursery_events').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_grid_nursery_events').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_grid_nursery_events').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_grid_nursery_events').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_grid_nursery_events').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_grid_nursery_events').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_grid_nursery_events').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_grid_nursery_events').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_grid_nursery_events').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_grid_nursery_events').style.width  = '0px';
        }
        if (oResp["setValue"]) {
        ...
        if (opc == "igual" && parm_save == "reload") {
            setTimeout(function(){clear_reload = nm_gp_submit_ajax ('igual', 'reload');},30000);
        }
        if (!SC_Link_View)
        {
            if (Qsearch_ok)
