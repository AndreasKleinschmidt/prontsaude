<?php
@session_start() ;
$_SESSION['scriptcase']['grid_nursery_events']['sc_process_barr'] = true;
require_once('../grid_nursery_events/index.php');
unset($_SESSION['scriptcase']['grid_nursery_events']['sc_process_barr']);
$ExportCtrl = new grid_nursery_events_export_control;
$ExportCtrl->Export_barr();

class grid_nursery_events_export_control
{
