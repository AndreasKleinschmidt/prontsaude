...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao'], $this->root . $this->path_prod, 'ProntSaude', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_search_sec_groups']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_search_sec_groups']['label'] = "" . $this->Ini->Nm_lang['lang_othr_srch_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_sec_groups'] . "";
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao'], $this->Ini->root . $this->Ini->path_prod, 'ProntSaude', 1, $this->Ini->force_db_utf8); 
      } 
      else 
      { 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_ProntSaude'])) {
               $_SESSION['scriptcase']['app_search_sec_groups']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_ProntSaude'];
           }
       }
   }
   if (isset($group)) 
