...
?>
  ...
  // ---------- Validate usrname
  function do_ajax_app_form_add_users_mob_validate_usrname()
  {
    var nomeCampo_usrname = "usrname";
    var var_usrname = scAjaxGetFieldText(nomeCampo_usrname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_mob_validate_usrname(var_usrname, var_script_case_init, do_ajax_app_form_add_users_mob_validate_usrname_cb);
  } // do_ajax_app_form_add_users_mob_validate_usrname

  function do_ajax_app_form_add_users_mob_validate_usrname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usrname";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_mob_validate_usrname_cb
  ...
  // ---------- Validate usractive
  function do_ajax_app_form_add_users_mob_validate_usractive()
  {
    var nomeCampo_usractive = "usractive";
    var var_usractive = scAjaxGetFieldCheckbox(nomeCampo_usractive, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_mob_validate_usractive(var_usractive, var_script_case_init, do_ajax_app_form_add_users_mob_validate_usractive_cb);
  } // do_ajax_app_form_add_users_mob_validate_usractive

  function do_ajax_app_form_add_users_mob_validate_usractive_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usractive";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_mob_validate_usractive_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_add_users_mob_submit_form()
  {
    ...
    var var_usrname = scAjaxGetFieldText("usrname");
    ...
    var var_usractive = scAjaxGetFieldCheckbox("usractive", ";");
    ...
    scAjaxProcOn();
    x_ajax_app_form_add_users_mob_submit_form(var_login, var_usrname, var_pswd, var_confirm_pswd, var_email, var_usractive, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_add_users_mob_submit_form_cb);
...
?>
  ...
  ajax_field_list[1] = "usrname";
  ajax_field_list[2] = "pswd";
  ajax_field_list[3] = "confirm_pswd";
  ajax_field_list[4] = "email";
  ajax_field_list[5] = "usractive";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "login": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fld_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "usrname": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fld_usrname'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pswd": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fld_pswd'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "email": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fld_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "usractive": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fld_usractive'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_id = {
    ...
    "usractive": new Array("hidden_field_label_usractive", "hidden_field_data_usractive")
  };
