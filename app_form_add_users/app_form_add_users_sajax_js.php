...
?>
  ...
  // ---------- Validate usrname
  function do_ajax_app_form_add_users_validate_usrname()
  {
    var nomeCampo_usrname = "usrname";
    var var_usrname = scAjaxGetFieldText(nomeCampo_usrname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_usrname(var_usrname, var_script_case_init, do_ajax_app_form_add_users_validate_usrname_cb);
  } // do_ajax_app_form_add_users_validate_usrname

  function do_ajax_app_form_add_users_validate_usrname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usrname";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_usrname_cb
  ...
  // ---------- Validate usractive
  function do_ajax_app_form_add_users_validate_usractive()
  {
    var nomeCampo_usractive = "usractive";
    var var_usractive = scAjaxGetFieldCheckbox(nomeCampo_usractive, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_usractive(var_usractive, var_script_case_init, do_ajax_app_form_add_users_validate_usractive_cb);
  } // do_ajax_app_form_add_users_validate_usractive

  function do_ajax_app_form_add_users_validate_usractive_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_usractive_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_add_users_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_add_users_submit_form(var_login, var_usrname, var_pswd, var_confirm_pswd, var_email, var_usractive, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_add_users_submit_form_cb);
