...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['usractive']))
          {
              $this->usractive = $this->NM_ajax_info['param']['usractive'];
          }
          if (isset($this->NM_ajax_info['param']['usrname']))
          {
              $this->usrname = $this->NM_ajax_info['param']['usrname'];
          }
...
$_SESSION['scriptcase']['app_form_add_users_mob']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_add_users_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_add_users_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_sec_users'] . "";
      ...
      $this->nm_new_label['usrname'] = '' . $this->Ini->Nm_lang['lang_sec_users_fld_usrname'] . '';
      $this->nm_new_label['email'] = '' . $this->Ini->Nm_lang['lang_sec_users_fld_email'] . '';
      $this->nm_new_label['usractive'] = '' . $this->Ini->Nm_lang['lang_sec_users_fld_usractive'] . '';
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['dados_form']))
      {
          ...
          if (!isset($this->usrperfil)){$this->usrperfil = $this->nmgp_dados_form['usrperfil'];} 
      }
...
//
      ...
      if (isset($this->usrname)) { $this->nm_limpa_alfa($this->usrname); }
      if (isset($this->email)) { $this->nm_limpa_alfa($this->email); }
      if (isset($this->usractive)) { $this->nm_limpa_alfa($this->usractive); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
   ...
   function loadFieldConfig()
   {
      ...
      //-- usrperfil
      $this->field_config['usrperfil']               = array();
      $this->field_config['usrperfil']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['usrperfil']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['usrperfil']['symbol_dec'] = '';
      $this->field_config['usrperfil']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['usrperfil']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_usrname' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'usrname');
          }
          ...
          if ('validate_usractive' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'usractive');
          }
          app_form_add_users_mob_pack_ajax_response();
          exit;
      }
      ...
      {
          if (is_array($this->usractive))
          {
              $x = 0; 
              $this->usractive_1 = $this->usractive;
              $this->usractive = ""; 
              if ($this->usractive_1 != "") 
              { 
                  foreach ($this->usractive_1 as $dados_usractive_1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->usractive .= ";";
                      } 
                      $this->usractive .= $dados_usractive_1;
                      $x++ ; 
                  } 
              } 
          } 
...
<HEAD>
 <TITLE><?php echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_sec_users'] . "") ?></TITLE>
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           case 'login':
               ...
               break;
           case 'usrname':
               return "" . $this->Ini->Nm_lang['lang_sec_users_fld_usrname'] . "";
               break;
           case 'pswd':
           ...
           case 'email':
               ...
               break;
           case 'usractive':
               return "" . $this->Ini->Nm_lang['lang_sec_users_fld_usractive'] . "";
               break;
           ...
           case 'priv_admin':
               ...
               break;
           case 'usrperfil':
               return "" . $this->Ini->Nm_lang['lang_sec_users_fld_usrperfil'] . "";
               break;
       }
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'usrname' == $filtro)) || (is_array($filtro) && in_array('usrname', $filtro)))
        $this->ValidateField_usrname($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'usractive' == $filtro)) || (is_array($filtro) && in_array('usractive', $filtro)))
        $this->ValidateField_usractive($Campos_Crit, $Campos_Falta, $Campos_Erros);
    ...
    function ValidateField_usrname(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['usrname'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->usrname) > 64) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_sec_users_fld_usrname'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 64 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['usrname']))
              {
                  $Campos_Erros['usrname'] = array();
              }
              $Campos_Erros['usrname'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 64 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['usrname']) || !is_array($this->NM_ajax_info['errList']['usrname']))
              {
                  $this->NM_ajax_info['errList']['usrname'] = array();
              }
              $this->NM_ajax_info['errList']['usrname'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 64 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_usractive(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['usractive'])) {
       return;
   }
      if ($this->usractive == "" && $this->nmgp_opcao != "excluir")
      { 
          $this->usractive = "N";
      } 
      else 
      { 
          ...
          {
              $x = 0; 
              $this->usractive_1 = array(); 
              foreach ($this->usractive as $ind => $dados_usractive_1 ) 
              {
                  if ($dados_usractive_1 != "") 
                  {
                      $this->usractive_1[] = $dados_usractive_1;
                  } 
              } 
              $this->usractive = ""; 
              foreach ($this->usractive_1 as $dados_usractive_1 ) 
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['usrname'] = $this->usrname;
   ...
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['usrperfil'] = $this->usrperfil;
      nm_limpa_numero($this->usrperfil, $this->field_config['usrperfil']['symbol_grp']) ; 
   }
...
//
   ...
   function ajax_return_values_login($bForce = false)
   {
          ...
          //----- usrname
   function ajax_return_values_usrname($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("usrname", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->usrname);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['usrname'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
   ...
   function ajax_return_values_email($bForce = false)
   {
          ...
          //----- usractive
   function ajax_return_values_usractive($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("usractive", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->usractive);
              $aLookup = array();
              $this->_tmp_lookup_usractive = $this->usractive;

$aLookup[] = array(app_form_add_users_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app_form_add_users_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['Lookup_usractive'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['usractive']) && !empty($this->NM_ajax_info['select_html']['usractive']))
          {
              $sOptComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['usractive']);
          }
          $this->NM_ajax_info['fldList']['usractive'] = array(
                       'row'    => '',
               'type'    => 'checkbox',
               'switch'  => false,
               ...
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-usractive',
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['usractive']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['usractive']['valList'][$i] = app_form_add_users_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['usractive']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['usractive']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['usractive']['labList'] = $aLabel;
          }
   }
...
$_SESSION['scriptcase']['app_form_add_users_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          $this->usrname_before_qstr = $this->usrname;
          $this->usrname = substr($this->Db->qstr($this->usrname), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->usrname = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->usrname);
          }
          if ($this->usrname == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->usrname = "null"; 
              $NM_val_null[] = "usrname";
          } 
          ...
          $this->usractive_before_qstr = $this->usractive;
          $this->usractive = substr($this->Db->qstr($this->usractive), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->usractive = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->usractive);
          }
          if ($this->usractive == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->usractive = "null"; 
              $NM_val_null[] = "usractive";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "usrname = '$this->usrname', usractive = '$this->usractive'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['usrperfil']) && $NM_val_form['usrperfil'] != $this->nmgp_dados_select['usrperfil']) 
              { 
                  $SC_fields_update[] = "usrperfil = $this->usrperfil"; 
              } 
             ...
             { 
              ...
              $this->usrname = $this->usrname_before_qstr;
              $this->email = $this->email_before_qstr;
              $this->usractive = $this->usractive_before_qstr;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['usrname'])) { $this->usrname = $NM_val_form['usrname']; }
              elseif (isset($this->usrname)) { $this->nm_limpa_alfa($this->usrname); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['usractive'])) { $this->usractive = $NM_val_form['usractive']; }
              elseif (isset($this->usractive)) { $this->nm_limpa_alfa($this->usractive); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('login', 'usrname', 'pswd', 'confirm_pswd', 'email', 'usractive'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (login, pswd, usrname, email, usractive, activation_code, priv_admin, usrperfil) VALUES ('$this->login', '$this->pswd', '$this->usrname', '$this->email', '$this->usractive', '$this->activation_code', '$this->priv_admin', $this->usrperfil)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "login, pswd, usrname, email, usractive, activation_code, priv_admin, usrperfil) VALUES (" . $NM_seq_auto . "'$this->login', '$this->pswd', '$this->usrname', '$this->email', '$this->usractive', '$this->activation_code', '$this->priv_admin', $this->usrperfil)"; 
              }
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['reg_start'] = 0; 
              }
...
//---------- 
      ...
      { 
          ...
          { 
              $nmgp_select = "SELECT login, pswd, usrname, email, usractive, activation_code, priv_admin, usrperfil from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT login, pswd, usrname, email, usractive, activation_code, priv_admin, usrperfil from " . $this->Ini->nm_tabela ; 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['reg_start']) ;  
              } 
          } 
          ...
          { 
              ...
              $this->usrname = $rs->fields[2] ; 
              $this->nmgp_dados_select['usrname'] = $this->usrname;
              $this->email = $rs->fields[3] ; 
              $this->nmgp_dados_select['email'] = $this->email;
              $this->usractive = $rs->fields[4] ; 
              $this->nmgp_dados_select['usractive'] = $this->usractive;
              ...
              $this->usrperfil = $rs->fields[7] ; 
              $this->nmgp_dados_select['usrperfil'] = $this->usrperfil;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->usrperfil = (string)$this->usrperfil; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['parms'] = "login?#?$this->login?@?";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['reg_start'] < $qt_geral_reg_app_form_add_users_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['opcao']   = '';
          }
      } 
...
$mail_smtp_server = '';        
$mail_smtp_user = 'vitor';                   
$mail_smtp_pass = 'vitor';			
$mail_from = '';          
$mail_to          = $emails_admin;         

$mail_message     = sprintf( $this->Ini->Nm_lang['lang_new_user_sign_in'] , $name , $this->email , $this->email );
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function Form_lookup_usractive()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "?#?Y?#?S?@?";
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_sec_users'] . ""; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_sec_users'] . ""; } ?></div>
