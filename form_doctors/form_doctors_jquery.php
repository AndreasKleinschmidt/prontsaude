...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_iddoctor' + iSeqRow).bind('blur', function() { sc_form_doctors_iddoctor_onblur('#id_sc_field_iddoctor' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_doctors_iddoctor_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_namedoctor' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_doctors_namedoctor_onblur('#id_sc_field_namedoctor' + iSeqRow, iSeqRow);}, 300) })
                                        .bind('change', function() { sc_form_doctors_namedoctor_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_day1' + iSeqRow).bind('blur', function() { sc_form_doctors_day1_onblur('#id_sc_field_day1' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_doctors_day1_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_day2' + iSeqRow).bind('blur', function() { sc_form_doctors_day2_onblur('#id_sc_field_day2' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_doctors_day2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_day3' + iSeqRow).bind('blur', function() { sc_form_doctors_day3_onblur('#id_sc_field_day3' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_doctors_day3_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_day4' + iSeqRow).bind('blur', function() { sc_form_doctors_day4_onblur('#id_sc_field_day4' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_doctors_day4_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_day5' + iSeqRow).bind('blur', function() { sc_form_doctors_day5_onblur('#id_sc_field_day5' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_doctors_day5_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_speciality_idspeciality' + iSeqRow).bind('blur', function() { sc_form_doctors_speciality_idspeciality_onblur('#id_sc_field_speciality_idspeciality' + iSeqRow, iSeqRow) })
                                                     .bind('change', function() { sc_form_doctors_speciality_idspeciality_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_node_order' + iSeqRow).bind('blur', function() { sc_form_doctors_node_order_onblur('#id_sc_field_node_order' + iSeqRow, iSeqRow) })
                                        .bind('change', function() { sc_form_doctors_node_order_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_treatments_idtreatments' + iSeqRow).bind('blur', function() { sc_form_doctors_treatments_idtreatments_onblur('#id_sc_field_treatments_idtreatments' + iSeqRow, iSeqRow) })
                                                     .bind('change', function() { sc_form_doctors_treatments_idtreatments_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_login' + iSeqRow).bind('blur', function() { sc_form_doctors_login_onblur('#id_sc_field_login' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_form_doctors_login_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_hfri' + iSeqRow).bind('blur', function() { sc_form_doctors_hfri_onblur('#id_sc_field_hfri' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_doctors_hfri_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_hmon' + iSeqRow).bind('blur', function() { sc_form_doctors_hmon_onblur('#id_sc_field_hmon' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_doctors_hmon_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_hthu' + iSeqRow).bind('blur', function() { sc_form_doctors_hthu_onblur('#id_sc_field_hthu' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_doctors_hthu_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_htue' + iSeqRow).bind('blur', function() { sc_form_doctors_htue_onblur('#id_sc_field_htue' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_doctors_htue_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_hwed' + iSeqRow).bind('blur', function() { sc_form_doctors_hwed_onblur('#id_sc_field_hwed' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_doctors_hwed_onchange(this, iSeqRow) })
...
function sc_form_doctors_iddoctor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_namedoctor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_day1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_day2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_day3_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_day4_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_day5_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_speciality_idspeciality_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_node_order_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_treatments_idtreatments_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_login_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_hfri_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_hmon_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_hthu_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_htue_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_doctors_hwed_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
        $("#id_form_doctors_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_doctors')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
