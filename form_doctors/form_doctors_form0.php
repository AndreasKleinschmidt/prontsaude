...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_doctors/form_doctors_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_doctors_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_doctors_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['link_info']['remove_border']) {
...
<?php
 include_once("form_doctors_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_doctors'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_doctors'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
?>
<TABLE align="center" id="hidden_bloco_0" class="scFormTable<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;"><script type="text/javascript">
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_iddoctor_label" id="hidden_field_label_iddoctor" style="<?php echo $sStyleHidden_iddoctor; ?>"><span id="id_label_iddoctor"><?php echo $this->nm_new_label['iddoctor']; ?></span></TD>
    <TD class="scFormDataOdd css_iddoctor_line" id="hidden_field_data_iddoctor" style="<?php echo $sStyleHidden_iddoctor; ?>"><span id="id_read_on_iddoctor" class="css_iddoctor_line" style="<?php echo $sStyleReadLab_iddoctor; ?>"><?php echo $this->form_format_readonly("iddoctor", $this->form_encode_input($this->iddoctor)); ?></span><span id="id_read_off_iddoctor" class="css_read_off_iddoctor" style="<?php echo $sStyleReadInp_iddoctor; ?>"><input type="hidden" name="iddoctor" value="<?php echo $this->form_encode_input($iddoctor) . "\">"?><span id="id_ajax_label_iddoctor"><?php echo nl2br($iddoctor); ?></span>
</span></span></TD>
   <?php }
      else
      {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_namedoctor_label" id="hidden_field_label_namedoctor" style="<?php echo $sStyleHidden_namedoctor; ?>"><span id="id_label_namedoctor"><?php echo $this->nm_new_label['namedoctor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['php_cmp_required']['namedoctor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['php_cmp_required']['namedoctor'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_namedoctor_line" id="hidden_field_data_namedoctor" style="<?php echo $sStyleHidden_namedoctor; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_speciality_idspeciality_label" id="hidden_field_label_speciality_idspeciality" style="<?php echo $sStyleHidden_speciality_idspeciality; ?>"><span id="id_label_speciality_idspeciality"><?php echo $this->nm_new_label['speciality_idspeciality']; ?></span></TD>
    <TD class="scFormDataOdd css_speciality_idspeciality_line" id="hidden_field_data_speciality_idspeciality" style="<?php echo $sStyleHidden_speciality_idspeciality; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_treatments_idtreatments_label" id="hidden_field_label_treatments_idtreatments" style="<?php echo $sStyleHidden_treatments_idtreatments; ?>"><span id="id_label_treatments_idtreatments"><?php echo $this->nm_new_label['treatments_idtreatments']; ?></span></TD>
    <TD class="scFormDataOdd css_treatments_idtreatments_line" id="hidden_field_data_treatments_idtreatments" style="<?php echo $sStyleHidden_treatments_idtreatments; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_node_order_label" id="hidden_field_label_node_order" style="<?php echo $sStyleHidden_node_order; ?>"><span id="id_label_node_order"><?php echo $this->nm_new_label['node_order']; ?></span></TD>
    <TD class="scFormDataOdd css_node_order_line" id="hidden_field_data_node_order" style="<?php echo $sStyleHidden_node_order; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_day1_label" id="hidden_field_label_day1" style="<?php echo $sStyleHidden_day1; ?>"><span id="id_label_day1"><?php echo $this->nm_new_label['day1']; ?></span></TD>
    <TD class="scFormDataOdd css_day1_line" id="hidden_field_data_day1" style="<?php echo $sStyleHidden_day1; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_day2_label" id="hidden_field_label_day2" style="<?php echo $sStyleHidden_day2; ?>"><span id="id_label_day2"><?php echo $this->nm_new_label['day2']; ?></span></TD>
    <TD class="scFormDataOdd css_day2_line" id="hidden_field_data_day2" style="<?php echo $sStyleHidden_day2; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_day3_label" id="hidden_field_label_day3" style="<?php echo $sStyleHidden_day3; ?>"><span id="id_label_day3"><?php echo $this->nm_new_label['day3']; ?></span></TD>
    <TD class="scFormDataOdd css_day3_line" id="hidden_field_data_day3" style="<?php echo $sStyleHidden_day3; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_day4_label" id="hidden_field_label_day4" style="<?php echo $sStyleHidden_day4; ?>"><span id="id_label_day4"><?php echo $this->nm_new_label['day4']; ?></span></TD>
    <TD class="scFormDataOdd css_day4_line" id="hidden_field_data_day4" style="<?php echo $sStyleHidden_day4; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_day5_label" id="hidden_field_label_day5" style="<?php echo $sStyleHidden_day5; ?>"><span id="id_label_day5"><?php echo $this->nm_new_label['day5']; ?></span></TD>
    <TD class="scFormDataOdd css_day5_line" id="hidden_field_data_day5" style="<?php echo $sStyleHidden_day5; ?>">
...
<ul class="scTabLine">
<li id="id_tabs_1_1" class="scTabActive"><a href="javascript: sc_control_tabs_1(1)"><?php echo $this->Ini->Nm_lang['lang_days_mond'] ?></a></li>
<li id="id_tabs_1_2" class="scTabInactive"><a href="javascript: sc_control_tabs_1(2)"><?php echo $this->Ini->Nm_lang['lang_days_tued'] ?></a></li>
<li id="id_tabs_1_3" class="scTabInactive"><a href="javascript: sc_control_tabs_1(3)"><?php echo $this->Ini->Nm_lang['lang_days_wend'] ?></a></li>
<li id="id_tabs_1_4" class="scTabInactive"><a href="javascript: sc_control_tabs_1(4)"><?php echo $this->Ini->Nm_lang['lang_days_thud'] ?></a></li>
<li id="id_tabs_1_5" class="scTabInactive"><a href="javascript: sc_control_tabs_1(5)"><?php echo $this->Ini->Nm_lang['lang_days_frid'] ?></a></li>
</ul>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['bpassfld_rightall']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['bpassfld_rightall']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bpassfld_rightall']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bpassfld_rightall']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bpassfld_rightall'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['bpassfld_right']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['bpassfld_right']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bpassfld_right']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bpassfld_right']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bpassfld_right'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['bpassfld_left']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['bpassfld_left']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bpassfld_left']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bpassfld_left']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bpassfld_left'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['bpassfld_leftall']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['bpassfld_leftall']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bpassfld_leftall']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bpassfld_leftall']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['bpassfld_leftall'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_doctors");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_doctors");
 parent.scAjaxDetailHeight("form_doctors", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
