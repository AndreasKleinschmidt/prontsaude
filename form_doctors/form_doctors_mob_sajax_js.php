  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_doctors_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate iddoctor
  function do_ajax_form_doctors_mob_validate_iddoctor()
  {
    var nomeCampo_iddoctor = "iddoctor";
    var var_iddoctor = scAjaxGetFieldHidden(nomeCampo_iddoctor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_iddoctor(var_iddoctor, var_script_case_init, do_ajax_form_doctors_mob_validate_iddoctor_cb);
  } // do_ajax_form_doctors_mob_validate_iddoctor

  function do_ajax_form_doctors_mob_validate_iddoctor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_iddoctor_cb

  // ---------- Validate namedoctor
  function do_ajax_form_doctors_mob_validate_namedoctor()
  {
    var nomeCampo_namedoctor = "namedoctor";
    var var_namedoctor = scAjaxGetFieldText(nomeCampo_namedoctor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_namedoctor(var_namedoctor, var_script_case_init, do_ajax_form_doctors_mob_validate_namedoctor_cb);
  } // do_ajax_form_doctors_mob_validate_namedoctor

  function do_ajax_form_doctors_mob_validate_namedoctor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_namedoctor_cb

  // ---------- Validate speciality_idspeciality
  function do_ajax_form_doctors_mob_validate_speciality_idspeciality()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_speciality_idspeciality(var_speciality_idspeciality, var_script_case_init, do_ajax_form_doctors_mob_validate_speciality_idspeciality_cb);
  } // do_ajax_form_doctors_mob_validate_speciality_idspeciality

  function do_ajax_form_doctors_mob_validate_speciality_idspeciality_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_speciality_idspeciality_cb

  // ---------- Validate treatments_idtreatments
  function do_ajax_form_doctors_mob_validate_treatments_idtreatments()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_treatments_idtreatments(var_treatments_idtreatments, var_script_case_init, do_ajax_form_doctors_mob_validate_treatments_idtreatments_cb);
  } // do_ajax_form_doctors_mob_validate_treatments_idtreatments

  function do_ajax_form_doctors_mob_validate_treatments_idtreatments_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_treatments_idtreatments_cb

  // ---------- Validate node_order
  function do_ajax_form_doctors_mob_validate_node_order()
  {
    var nomeCampo_node_order = "node_order";
    var var_node_order = scAjaxGetFieldText(nomeCampo_node_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_node_order(var_node_order, var_script_case_init, do_ajax_form_doctors_mob_validate_node_order_cb);
  } // do_ajax_form_doctors_mob_validate_node_order

  function do_ajax_form_doctors_mob_validate_node_order_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_node_order_cb

  // ---------- Validate day1
  function do_ajax_form_doctors_mob_validate_day1()
  {
    var nomeCampo_day1 = "day1";
    var var_day1 = scAjaxGetFieldText(nomeCampo_day1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_day1(var_day1, var_script_case_init, do_ajax_form_doctors_mob_validate_day1_cb);
  } // do_ajax_form_doctors_mob_validate_day1

  function do_ajax_form_doctors_mob_validate_day1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "day1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_day1_cb

  // ---------- Validate day2
  function do_ajax_form_doctors_mob_validate_day2()
  {
    var nomeCampo_day2 = "day2";
    var var_day2 = scAjaxGetFieldText(nomeCampo_day2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_day2(var_day2, var_script_case_init, do_ajax_form_doctors_mob_validate_day2_cb);
  } // do_ajax_form_doctors_mob_validate_day2

  function do_ajax_form_doctors_mob_validate_day2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "day2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_day2_cb

  // ---------- Validate day3
  function do_ajax_form_doctors_mob_validate_day3()
  {
    var nomeCampo_day3 = "day3";
    var var_day3 = scAjaxGetFieldText(nomeCampo_day3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_day3(var_day3, var_script_case_init, do_ajax_form_doctors_mob_validate_day3_cb);
  } // do_ajax_form_doctors_mob_validate_day3

  function do_ajax_form_doctors_mob_validate_day3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "day3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_day3_cb

  // ---------- Validate day4
  function do_ajax_form_doctors_mob_validate_day4()
  {
    var nomeCampo_day4 = "day4";
    var var_day4 = scAjaxGetFieldText(nomeCampo_day4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_day4(var_day4, var_script_case_init, do_ajax_form_doctors_mob_validate_day4_cb);
  } // do_ajax_form_doctors_mob_validate_day4

  function do_ajax_form_doctors_mob_validate_day4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "day4";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_day4_cb

  // ---------- Validate day5
  function do_ajax_form_doctors_mob_validate_day5()
  {
    var nomeCampo_day5 = "day5";
    var var_day5 = scAjaxGetFieldText(nomeCampo_day5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_day5(var_day5, var_script_case_init, do_ajax_form_doctors_mob_validate_day5_cb);
  } // do_ajax_form_doctors_mob_validate_day5

  function do_ajax_form_doctors_mob_validate_day5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "day5";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_day5_cb

  // ---------- Validate login
  function do_ajax_form_doctors_mob_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldSelect(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_login(var_login, var_script_case_init, do_ajax_form_doctors_mob_validate_login_cb);
  } // do_ajax_form_doctors_mob_validate_login

  function do_ajax_form_doctors_mob_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_login_cb

  // ---------- Validate hmon
  function do_ajax_form_doctors_mob_validate_hmon()
  {
    var nomeCampo_hmon = "hmon";
    nm_pack(nomeCampo_hmon + '_dest', nomeCampo_hmon);
    var var_hmon = scAjaxGetFieldText(nomeCampo_hmon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_hmon(var_hmon, var_script_case_init, do_ajax_form_doctors_mob_validate_hmon_cb);
  } // do_ajax_form_doctors_mob_validate_hmon

  function do_ajax_form_doctors_mob_validate_hmon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hmon";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_hmon_cb

  // ---------- Validate htue
  function do_ajax_form_doctors_mob_validate_htue()
  {
    var nomeCampo_htue = "htue";
    nm_pack(nomeCampo_htue + '_dest', nomeCampo_htue);
    var var_htue = scAjaxGetFieldText(nomeCampo_htue);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_htue(var_htue, var_script_case_init, do_ajax_form_doctors_mob_validate_htue_cb);
  } // do_ajax_form_doctors_mob_validate_htue

  function do_ajax_form_doctors_mob_validate_htue_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "htue";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_htue_cb

  // ---------- Validate hwed
  function do_ajax_form_doctors_mob_validate_hwed()
  {
    var nomeCampo_hwed = "hwed";
    nm_pack(nomeCampo_hwed + '_dest', nomeCampo_hwed);
    var var_hwed = scAjaxGetFieldText(nomeCampo_hwed);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_hwed(var_hwed, var_script_case_init, do_ajax_form_doctors_mob_validate_hwed_cb);
  } // do_ajax_form_doctors_mob_validate_hwed

  function do_ajax_form_doctors_mob_validate_hwed_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hwed";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_hwed_cb

  // ---------- Validate hthu
  function do_ajax_form_doctors_mob_validate_hthu()
  {
    var nomeCampo_hthu = "hthu";
    nm_pack(nomeCampo_hthu + '_dest', nomeCampo_hthu);
    var var_hthu = scAjaxGetFieldText(nomeCampo_hthu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_hthu(var_hthu, var_script_case_init, do_ajax_form_doctors_mob_validate_hthu_cb);
  } // do_ajax_form_doctors_mob_validate_hthu

  function do_ajax_form_doctors_mob_validate_hthu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hthu";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_hthu_cb

  // ---------- Validate hfri
  function do_ajax_form_doctors_mob_validate_hfri()
  {
    var nomeCampo_hfri = "hfri";
    nm_pack(nomeCampo_hfri + '_dest', nomeCampo_hfri);
    var var_hfri = scAjaxGetFieldText(nomeCampo_hfri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_mob_validate_hfri(var_hfri, var_script_case_init, do_ajax_form_doctors_mob_validate_hfri_cb);
  } // do_ajax_form_doctors_mob_validate_hfri

  function do_ajax_form_doctors_mob_validate_hfri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hfri";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_mob_validate_hfri_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_doctors_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_doctors_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_doctors_mob_submit_form(var_iddoctor, var_namedoctor, var_speciality_idspeciality, var_treatments_idtreatments, var_node_order, var_day1, var_day2, var_day3, var_day4, var_day5, var_login, var_hmon, var_htue, var_hwed, var_hthu, var_hfri, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_doctors_mob_submit_form_cb);
  } // do_ajax_form_doctors_mob_submit_form

  function do_ajax_form_doctors_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_doctors_mob_submit_form_cb_after_alert);
  } // do_ajax_form_doctors_mob_submit_form_cb
  function do_ajax_form_doctors_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_doctors_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_doctors_mob_navigate_form()
  {
    perform_ajax_form_doctors_mob_navigate_form();
  }

  function perform_ajax_form_doctors_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_doctors_mob_navigate_form(var_iddoctor, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_doctors_mob_navigate_form_cb);
  } // do_ajax_form_doctors_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_doctors_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_doctors_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_doctors_mob_navigate_form_cb
  function do_ajax_form_doctors_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_doctors_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_doctors_mob_navigate_form_cb_after_alert

  function sc_hide_form_doctors_mob_form()
  {
