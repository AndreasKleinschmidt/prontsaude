  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_doctors" == sTestField)
        {
...
?>
  ...
  // ---------- Validate iddoctor
  function do_ajax_form_doctors_validate_iddoctor()
  {
    var nomeCampo_iddoctor = "iddoctor";
    var var_iddoctor = scAjaxGetFieldHidden(nomeCampo_iddoctor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_iddoctor(var_iddoctor, var_script_case_init, do_ajax_form_doctors_validate_iddoctor_cb);
  } // do_ajax_form_doctors_validate_iddoctor

  function do_ajax_form_doctors_validate_iddoctor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "iddoctor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_iddoctor_cb

  // ---------- Validate namedoctor
  function do_ajax_form_doctors_validate_namedoctor()
  {
    var nomeCampo_namedoctor = "namedoctor";
    var var_namedoctor = scAjaxGetFieldText(nomeCampo_namedoctor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_namedoctor(var_namedoctor, var_script_case_init, do_ajax_form_doctors_validate_namedoctor_cb);
  } // do_ajax_form_doctors_validate_namedoctor

  function do_ajax_form_doctors_validate_namedoctor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "namedoctor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_namedoctor_cb

  // ---------- Validate speciality_idspeciality
  function do_ajax_form_doctors_validate_speciality_idspeciality()
  {
    var nomeCampo_speciality_idspeciality = "speciality_idspeciality";
    var var_speciality_idspeciality = scAjaxGetFieldSelect(nomeCampo_speciality_idspeciality);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_speciality_idspeciality(var_speciality_idspeciality, var_script_case_init, do_ajax_form_doctors_validate_speciality_idspeciality_cb);
  } // do_ajax_form_doctors_validate_speciality_idspeciality

  function do_ajax_form_doctors_validate_speciality_idspeciality_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "speciality_idspeciality";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_speciality_idspeciality_cb

  // ---------- Validate treatments_idtreatments
  function do_ajax_form_doctors_validate_treatments_idtreatments()
  {
    var nomeCampo_treatments_idtreatments = "treatments_idtreatments";
    var var_treatments_idtreatments = scAjaxGetFieldSelect(nomeCampo_treatments_idtreatments);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_treatments_idtreatments(var_treatments_idtreatments, var_script_case_init, do_ajax_form_doctors_validate_treatments_idtreatments_cb);
  } // do_ajax_form_doctors_validate_treatments_idtreatments

  function do_ajax_form_doctors_validate_treatments_idtreatments_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "treatments_idtreatments";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_treatments_idtreatments_cb

  // ---------- Validate node_order
  function do_ajax_form_doctors_validate_node_order()
  {
    var nomeCampo_node_order = "node_order";
    var var_node_order = scAjaxGetFieldText(nomeCampo_node_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_node_order(var_node_order, var_script_case_init, do_ajax_form_doctors_validate_node_order_cb);
  } // do_ajax_form_doctors_validate_node_order

  function do_ajax_form_doctors_validate_node_order_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "node_order";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_node_order_cb

  // ---------- Validate day1
  function do_ajax_form_doctors_validate_day1()
  {
    var nomeCampo_day1 = "day1";
    var var_day1 = scAjaxGetFieldText(nomeCampo_day1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_day1(var_day1, var_script_case_init, do_ajax_form_doctors_validate_day1_cb);
  } // do_ajax_form_doctors_validate_day1

  function do_ajax_form_doctors_validate_day1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "day1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_day1_cb

  // ---------- Validate day2
  function do_ajax_form_doctors_validate_day2()
  {
    var nomeCampo_day2 = "day2";
    var var_day2 = scAjaxGetFieldText(nomeCampo_day2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_day2(var_day2, var_script_case_init, do_ajax_form_doctors_validate_day2_cb);
  } // do_ajax_form_doctors_validate_day2

  function do_ajax_form_doctors_validate_day2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "day2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_day2_cb

  // ---------- Validate day3
  function do_ajax_form_doctors_validate_day3()
  {
    var nomeCampo_day3 = "day3";
    var var_day3 = scAjaxGetFieldText(nomeCampo_day3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_day3(var_day3, var_script_case_init, do_ajax_form_doctors_validate_day3_cb);
  } // do_ajax_form_doctors_validate_day3

  function do_ajax_form_doctors_validate_day3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "day3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_day3_cb

  // ---------- Validate day4
  function do_ajax_form_doctors_validate_day4()
  {
    var nomeCampo_day4 = "day4";
    var var_day4 = scAjaxGetFieldText(nomeCampo_day4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_day4(var_day4, var_script_case_init, do_ajax_form_doctors_validate_day4_cb);
  } // do_ajax_form_doctors_validate_day4

  function do_ajax_form_doctors_validate_day4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "day4";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_day4_cb

  // ---------- Validate day5
  function do_ajax_form_doctors_validate_day5()
  {
    var nomeCampo_day5 = "day5";
    var var_day5 = scAjaxGetFieldText(nomeCampo_day5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_day5(var_day5, var_script_case_init, do_ajax_form_doctors_validate_day5_cb);
  } // do_ajax_form_doctors_validate_day5

  function do_ajax_form_doctors_validate_day5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "day5";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_day5_cb

  // ---------- Validate login
  function do_ajax_form_doctors_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldSelect(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_login(var_login, var_script_case_init, do_ajax_form_doctors_validate_login_cb);
  } // do_ajax_form_doctors_validate_login

  function do_ajax_form_doctors_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_login_cb

  // ---------- Validate hmon
  function do_ajax_form_doctors_validate_hmon()
  {
    var nomeCampo_hmon = "hmon";
    nm_pack(nomeCampo_hmon + '_dest', nomeCampo_hmon);
    var var_hmon = scAjaxGetFieldText(nomeCampo_hmon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_hmon(var_hmon, var_script_case_init, do_ajax_form_doctors_validate_hmon_cb);
  } // do_ajax_form_doctors_validate_hmon

  function do_ajax_form_doctors_validate_hmon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hmon";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_hmon_cb

  // ---------- Validate htue
  function do_ajax_form_doctors_validate_htue()
  {
    var nomeCampo_htue = "htue";
    nm_pack(nomeCampo_htue + '_dest', nomeCampo_htue);
    var var_htue = scAjaxGetFieldText(nomeCampo_htue);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_htue(var_htue, var_script_case_init, do_ajax_form_doctors_validate_htue_cb);
  } // do_ajax_form_doctors_validate_htue

  function do_ajax_form_doctors_validate_htue_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "htue";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_htue_cb

  // ---------- Validate hwed
  function do_ajax_form_doctors_validate_hwed()
  {
    var nomeCampo_hwed = "hwed";
    nm_pack(nomeCampo_hwed + '_dest', nomeCampo_hwed);
    var var_hwed = scAjaxGetFieldText(nomeCampo_hwed);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_hwed(var_hwed, var_script_case_init, do_ajax_form_doctors_validate_hwed_cb);
  } // do_ajax_form_doctors_validate_hwed

  function do_ajax_form_doctors_validate_hwed_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hwed";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_hwed_cb

  // ---------- Validate hthu
  function do_ajax_form_doctors_validate_hthu()
  {
    var nomeCampo_hthu = "hthu";
    nm_pack(nomeCampo_hthu + '_dest', nomeCampo_hthu);
    var var_hthu = scAjaxGetFieldText(nomeCampo_hthu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_hthu(var_hthu, var_script_case_init, do_ajax_form_doctors_validate_hthu_cb);
  } // do_ajax_form_doctors_validate_hthu

  function do_ajax_form_doctors_validate_hthu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hthu";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_hthu_cb

  // ---------- Validate hfri
  function do_ajax_form_doctors_validate_hfri()
  {
    var nomeCampo_hfri = "hfri";
    nm_pack(nomeCampo_hfri + '_dest', nomeCampo_hfri);
    var var_hfri = scAjaxGetFieldText(nomeCampo_hfri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_doctors_validate_hfri(var_hfri, var_script_case_init, do_ajax_form_doctors_validate_hfri_cb);
  } // do_ajax_form_doctors_validate_hfri

  function do_ajax_form_doctors_validate_hfri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hfri";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_doctors_validate_hfri_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_doctors_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_doctors_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_iddoctor = scAjaxGetFieldHidden("iddoctor");
    var var_namedoctor = scAjaxGetFieldText("namedoctor");
    var var_speciality_idspeciality = scAjaxGetFieldSelect("speciality_idspeciality");
    var var_treatments_idtreatments = scAjaxGetFieldSelect("treatments_idtreatments");
    var var_node_order = scAjaxGetFieldText("node_order");
    var var_day1 = scAjaxGetFieldText("day1");
    var var_day2 = scAjaxGetFieldText("day2");
    var var_day3 = scAjaxGetFieldText("day3");
    var var_day4 = scAjaxGetFieldText("day4");
    var var_day5 = scAjaxGetFieldText("day5");
    var var_login = scAjaxGetFieldSelect("login");
    nm_pack("hmon_dest", "hmon");
    var var_hmon = scAjaxGetFieldText("hmon", "@?@");
    nm_pack("htue_dest", "htue");
    var var_htue = scAjaxGetFieldText("htue", "@?@");
    nm_pack("hwed_dest", "hwed");
    var var_hwed = scAjaxGetFieldText("hwed", "@?@");
    nm_pack("hthu_dest", "hthu");
    var var_hthu = scAjaxGetFieldText("hthu", "@?@");
    nm_pack("hfri_dest", "hfri");
    var var_hfri = scAjaxGetFieldText("hfri", "@?@");
    ...
    scAjaxProcOn();
    x_ajax_form_doctors_submit_form(var_iddoctor, var_namedoctor, var_speciality_idspeciality, var_treatments_idtreatments, var_node_order, var_day1, var_day2, var_day3, var_day4, var_day5, var_login, var_hmon, var_htue, var_hwed, var_hthu, var_hfri, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_doctors_submit_form_cb);
  } // do_ajax_form_doctors_submit_form

  function do_ajax_form_doctors_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_doctors_submit_form_cb_after_alert);
  } // do_ajax_form_doctors_submit_form_cb
  function do_ajax_form_doctors_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_doctors_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_doctors_navigate_form()
  {
    perform_ajax_form_doctors_navigate_form();
  }

  function perform_ajax_form_doctors_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_iddoctor = document.F2.iddoctor.value;
    ...
    scAjaxProcOn();
    x_ajax_form_doctors_navigate_form(var_iddoctor, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_doctors_navigate_form_cb);
  } // do_ajax_form_doctors_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_doctors_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.iddoctor.value = scAjaxGetKeyValue("iddoctor");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_doctors_navigate_form_cb_after_alert);
  } // do_ajax_form_doctors_navigate_form_cb
  function do_ajax_form_doctors_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_doctors_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_doctors_navigate_form_cb_after_alert

  function sc_hide_form_doctors_form()
  {
  ...
  ajax_field_list[0] = "iddoctor";
  ajax_field_list[1] = "namedoctor";
  ajax_field_list[2] = "speciality_idspeciality";
  ajax_field_list[3] = "treatments_idtreatments";
  ajax_field_list[4] = "node_order";
  ajax_field_list[5] = "day1";
  ajax_field_list[6] = "day2";
  ajax_field_list[7] = "day3";
  ajax_field_list[8] = "day4";
  ajax_field_list[9] = "day5";
  ajax_field_list[10] = "login";
  ajax_field_list[11] = "hmon";
  ajax_field_list[12] = "htue";
  ajax_field_list[13] = "hwed";
  ajax_field_list[14] = "hthu";
  ajax_field_list[15] = "hfri";
  ...
  var ajax_error_list = {
    "iddoctor": {"label": "<?php echo $this->Ini->Nm_lang['lang_doctors_fld_iddoctor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "namedoctor": {"label": "<?php echo $this->Ini->Nm_lang['lang_doctors_fld_namedoctor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "speciality_idspeciality": {"label": "<?php echo $this->Ini->Nm_lang['lang_doctors_fld_speciality_idspeciality'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "treatments_idtreatments": {"label": "<?php echo $this->Ini->Nm_lang['lang_doctors_fld_treatments_idtreatments'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "node_order": {"label": "<?php echo $this->Ini->Nm_lang['lang_doctors_fld_node_order'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "day1": {"label": "<?php echo $this->Ini->Nm_lang['lang_doctors_fld_day1'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "day2": {"label": "<?php echo $this->Ini->Nm_lang['lang_doctors_fld_day2'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "day3": {"label": "<?php echo $this->Ini->Nm_lang['lang_doctors_fld_day3'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "day4": {"label": "<?php echo $this->Ini->Nm_lang['lang_doctors_fld_day4'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "day5": {"label": "<?php echo $this->Ini->Nm_lang['lang_doctors_fld_day5'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "login": {"label": "<?php echo $this->Ini->Nm_lang['lang_nurses_fld_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "hmon": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "htue": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "hwed": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "hthu": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "hfri": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "iddoctor": new Array(),
    "namedoctor": new Array(),
    "speciality_idspeciality": new Array(),
    "treatments_idtreatments": new Array(),
    "node_order": new Array(),
    "day1": new Array(),
    "day2": new Array(),
    "day3": new Array(),
    "day4": new Array(),
  ...
  ajax_field_mult["iddoctor"][1] = "iddoctor";
  ajax_field_mult["namedoctor"][1] = "namedoctor";
  ajax_field_mult["speciality_idspeciality"][1] = "speciality_idspeciality";
  ajax_field_mult["treatments_idtreatments"][1] = "treatments_idtreatments";
  ajax_field_mult["node_order"][1] = "node_order";
  ajax_field_mult["day1"][1] = "day1";
  ajax_field_mult["day2"][1] = "day2";
  ajax_field_mult["day3"][1] = "day3";
  ajax_field_mult["day4"][1] = "day4";
  ajax_field_mult["day5"][1] = "day5";
  ajax_field_mult["login"][1] = "login";
  ajax_field_mult["hmon"][1] = "hmon";
  ajax_field_mult["htue"][1] = "htue";
  ajax_field_mult["hwed"][1] = "hwed";
  ajax_field_mult["hthu"][1] = "hthu";
  ajax_field_mult["hfri"][1] = "hfri";

  var ajax_field_id = {
    "iddoctor": new Array("hidden_field_label_iddoctor", "hidden_field_data_iddoctor"),
    "namedoctor": new Array("hidden_field_label_namedoctor", "hidden_field_data_namedoctor"),
    "speciality_idspeciality": new Array("hidden_field_label_speciality_idspeciality", "hidden_field_data_speciality_idspeciality"),
    "treatments_idtreatments": new Array("hidden_field_label_treatments_idtreatments", "hidden_field_data_treatments_idtreatments"),
    "node_order": new Array("hidden_field_label_node_order", "hidden_field_data_node_order"),
    "login": new Array("hidden_field_label_login", "hidden_field_data_login"),
    "hmon": new Array("hidden_field_label_hmon", "hidden_field_data_hmon"),
    "htue": new Array("hidden_field_label_htue", "hidden_field_data_htue"),
    "hwed": new Array("hidden_field_label_hwed", "hidden_field_data_hwed"),
    "hthu": new Array("hidden_field_label_hthu", "hidden_field_data_hthu"),
    "hfri": new Array("hidden_field_label_hfri", "hidden_field_data_hfri")
  };

  var ajax_read_only = {
    "iddoctor": "on",
    "namedoctor": "off",
    "speciality_idspeciality": "off",
    "treatments_idtreatments": "off",
    "node_order": "off",
    "day1": "off",
    "day2": "off",
    "day3": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("speciality_idspeciality" == sIndex)
    {
    ...
    if ("treatments_idtreatments" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
