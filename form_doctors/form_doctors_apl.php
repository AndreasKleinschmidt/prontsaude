...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_doctors']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_doctors']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_doctors']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_doctors']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_doctors']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_doctors']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_doctors']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_doctors']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->lang)) 
          {
              $_SESSION['lang'] = $this->lang;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_doctors']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_doctors']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_doctors']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_doctors']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_doctors']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_doctors']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_doctors']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_doctors']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_doctors']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_doctors_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("en_us");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_doctors']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_doctors']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_doctors'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_doctors']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_doctors']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_doctors') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_doctors']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_doctors'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['form_doctors']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_doctors'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_doctors']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_doctors'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_doctors'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_doctors_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_doctors_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_doctors/form_doctors_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_doctors_erro.class.php"); 
      }
      $this->Erro      = new form_doctors_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opcao']))
         { 
             if ($this->iddoctor != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_doctors']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opcao'] = "novo";
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_doctors']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_doctors']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_doctors.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_doctors_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_doctors"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_doctors']) || !is_array($this->NM_ajax_info['errList']['geral_form_doctors']))
              {
                  $this->NM_ajax_info['errList']['geral_form_doctors'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_doctors'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_namedoctor(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['php_cmp_required']['namedoctor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['php_cmp_required']['namedoctor'] == "on")) 
      { 
          if ($this->namedoctor == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['speciality_idspeciality'])) {
       return;
               ...
               if (!empty($this->speciality_idspeciality) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_speciality_idspeciality']) && !in_array($this->speciality_idspeciality, $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_speciality_idspeciality']))
               {
                   $hasError = true;
   ...
   if (isset($this->Field_no_validate['treatments_idtreatments'])) {
       return;
               ...
               if (!empty($this->treatments_idtreatments) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_treatments_idtreatments']) && !in_array($this->treatments_idtreatments, $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_treatments_idtreatments']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_node_order(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->node_order, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
   ...
   if (isset($this->Field_no_validate['login'])) {
       return;
               ...
               if (!empty($this->login) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_login']) && !in_array($this->login, $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_login']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
      ...
      if ($this->hmon != "")
      {
          ...
          { 
              ...
              { 
                       ...
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hmon']) && !in_array($dados_hmon_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hmon']))
                       {
                           $hasError = true;
                           $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
      ...
      if ($this->htue != "")
      {
          ...
          { 
              ...
              { 
                       ...
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_htue']) && !in_array($dados_htue_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_htue']))
                       {
                           $hasError = true;
                           $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
      ...
      if ($this->hwed != "")
      {
          ...
          { 
              ...
              { 
                       ...
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hwed']) && !in_array($dados_hwed_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hwed']))
                       {
                           $hasError = true;
                           $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
      ...
      if ($this->hthu != "")
      {
          ...
          { 
              ...
              { 
                       ...
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hthu']) && !in_array($dados_hthu_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hthu']))
                       {
                           $hasError = true;
                           $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
      ...
      if ($this->hfri != "")
      {
          ...
          { 
              ...
              { 
                       ...
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hfri']) && !in_array($dados_hfri_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hfri']))
                       {
                           $hasError = true;
                           $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['iddoctor']['keyVal'] = form_doctors_pack_protect_string($this->nmgp_dados_form['iddoctor']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_speciality_idspeciality']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_speciality_idspeciality'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_speciality_idspeciality']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_speciality_idspeciality'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_doctors_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_doctors_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_speciality_idspeciality'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['speciality_idspeciality']['valList'][$i] = form_doctors_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_treatments_idtreatments']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_treatments_idtreatments'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_treatments_idtreatments']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_treatments_idtreatments'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_treatments_idtreatments'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['treatments_idtreatments']['valList'][$i] = form_doctors_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_login']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_login'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_login']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_login'] = array(); 
}
$aLookup[] = array(form_doctors_pack_protect_string('') => str_replace('<', '&lt;',form_doctors_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_login'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_login'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['login']['valList'][$i] = form_doctors_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hmon']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hmon'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hmon']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hmon'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hmon'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_htue']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_htue'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_htue']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_htue'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_htue'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hwed']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hwed'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hwed']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hwed'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hwed'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hthu']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hthu'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hthu']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hthu'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hthu'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hfri']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hfri'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hfri']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hfri'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Lookup_hfri'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
//----------- 
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['form_doctors']['contr_erro'] = 'on';
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_doctors';
...
$_SESSION['scriptcase']['form_doctors']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['parms'] = "iddoctor?#?$this->iddoctor?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_doctors = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['total'] = $qt_geral_reg_form_doctors;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->iddoctor))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_doctors = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] > $qt_geral_reg_form_doctors)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] = $qt_geral_reg_form_doctors; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_doctors) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] < $qt_geral_reg_form_doctors;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_doctors_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_doctors = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['total'] = $qt_geral_reg_form_doctors;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_doctors_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_doctors_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_doctors_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_doctors']['ordem_ord'] == " desc") {
