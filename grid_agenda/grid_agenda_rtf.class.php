...
$_SESSION['scriptcase']['grid_agenda']['contr_erro'] = 'off'; 
   ...
   function NM_export_idevent_priority()
   {
         ...
         $this->look_idevent_priority = str_replace('<', '&lt;', $this->look_idevent_priority);
         $this->look_idevent_priority = str_replace('>', '&gt;', $this->look_idevent_priority);
         $this->Texto_tag .= "<td>" . $this->look_idevent_priority . "</td>\r\n";
   }
   //----- start_time
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_agenda_day'] ?>:  <?php echo $_SESSION['var_doctorname'] ?> :: RTF</TITLE>
