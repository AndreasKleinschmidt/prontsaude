...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_agenda']['opc_pdf']['all_cab']     = (isset($aParams['pdf_all_cab']))     ? $aParams['pdf_all_cab']     : "N";
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_agenda']['opc_pdf']['all_label']   = (isset($aParams['pdf_all_label']))   ? $aParams['pdf_all_label']   : "N";
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_agenda']['opc_pdf']['label_group'] = (isset($aParams['pdf_label_group'])) ? $aParams['pdf_label_group'] : "S";
...
<head>
 <title><?php echo $Nm_lang['lang_agenda_day'] ?>:  <?php echo $_SESSION['var_doctorname'] ?> :: PDF</title>
