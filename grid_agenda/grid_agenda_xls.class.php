...
$_SESSION['scriptcase']['grid_agenda']['contr_erro'] = 'off'; 
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "idevent_priority" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
   ...
   function NM_export_idevent_priority()
   {
         ...
         if (is_numeric($this->look_idevent_priority))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_idevent_priority);
         $this->Xls_col++;
   }
   //----- start_time
   ...
   //----- idevent_priority
   function NM_sub_cons_idevent_priority()
   {
         $this->look_idevent_priority = NM_charset_to_utf8($this->look_idevent_priority);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_idevent_priority;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
 ...
 function quebra_start_date_q1($start_date) 
 {
   ...
   function quebra_start_date_q1_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_agenda_day'] ?>:  <?php echo $_SESSION['var_doctorname'] ?> :: Excel</TITLE>
