...
class grid_agenda_total
{
   ...
   //----- 
   function Calc_resumo_q1($destino_resumo, $res_export=false, $ind_compara="", $tipo="")
   {
      global $nm_lang;
      $this->nm_data = new nm_data("en_us");
      ...
      $cmps_quebra_atual = array("start_date");
   ...
   function Res_Totaliza_q1($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export)
   {
      ...
      $format_dimensions['start_date']['reg'] = "S";
      $format_dimensions['start_date']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
   ...
   {
      global $nada, $nm_lang , $idevent_priority, $categ, $patients_idpatient, $idevent_status;
   ...
   //-----  start_date
   function quebra_start_date_q1($start_date, $arg_sum_start_date) 
   {
      global $tot_start_date, $idevent_priority, $categ, $patients_idpatient, $idevent_status;
      $tot_start_date = array() ;  
      $tot_start_date[0] = $start_date ; 
   }
