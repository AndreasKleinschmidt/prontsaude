<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_agenda']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['idevent_priority'] = "idevent_priority";
   $tab_labels["idevent_priority"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda']['labels']["idevent_priority"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda']['labels']["idevent_priority"] : "" . $this->Nm_lang['lang_event_fld_idevent_priority'] . "";
   $tab_ger_campos['start_time'] = "on";
   $tab_def_campos['start_time'] = "start_time";
   $tab_labels["start_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda']['labels']["start_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda']['labels']["start_time"] : "" . $this->Nm_lang['lang_event_fld_start_time'] . "";
   $tab_ger_campos['categ'] = "on";
   $tab_def_campos['categ'] = "categ";
   $tab_labels["categ"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda']['labels']["categ"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda']['labels']["categ"] : "" . $this->Nm_lang['lang_event_fld_categ'] . "";
   $tab_ger_campos['patients_idpatient'] = "on";
   $tab_def_campos['patients_idpatient'] = "patients_idpatient";
   $tab_labels["patients_idpatient"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda']['labels']["patients_idpatient"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda']['labels']["patients_idpatient"] : "" . $this->Nm_lang['lang_event_fld_patients_idpatient'] . "";
   $tab_ger_campos['idevent_status'] = "on";
   $tab_def_campos['idevent_status'] = "idevent_status";
   $tab_labels["idevent_status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_agenda']['labels']["idevent_status"])) ? $_SESSION['sc_session'][$sc_init]['grid_agenda']['labels']["idevent_status"] : "" . $this->Nm_lang['lang_event_fld_idevent_status'] . "";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_agenda_day'] ?>:  <?php echo $_SESSION['var_doctorname'] ?></TITLE>
