<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_agenda']['glo_nm_perfil']          = "conn_example";
   $_SESSION['scriptcase']['grid_agenda']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['grid_agenda']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['grid_agenda']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['grid_agenda']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['grid_agenda']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['grid_agenda']['glo_nm_path_doc']        = "";
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda']['dashboard_info']['remove_background'] = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_background'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_agenda']['dashboard_info']['remove_background'] = 1 == $_GET['remove_background'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_background)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_agenda']['dashboard_info']['remove_background'] = 1 == $remove_background;
              }
          }
      }
      ...
      if (is_file($this->root . $this->path_link . "_lib/_app_data/form_patients_ini.php"))
      {
          require($this->root . $this->path_link . "_lib/_app_data/form_patients_ini.php");
      ...
      $this->sc_lig_target["C_@scinf_patients_idpatient"] = '_blank';
      $this->sc_lig_target["C_@scinf_patients_idpatient_@scinf_form_patients"] = '_blank';
      if ($_SESSION['sc_session'][$this->sc_page]['grid_agenda']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_remove_background) && 'ok' == $link_remove_background) {
            ...
            $_SESSION['sc_session'][$this->sc_page]['grid_agenda']['link_info']['remove_background'] = true;
        }
        if (isset($link_margin_top) && '' != $link_margin_top) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_agenda']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_agenda']['link_info']['margin_top'] = $link_margin_top;
        }

      $this->link_form_patients_edit =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_patients') . "/" ; 
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
$_SESSION['scriptcase']['nmamp'] = array(60, 100, 105, 118, 32, 115, 116, 121, 108, 101, 61, 34, 102, 111, 110, 116, 45, 102, 97, 109, 105, 108, 121, 58, 32, 84, 97, 104, 111, 109, 97, 44, 32, 65, 114, 105, 97, 108, 44, 32, 115, 97, 110, 115, 45, 115, 101, 114, 105, 102, 59, 32, 102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 32, 49, 51, 112, 120, 59, 32, 102, 111, 110, 116, 45, 119, 101, 105, 103, 104, 116, 58, 32, 98, 111, 108, 100, 59, 32, 116, 101, 120, 116, 45, 97, 108, 105, 103, 110, 58, 32, 99, 101, 110, 116, 101, 114, 34, 62, 84, 104, 105, 115, 32, 97, 112, 112, 108, 105, 99, 97, 116, 105, 111, 110, 32, 119, 97, 115, 32, 100, 101, 118, 101, 108, 111, 112, 101, 100, 32, 97, 110, 100, 32, 112, 117, 98, 108, 105, 115, 104, 101, 100, 32, 117, 115, 105, 110, 103, 32, 97, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32, 83, 99, 114, 105, 112, 116, 67, 97, 115, 101, 32, 97, 110, 100, 32, 105, 116, 115, 32, 116, 114, 105, 97, 108, 32, 112, 101, 114, 105, 111, 100, 32, 104, 97, 115, 32, 101, 120, 112, 105, 114, 101, 100, 46, 60, 47, 100, 105, 118, 62);
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_agenda']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['grid_agenda']['initialize'])  
      { 
...
{
	$_SESSION['scriptcase']['sc_apl_conf']['grid_agenda']['start'] = 'filter';
}else{
	if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_agenda']['start']))
{
unset($_SESSION['scriptcase']['sc_apl_conf']['grid_agenda']['start']);
}
;
}
...
$_SESSION['scriptcase']['grid_agenda']['contr_erro'] = 'off'; 
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda']['initialize'] = false;
      } 
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_agenda']['glo_nm_conexao'], $this->root . $this->path_prod, 'ProntSaude', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      $this->List_apl_lig = array('form_patients'=>array('type'=>'form', 'lab'=>'' . $this->Ini->Nm_lang['lang_tbl_medical_history'] . '', 'hint'=>'', 'img_on'=>'', 'img_off'=>'', 'fa_icon'=>''));
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['sc_modal']))
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['emb_lig_aba'] = $this->Ini->Init_apl_lig;
          }
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_agenda']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_agenda']['label'] = "" . $this->Ini->Nm_lang['lang_agenda_day'] . ":  " . $_SESSION['var_doctorname'] . "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['SC_Gb_prefix_date_format']['q1']['start_date'] = "" . $this->Ini->Nm_lang['lang_othr_valueYYYYMMDD2'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['SC_Gb_date_format']['q1']['start_date'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['SC_Gb_date_format']['q1']['start_date'] = 'YYYYMMDD2';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['SC_Gb_def_sql']['q1']['start_date'] = 'start_date';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['SC_All_Groupby'] = array('q1' => 'all');
      ...
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['SC_Ind_Groupby'] == "q1")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Labels_GB'][] = sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", "" . $this->Ini->Nm_lang['lang_event_fld_start_date'] . "");
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['q1']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['q1'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_order']['q1'][] = 2;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_control']['q1']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_control']['q1'] = array(
               array(
                   'cmp_res' => "NM_Count",
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "idevent_priority";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "start_time";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "categ";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "patients_idpatient";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "idevent_status";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "idevent";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "title";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "descr";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "start_date";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "end_date";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['usr_cmp_sel']['idevent'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['usr_cmp_sel']['title'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['usr_cmp_sel']['descr'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['usr_cmp_sel']['start_date'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['usr_cmp_sel']['end_date'] = "off";
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      foreach ($fields as $field) {
          ...
          {
              $this->SC_monta_condicao($comando, "doctor_iddoctor", $arg_search, str_replace(",", ".", $data_search));
          }
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_agenda_day'] ?>:  <?php echo $_SESSION['var_doctorname'] ?> :: Doc</TITLE>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_agenda']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_agenda']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_ProntSaude'])) {
               $_SESSION['scriptcase']['grid_agenda']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_ProntSaude'];
           }
       }
   }
   ...
   if (isset($_SESSION['scriptcase']['grid_agenda']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['grid_agenda']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_SweetBlue/Sc9_SweetBlue";
   ...
   { 
       ...
       if (!isset($_SESSION["var_doctorname"])) 
       {
           $_SESSION["var_doctorname"] = "";
       }
       if (isset($_POST["lang"])) 
       {
...
// 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['grid_agenda']['opc_psq'] && !isset($_SESSION['scriptcase']['grid_agenda']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_agenda']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_agenda'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_agenda']['iframe_menu']) ? false : true;
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['grid_agenda']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['grid_agenda']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_agenda']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
