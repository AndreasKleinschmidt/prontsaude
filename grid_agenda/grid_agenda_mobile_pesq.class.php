...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "start_date";$Nm_datas[] = "start_time";$Nm_datas[] = "end_date";$Nm_datas[] = "end_time";$Nm_numeric[] = "idevent";$Nm_numeric[] = "categ";$Nm_numeric[] = "doctor_iddoctor";$Nm_numeric[] = "patients_idpatient";$Nm_numeric[] = "event_period";$Nm_numeric[] = "idevent_status";$Nm_numeric[] = "idevent_priority";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_doctor_iddoctor"  <?php echo $str_hide_doctor_iddoctor?>>
<?php
...
<SPAN id="Nm_bi_dados_start_date" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_start_date"  style="display:''">
