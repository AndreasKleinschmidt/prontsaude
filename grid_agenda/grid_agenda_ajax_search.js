...
Table_sv_fil[0] = "doctor_iddoctor";
Table_sv_fil[1] = "start_date";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_start_date_cond") && search_get_sel_txt("SC_start_date_cond").substring(0, 3) == "bi_") {
            formata_bi_start_date(search_get_sel_txt("SC_start_date_cond"), SC_start_date_bi_opc, SC_start_date_bi_dt);
        }
