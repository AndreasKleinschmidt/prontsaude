   ...
   if ($this->Ini->Embutida_iframe) {
    ...
    function info_initializeInfo()
    {
        $this->SC_APP_info = [
            ...
            'dimension' => [
                'start_date' => [
                    'label' => sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", "" . $this->Ini->Nm_lang['lang_event_fld_start_date'] . ""),
                    'datatype' => 'date',
            ...
            'options' => [
                ...
                'order_initial_rule' => '',
                'order_metric_apply_to_dimensions' => ['start_date'],
    ...
    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['last_displayed_group_by'] = 'q1';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('q1' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['last_displayed_group_by'] = 'q1';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['summarizing_fields_order'] ['q1'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['summarizing_fields_display'] ['q1'] [$metricIndex] ['display']) {
    ...
    function info_exportData()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['export_data'] = $exportData;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['export_info'] = [
            'dimension_count' => [
...
SCEOT;
    ...
    {
        if ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['opcao']) {
            return true;
        }

        if ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['opcao']) {
            return true;
        }

        if ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_agenda'] ['opcao']) {
            return true;
        }
...
$_SESSION['scriptcase']['grid_agenda']['contr_erro'] = 'off'; 
      ...
      {
            if ($this->aux_hasXAxysDimensionField()) {
                $this->array_line_start_date = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['arr_total_line']['start_date'];
            }
          $this->array_total_start_date = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['arr_total']['start_date'];
      ...
      else
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['arr_total']['start_date'] = $this->array_total_start_date;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['arr_total_line']['start_date'] = $this->array_line_start_date;
   ...
   function completeMatrix()
   {
       ...
       {
       $Lab_start_date = "" . $this->Ini->Nm_lang['lang_event_fld_start_date'] . "";
       $Lab_start_date =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_start_date);
       }
       $this->comp_field = array(
           $Lab_start_date,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['idevent_priority']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['idevent_priority'] = "" . $this->Ini->Nm_lang['lang_event_fld_idevent_priority'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['start_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['start_time'] = "" . $this->Ini->Nm_lang['lang_event_fld_start_time'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['categ']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['categ'] = "" . $this->Ini->Nm_lang['lang_event_fld_categ'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['patients_idpatient']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['patients_idpatient'] = "" . $this->Ini->Nm_lang['lang_event_fld_patients_idpatient'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['idevent_status']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['idevent_status'] = "" . $this->Ini->Nm_lang['lang_event_fld_idevent_status'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['idevent']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['idevent'] = "" . $this->Ini->Nm_lang['lang_event_fld_idevent'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['title']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['title'] = "" . $this->Ini->Nm_lang['lang_event_fld_title'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['descr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['descr'] = "" . $this->Ini->Nm_lang['lang_event_fld_descr'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['start_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['start_date'] = "" . $this->Ini->Nm_lang['lang_event_fld_start_date'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['end_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['end_date'] = "" . $this->Ini->Nm_lang['lang_event_fld_end_date'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['end_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['end_time'] = "" . $this->Ini->Nm_lang['lang_event_fld_end_time'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['recurr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['recurr'] = "" . $this->Ini->Nm_lang['lang_event_fld_recurr'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['period']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['period'] = "" . $this->Ini->Nm_lang['lang_event_fld_period'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['id_api']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['id_api'] = "" . $this->Ini->Nm_lang['lang_event_fld_id_api'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['id_event_google']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['id_event_google'] = "" . $this->Ini->Nm_lang['lang_event_fld_id_event_google'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['recur_info']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['recur_info'] = "" . $this->Ini->Nm_lang['lang_event_fld_recur_info'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['event_color']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['event_color'] = "" . $this->Ini->Nm_lang['lang_event_fld_event_color'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['creator']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['creator'] = "" . $this->Ini->Nm_lang['lang_event_fld_creator'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['reminder']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['reminder'] = "" . $this->Ini->Nm_lang['lang_event_fld_reminder'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['doctor_iddoctor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['doctor_iddoctor'] = "" . $this->Ini->Nm_lang['lang_event_fld_doctor_iddoctor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['event_period']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['labels']['event_period'] = "" . $this->Ini->Nm_lang['lang_event_fld_event_period'] . ""; 
       }
       //-----
       $this->comp_field_nm = array(
           'start_date' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_order']['q1']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_order']['q1'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_order']['q1'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['q1'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['q1'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['q1'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['q1'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['q1'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['q1'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['summarizing_fields_display']['q1'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_start_date as $i_start_date => $d_start_date) {
           if (!isset($i_start_date, $this->comp_label[0]) || !in_array($i_start_date, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_start_date[3] ] = $d_start_date[2];
               $this->comp_label[0][ $d_start_date[3] ] = $d_start_date[2];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'start_date', 'prot' => '@aspass@'),
       );
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_start_date => $l_start_date) {
           if (isset($this->array_total_start_date[$i_start_date])) {
               $this->comp_group[$i_start_date] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_start_date;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['proc_pdf_vert']){ 
   ...
   function totaliza($tipo='')
   {
      ...
      $where_compara   = "";
      $this->Total->Calc_resumo_q1("res", $this->NM_export, 1, $tipo);
      ...
      if (is_array($this->array_total_start_date)) {
          ksort($this->array_total_start_date);
      }
      ...
      $this->array_total_geral[1][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['tot_geral'][1];
      ...
      if ($this->Tem_Res_Compara) {
          ...
          $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['Res_search_metric_use'])) ? true : false;
          $this->Total->$Gb_geral($tp_tot, $this->NM_export);
          $this->array_total_geral[2][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['tot_geral'][1];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['tot_geral'][1] > 0) {
              $this->NM_res_sem_reg = false;
          }
      }
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      $nm_saida->saida("<TD style=\"padding: 0px; vertical-align: initial\" class='sc-mobile-inner-control'>\r\n");
       $tableHeight = "";
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['dashboard_info']['under_dashboard'])
       {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_agenda/grid_agenda_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&nm_label_group=S&nm_all_cab=N&nm_all_label=N&pdf_zip=N&nm_orient_grid=2&origem=res&language=en_us&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_agenda&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_agenda/grid_agenda_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=grid,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_agenda/grid_agenda_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_agenda_config_pivot.php?nome_apl=grid_agenda&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_cabecalho()
   {
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $doctor_iddoctor = (isset($Busca_temp['doctor_iddoctor'])) ? $Busca_temp['doctor_iddoctor'] : ""; 
          $tmp_pos = (is_string($doctor_iddoctor)) ? strpos($doctor_iddoctor, "##@@") : false;
          if ($tmp_pos !== false && !is_array($doctor_iddoctor))
          {
              $doctor_iddoctor = substr($doctor_iddoctor, 0, $tmp_pos);
          }
          $start_date = (isset($Busca_temp['start_date'])) ? $Busca_temp['start_date'] : ""; 
          $tmp_pos = (is_string($start_date)) ? strpos($start_date, "##@@") : false;
          if ($tmp_pos !== false && !is_array($start_date))
          {
   ...
   //---- 
   function adiciona_registro($quebra_start_date, $quebra_start_date_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_start_date[$quebra_start_date_orig]))
      {
         $this->array_total_start_date[$quebra_start_date_orig][0] = 1;
         $this->array_total_start_date[$quebra_start_date_orig][1] = 1;
         $this->array_total_start_date[$quebra_start_date_orig][2] = $quebra_start_date;
         $this->array_total_start_date[$quebra_start_date_orig][3] = $quebra_start_date_orig;
      }
      else
      {
         $this->array_total_start_date[$quebra_start_date_orig][0]++;
         $this->array_total_start_date[$quebra_start_date_orig][2]++;
      }
   }
   ...
   {
      if (isset($this->array_total_start_date))
      {
         $arr_temp_0 = $this->array_total_start_date;
         foreach ($this->array_total_start_date as $campo_start_date => $dados_start_date)
         {
            $ind_exists  = "";
            $ind_missing = "";
            if (!isset($this->array_total_start_date[$campo_start_date][1])) {
                $ind_exists  = 2;
                $ind_missing = 1;
            }
            if (!isset($this->array_total_start_date[$campo_start_date][2])) {
                $ind_exists  = 1;
                $ind_missing = 2;
            }
            if (!empty($ind_missing)) {
                $arr_temp_0[$campo_start_date][$ind_missing][0] = 0;
                $arr_temp_0[$campo_start_date][$ind_missing][1] = 0;
                $arr_temp_0[$campo_start_date][$ind_missing][2] = $dados_start_date[$ind_exists][2];
                $arr_temp_0[$campo_start_date][$ind_missing][3] = $dados_start_date[$ind_exists][3];
            }
            ksort($arr_temp_0[$campo_start_date]);
            $this->array_total_start_date[$campo_start_date] = $arr_temp_0[$campo_start_date];
         } 
      } 
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->doctor_iddoctor = $Busca_temp['doctor_iddoctor']; 
       $this->doctor_iddoctor = (isset($Busca_temp['doctor_iddoctor'])) ? $Busca_temp['doctor_iddoctor'] : ""; 
       $tmp_pos = (is_string($this->doctor_iddoctor)) ? strpos($this->doctor_iddoctor, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->doctor_iddoctor))
       {
...
$_SESSION['scriptcase']['grid_agenda']['contr_erro'] = 'off'; 
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('q1', 'start_date');
     $campos_order = $this->Ini->Get_date_order_groupby("start_date", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->idevent_priority = $rs_res->fields[0] ;  
            $this->start_time = $rs_res->fields[1] ;  
            $this->categ = $rs_res->fields[2] ;  
            $this->patients_idpatient = $rs_res->fields[3] ;  
            $this->idevent_status = $rs_res->fields[4] ;  
            $this->idevent = $rs_res->fields[5] ;  
            $this->title = $rs_res->fields[6] ;  
            $this->descr = $rs_res->fields[7] ;  
            $this->start_date = $rs_res->fields[8] ;  
            $this->end_date = $rs_res->fields[9] ;  
            $this->doctor_iddoctor = $rs_res->fields[10] ;  
            ...
            $this->start_date_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->start_date, $Format_tst);
            $this->start_date = $this->Ini->GB_date_format($TP_Time . $this->start_date, $Format_tst, $Prefix_dat);
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->start_date, $this->start_date_orig);
            }
   }
//
