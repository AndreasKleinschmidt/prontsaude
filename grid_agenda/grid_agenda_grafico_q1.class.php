...
SCEOT;
    ...
    {
        $scPage = NM_encode_input($this->Ini->sc_page);
        $ajaxUrl = "{$this->Ini->path_link}grid_agenda/grid_agenda_config_graf_flash.php?nome_apl=grid_agenda&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us";
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['contr_label_graf']['start_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['contr_label_graf']['start_date']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['contr_label_graf']['start_date'];
      }
   }
