<?php
   ...
   if(!$bol_sel_campos_include)
   {
     ...
     if (!isset($_SESSION['sc_session']))
     {
       ...
       if (is_file($root . $_SESSION['scriptcase']['app_grid_sec_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt"))
       {
?>
...
?>
                        ...
                        echo $_SESSION['sc_session'][$this->sc_init]['app_grid_sec_apps']['labels'][$NM_cada_field];
                        if ($_SESSION['scriptcase']['proc_mobile']) {
                            echo '<div class="sc_ui_sorting-list-item-handle"><i class="fa-solid fa-grip-vertical"></i></div>';
                        }
                        ?></li>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_btns_grid_hint'] ?> - <?php echo $this->Nm_lang['lang_othr_msec_capp'] ?></TITLE>
