...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["ProntSaude_____grid_nurses"]))
   {
      unset($_SESSION['session_sec_aplicacao']["ProntSaude_____grid_nurses"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_nurses'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_nurses']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_nurses']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_nurses']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_nurses']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_nurses']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_nurses']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_nurses']['embutida_filho'] as $ind => $sc_init)
          {
