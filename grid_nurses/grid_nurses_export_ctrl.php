<?php
@session_start() ;
$_SESSION['scriptcase']['grid_nurses']['sc_process_barr'] = true;
require_once('../grid_nurses/index.php');
unset($_SESSION['scriptcase']['grid_nurses']['sc_process_barr']);
$ExportCtrl = new grid_nurses_export_control;
$ExportCtrl->Export_barr();

class grid_nurses_export_control
{
