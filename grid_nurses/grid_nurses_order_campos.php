...
<?php
   ...
   $Ord_Cmp = new grid_nurses_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_nurses_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idnurse'] = "idnurse";
   $tab_labels["idnurse"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nurses']['labels']["idnurse"])) ? $_SESSION['sc_session'][$sc_init]['grid_nurses']['labels']["idnurse"] : "" . $this->Nm_lang['lang_nurses_fld_idnurse'] . "";
   $tab_ger_campos['namenurse'] = "on";
   $tab_def_campos['namenurse'] = "namenurse";
   $tab_labels["namenurse"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nurses']['labels']["namenurse"])) ? $_SESSION['sc_session'][$sc_init]['grid_nurses']['labels']["namenurse"] : "" . $this->Nm_lang['lang_nurses_fld_namenurse'] . "";
   $tab_ger_campos['login'] = "on";
   $tab_def_campos['login'] = "login";
   $tab_labels["login"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nurses']['labels']["login"])) ? $_SESSION['sc_session'][$sc_init]['grid_nurses']['labels']["login"] : "" . $this->Nm_lang['lang_nurses_fld_login'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_nurses']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_nurses']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_nurses']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_nurses_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_nurses']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
