...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "idnurse";$Nm_numeric[] = "login";$Nm_numeric[] = "idnurse";$Nm_numeric[] = "login";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idnurse_cond" name="idnurse_cond" onChange="nm_campos_between(document.getElementById('id_vis_idnurse'), this, 'idnurse')">
      ...
      <br><span id="id_hide_idnurse"  <?php echo $str_hide_idnurse?>><?php
      if ($idnurse != "")
      {
      $idnurse_look = (is_string($idnurse) ? substr($this->Db->qstr($idnurse), 1, -1) : $idnurse); 
      $nmgp_def_dados = array(); 
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_namenurse_cond" name="namenurse_cond" onChange="nm_campos_between(document.getElementById('id_vis_namenurse'), this, 'namenurse')">
      ...
      <br><span id="id_hide_namenurse"  <?php echo $str_hide_namenurse?>><?php
      if ($namenurse != "")
      {
      $namenurse_look = (is_string($namenurse) ? substr($this->Db->qstr($namenurse), 1, -1) : $namenurse); 
      $nmgp_def_dados = array(); 
