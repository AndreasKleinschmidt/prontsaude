  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_timesappointments" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_timesappointments_form();
        }
...
?>
  ...
  // ---------- Validate idtimesappointments_
  function do_ajax_form_timesappointments_validate_idtimesappointments_(iNumLinha)
  {
    var nomeCampo_idtimesappointments_ = "idtimesappointments_" + iNumLinha;
    var var_idtimesappointments_ = scAjaxGetFieldHidden(nomeCampo_idtimesappointments_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_timesappointments_validate_idtimesappointments_(var_idtimesappointments_, iNumLinha, var_script_case_init, do_ajax_form_timesappointments_validate_idtimesappointments__cb);
  } // do_ajax_form_timesappointments_validate_idtimesappointments_

  function do_ajax_form_timesappointments_validate_idtimesappointments__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idtimesappointments_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idtimesappointments_";
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_timesappointments_validate_idtimesappointments__cb

  // ---------- Validate times_
  function do_ajax_form_timesappointments_validate_times_(iNumLinha)
  {
    var nomeCampo_times_ = "times_" + iNumLinha;
    var var_times_ = scAjaxGetFieldText(nomeCampo_times_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_timesappointments_validate_times_(var_times_, iNumLinha, var_script_case_init, do_ajax_form_timesappointments_validate_times__cb);
  } // do_ajax_form_timesappointments_validate_times_

  function do_ajax_form_timesappointments_validate_times__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "times_" + iLineNumber;
    }
    else
    {
      sFieldValid = "times_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_timesappointments_validate_times__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_timesappointments_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_timesappointments_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_timesappointments_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_timesappointments_add_new_line_cb);
  } // do_ajax_form_timesappointments_add_new_line

  function do_ajax_form_timesappointments_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_timesappointments_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_timesappointments_backup_line(iNumLinha)
  {
    var var_idtimesappointments_ = scAjaxGetFieldHidden("idtimesappointments_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_timesappointments_backup_line(var_idtimesappointments_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_timesappointments_backup_line_cb);
  } // do_ajax_form_timesappointments_backup_line

  function do_ajax_form_timesappointments_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_timesappointments_backup_line_cb

  function do_ajax_form_timesappointments_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_timesappointments_cancel_insert

  function do_ajax_form_timesappointments_cancel_update(iSeqVert)
  {
    do_ajax_form_timesappointments_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_timesappointments_cancel_update

  function do_ajax_form_timesappointments_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_timesappointments_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_timesappointments_table_refresh()
  {
    var var_idtimesappointments_ = document.F2.idtimesappointments_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_timesappointments_table_refresh(var_idtimesappointments_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_timesappointments_table_refresh_cb);
  } //  do_ajax_form_timesappointments_table_refresh

  function do_ajax_form_timesappointments_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idtimesappointments_.value = scAjaxGetKeyValue("idtimesappointments_");
    ...
    scAjaxAlert(do_ajax_form_timesappointments_table_refresh_cb_after_alert);
  } // do_ajax_form_timesappointments_table_refresh_cb
  function do_ajax_form_timesappointments_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_timesappointments_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_timesappointments_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_timesappointments_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idtimesappointments_ = scAjaxGetFieldHidden("idtimesappointments_" + iNumLinha);
    var var_times_ = scAjaxGetFieldText("times_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_timesappointments_submit_form(var_idtimesappointments_, var_times_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_timesappointments_submit_form_cb);
  } // do_ajax_form_timesappointments_submit_form

  function do_ajax_form_timesappointments_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_timesappointments_submit_form_cb_after_alert);
  } // do_ajax_form_timesappointments_submit_form_cb
  function do_ajax_form_timesappointments_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_timesappointments_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_timesappointments_navigate_form()
  {
    perform_ajax_form_timesappointments_navigate_form();
  }

  function perform_ajax_form_timesappointments_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_timesappointments_navigate_form(var_idtimesappointments_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_timesappointments_navigate_form_cb);
  } // do_ajax_form_timesappointments_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_timesappointments']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_timesappointments_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.idtimesappointments_.value = scAjaxGetKeyValue("idtimesappointments_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_timesappointments_navigate_form_cb_after_alert);
  } // do_ajax_form_timesappointments_navigate_form_cb
  function do_ajax_form_timesappointments_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_timesappointments_navigate_form_cb_after_alert

    function sc_form_timesappointments_get_last_line_number()
    {
    ...
    } //sc_form_timesappointments_get_last_line_number

  function sc_hide_form_timesappointments_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idtimesappointments_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "times_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idtimesappointments_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_timesappointments_fld_idtimesappointments'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["times_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_timesappointments_fld_times'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["idtimesappointments_"][iNumLinha] = "idtimesappointments_" + iNumLinha;
    ajax_field_mult["times_"][iNumLinha] = "times_" + iNumLinha;
    ajax_field_id["idtimesappointments_" + iNumLinha] = new Array("hidden_field_label_idtimesappointments_", "hidden_field_data_idtimesappointments_" + iNumLinha);
    ajax_field_id["times_" + iNumLinha] = new Array("hidden_field_label_times_", "hidden_field_data_times_" + iNumLinha);
    ajax_error_count["idtimesappointments_" + iNumLinha] = "off";
    ajax_error_count["times_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idtimesappointments_" + iNumLinha] = "on";
    ajax_read_only["times_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idtimesappointments_" + iNumLinha] = "on";
    ajax_read_only["times_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idtimesappointments_" + iNumLinha] = null;
    ajax_error_list["times_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idtimesappointments_": new Array(),
    "times_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idtimesappointments_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idtimesappointments_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idtimesappointments_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idtimesappointments_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idtimesappointments_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["times_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["times_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["times_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["times_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["times_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idtimesappointments_'])) ? $this->nmgp_cmp_readonly['idtimesappointments_'] : 'on';
?>
    scAjaxFieldRead("idtimesappointments_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['times_'])) ? $this->nmgp_cmp_readonly['times_'] : 'off';
?>
    scAjaxFieldRead("times_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idtimesappointments_" + iSeq, "on");
    scAjaxFieldRead("times_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idtimesappointments_" + iRow] || "on" == ajax_error_count["times_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idtimesappointments_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_times_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idtimesappointments_" + iRow] && "off" == ajax_error_count["times_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idtimesappointments_" + iRow] = "off";
        ajax_error_count["times_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idtimesappointments_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_times_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idtimesappointments_" == sIndex)
    {
