  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendar_event_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_calendar_event_mob_form();
        }
...
?>
  ...
  // ---------- Validate patients_idpatient
  function do_ajax_calendar_event_mob_validate_patients_idpatient()
  {
  } // do_ajax_calendar_event_mob_validate_patients_idpatient

  function do_ajax_calendar_event_mob_validate_patients_idpatient_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "patients_idpatient";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_patients_idpatient_cb

  // ---------- Validate title
  function do_ajax_calendar_event_mob_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldText(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate_title(var_title, var_script_case_init, do_ajax_calendar_event_mob_validate_title_cb);
  } // do_ajax_calendar_event_mob_validate_title

  function do_ajax_calendar_event_mob_validate_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "title";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_title_cb

  // ---------- Validate descr
  function do_ajax_calendar_event_mob_validate_descr()
  {
    var nomeCampo_descr = "descr";
    var var_descr = scAjaxGetFieldText(nomeCampo_descr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate_descr(var_descr, var_script_case_init, do_ajax_calendar_event_mob_validate_descr_cb);
  } // do_ajax_calendar_event_mob_validate_descr

  function do_ajax_calendar_event_mob_validate_descr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_descr_cb

  // ---------- Validate categ
  function do_ajax_calendar_event_mob_validate_categ()
  {
    var nomeCampo_categ = "categ";
    var var_categ = scAjaxGetFieldSelect(nomeCampo_categ);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate_categ(var_categ, var_script_case_init, do_ajax_calendar_event_mob_validate_categ_cb);
  } // do_ajax_calendar_event_mob_validate_categ

  function do_ajax_calendar_event_mob_validate_categ_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "categ";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_categ_cb

  // ---------- Validate idevent_status
  function do_ajax_calendar_event_mob_validate_idevent_status()
  {
    var nomeCampo_idevent_status = "idevent_status";
    var var_idevent_status = scAjaxGetFieldSelect(nomeCampo_idevent_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate_idevent_status(var_idevent_status, var_script_case_init, do_ajax_calendar_event_mob_validate_idevent_status_cb);
  } // do_ajax_calendar_event_mob_validate_idevent_status

  function do_ajax_calendar_event_mob_validate_idevent_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idevent_status";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_idevent_status_cb

  // ---------- Validate idevent_priority
  function do_ajax_calendar_event_mob_validate_idevent_priority()
  {
    var nomeCampo_idevent_priority = "idevent_priority";
    var var_idevent_priority = scAjaxGetFieldSelect(nomeCampo_idevent_priority);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate_idevent_priority(var_idevent_priority, var_script_case_init, do_ajax_calendar_event_mob_validate_idevent_priority_cb);
  } // do_ajax_calendar_event_mob_validate_idevent_priority

  function do_ajax_calendar_event_mob_validate_idevent_priority_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idevent_priority";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_idevent_priority_cb

  // ---------- Validate event_color
  function do_ajax_calendar_event_mob_validate_event_color()
  {
    var nomeCampo_event_color = "event_color";
    var var_event_color = scAjaxGetFieldText(nomeCampo_event_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate_event_color(var_event_color, var_script_case_init, do_ajax_calendar_event_mob_validate_event_color_cb);
  } // do_ajax_calendar_event_mob_validate_event_color

  function do_ajax_calendar_event_mob_validate_event_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_event_color_cb

  // ---------- Validate start_date
  function do_ajax_calendar_event_mob_validate_start_date()
  {
    ...
    setTimeout(function() {
      var var_start_date = scAjaxGetFieldText(nomeCampo_start_date);
      x_ajax_calendar_event_mob_validate_start_date(var_start_date, var_script_case_init, do_ajax_calendar_event_mob_validate_start_date_cb);
    }, 200);
  } // do_ajax_calendar_event_mob_validate_start_date

  function do_ajax_calendar_event_mob_validate_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_start_date_cb

  // ---------- Validate end_date
  function do_ajax_calendar_event_mob_validate_end_date()
  {
    var nomeCampo_end_date = "end_date";
    var var_end_date = scAjaxGetFieldText(nomeCampo_end_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate_end_date(var_end_date, var_script_case_init, do_ajax_calendar_event_mob_validate_end_date_cb);
  } // do_ajax_calendar_event_mob_validate_end_date

  function do_ajax_calendar_event_mob_validate_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_end_date_cb

  // ---------- Validate start_time
  function do_ajax_calendar_event_mob_validate_start_time()
  {
    var nomeCampo_start_time = "start_time";
    var var_start_time = scAjaxGetFieldText(nomeCampo_start_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate_start_time(var_start_time, var_script_case_init, do_ajax_calendar_event_mob_validate_start_time_cb);
  } // do_ajax_calendar_event_mob_validate_start_time

  function do_ajax_calendar_event_mob_validate_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_start_time_cb

  // ---------- Validate end_time
  function do_ajax_calendar_event_mob_validate_end_time()
  {
    var nomeCampo_end_time = "end_time";
    var var_end_time = scAjaxGetFieldText(nomeCampo_end_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate_end_time(var_end_time, var_script_case_init, do_ajax_calendar_event_mob_validate_end_time_cb);
  } // do_ajax_calendar_event_mob_validate_end_time

  function do_ajax_calendar_event_mob_validate_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_end_time_cb

  // ---------- Validate __calend_all_day__
  function do_ajax_calendar_event_mob_validate___calend_all_day__()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate___calend_all_day__(var___calend_all_day__, var_script_case_init, do_ajax_calendar_event_mob_validate___calend_all_day___cb);
  } // do_ajax_calendar_event_mob_validate___calend_all_day__

  function do_ajax_calendar_event_mob_validate___calend_all_day___cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate___calend_all_day___cb

  // ---------- Validate recurr
  function do_ajax_calendar_event_mob_validate_recurr()
  {
    var nomeCampo_recurr = "recurr";
    var var_recurr = scAjaxGetFieldSelect(nomeCampo_recurr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate_recurr(var_recurr, var_script_case_init, do_ajax_calendar_event_mob_validate_recurr_cb);
  } // do_ajax_calendar_event_mob_validate_recurr

  function do_ajax_calendar_event_mob_validate_recurr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "recurr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_recurr_cb

  // ---------- Validate period
  function do_ajax_calendar_event_mob_validate_period()
  {
    var nomeCampo_period = "period";
    var var_period = scAjaxGetFieldSelect(nomeCampo_period);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate_period(var_period, var_script_case_init, do_ajax_calendar_event_mob_validate_period_cb);
  } // do_ajax_calendar_event_mob_validate_period

  function do_ajax_calendar_event_mob_validate_period_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "period";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_period_cb

  // ---------- Validate recur_info
  function do_ajax_calendar_event_mob_validate_recur_info()
  {
    var nomeCampo_recur_info = "recur_info";
    var var_recur_info = scAjaxGetFieldRecurInfo(nomeCampo_recur_info);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate_recur_info(var_recur_info, var_script_case_init, do_ajax_calendar_event_mob_validate_recur_info_cb);
  } // do_ajax_calendar_event_mob_validate_recur_info

  function do_ajax_calendar_event_mob_validate_recur_info_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_recur_info_cb

  // ---------- Validate event_period
  function do_ajax_calendar_event_mob_validate_event_period()
  {
    var nomeCampo_event_period = "event_period";
    var var_event_period = scAjaxGetFieldHidden(nomeCampo_event_period);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_mob_validate_event_period(var_event_period, var_script_case_init, do_ajax_calendar_event_mob_validate_event_period_cb);
  } // do_ajax_calendar_event_mob_validate_event_period

  function do_ajax_calendar_event_mob_validate_event_period_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "event_period";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_mob_validate_event_period_cb

  // ---------- Event onchange patients_idpatient
  function do_ajax_calendar_event_mob_event_patients_idpatient_onchange()
  {
    var var_patients_idpatient = scAjaxGetFieldText("id_ac_patients_idpatient");
    var var_title = scAjaxGetFieldText("title");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_calendar_event_mob_event_patients_idpatient_onchange(var_patients_idpatient, var_title, var_script_case_init, do_ajax_calendar_event_mob_event_patients_idpatient_onchange_cb);
  } // do_ajax_calendar_event_mob_event_patients_idpatient_onchange

  function do_ajax_calendar_event_mob_event_patients_idpatient_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "patients_idpatient";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_calendar_event_mob_event_patients_idpatient_onchange_cb_after_alert);
  } // do_ajax_calendar_event_mob_event_patients_idpatient_onchange_cb
  function do_ajax_calendar_event_mob_event_patients_idpatient_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_calendar_event_mob_event_patients_idpatient_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_calendar_event_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendar_event_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_patients_idpatient = scAjaxGetFieldText("patients_idpatient");
    var var_title = scAjaxGetFieldText("title");
    var var_descr = scAjaxGetFieldText("descr");
    var var_categ = scAjaxGetFieldSelect("categ");
    var var_idevent_status = scAjaxGetFieldSelect("idevent_status");
    var var_idevent_priority = scAjaxGetFieldSelect("idevent_priority");
    ...
    var var_recurr = scAjaxGetFieldSelect("recurr");
    var var_period = scAjaxGetFieldSelect("period");
    var var_recur_info = scAjaxGetFieldRecurInfo("recur_info");
    var var_event_period = scAjaxGetFieldHidden("event_period");
    var var_idevent = scAjaxGetFieldText("idevent");
    ...
    scAjaxProcOn();
    x_ajax_calendar_event_mob_submit_form(var_patients_idpatient, var_title, var_descr, var_categ, var_idevent_status, var_idevent_priority, var_event_color, var_start_date, var_end_date, var_start_time, var_end_time, var___calend_all_day__, var_recurr, var_period, var_recur_info, var_event_period, var_idevent, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendar_event_mob_submit_form_cb);
  } // do_ajax_calendar_event_mob_submit_form

  function do_ajax_calendar_event_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_calendar_event_mob_submit_form_cb_after_alert);
  } // do_ajax_calendar_event_mob_submit_form_cb
  function do_ajax_calendar_event_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendar_event_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendar_event_mob_navigate_form()
  {
    perform_ajax_calendar_event_mob_navigate_form();
  }

  function perform_ajax_calendar_event_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_idevent = document.F2.idevent.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_calendar_event_mob_navigate_form(var_idevent, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendar_event_mob_navigate_form_cb);
  } // do_ajax_calendar_event_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendar_event_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.idevent.value = scAjaxGetKeyValue("idevent");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendar_event_mob_navigate_form_cb_after_alert);
  } // do_ajax_calendar_event_mob_navigate_form_cb
  function do_ajax_calendar_event_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendar_event_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_calendar_event_mob_navigate_form_cb_after_alert

  function sc_hide_calendar_event_mob_form()
  {
  ...
  ajax_field_list[0] = "patients_idpatient";
  ajax_field_list[1] = "title";
  ajax_field_list[2] = "descr";
  ajax_field_list[3] = "categ";
  ajax_field_list[4] = "idevent_status";
  ajax_field_list[5] = "idevent_priority";
  ajax_field_list[6] = "event_color";
  ajax_field_list[7] = "start_date";
  ajax_field_list[8] = "end_date";
  ajax_field_list[9] = "start_time";
  ajax_field_list[10] = "end_time";
  ajax_field_list[11] = "__calend_all_day__";
  ajax_field_list[12] = "recurr";
  ajax_field_list[13] = "period";
  ajax_field_list[14] = "recur_info";
  ajax_field_list[15] = "event_period";
  ...
  var ajax_error_list = {
    "patients_idpatient": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_patients_idpatient'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "title": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_title'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "descr": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_descr'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "categ": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_categ'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "idevent_status": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_idevent_status'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "idevent_priority": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_idevent_priority'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "event_color": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_event_color'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "start_date": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_start_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "end_date": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_end_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "start_time": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_start_time'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "end_time": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_end_time'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "recurr": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_recurr'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "period": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_period'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "recur_info": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_recur_info'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "event_period": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_event_period'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "patients_idpatient": new Array(),
    "title": new Array(),
    "descr": new Array(),
    "categ": new Array(),
    "idevent_status": new Array(),
    "idevent_priority": new Array(),
    ...
    "event_period": new Array()
  };
  ajax_field_mult["patients_idpatient"][1] = "patients_idpatient";
  ajax_field_mult["title"][1] = "title";
  ajax_field_mult["descr"][1] = "descr";
  ajax_field_mult["categ"][1] = "categ";
  ajax_field_mult["idevent_status"][1] = "idevent_status";
  ajax_field_mult["idevent_priority"][1] = "idevent_priority";
  ...
  ajax_field_mult["recurr"][1] = "recurr";
  ajax_field_mult["period"][1] = "period";
  ajax_field_mult["recur_info"][1] = "recur_info";
  ajax_field_mult["event_period"][1] = "event_period";

  var ajax_field_id = {
    "patients_idpatient": new Array("hidden_field_label_patients_idpatient", "hidden_field_data_patients_idpatient"),
    "descr": new Array("hidden_field_label_descr", "hidden_field_data_descr"),
    "categ": new Array("hidden_field_label_categ", "hidden_field_data_categ"),
    "idevent_status": new Array("hidden_field_label_idevent_status", "hidden_field_data_idevent_status"),
    "idevent_priority": new Array("hidden_field_label_idevent_priority", "hidden_field_data_idevent_priority"),
    ...
    "recurr": new Array("hidden_field_label_recurr", "hidden_field_data_recurr"),
    ...
    "event_period": new Array("hidden_field_label_event_period", "hidden_field_data_event_period")
  };

  var ajax_read_only = {
    "patients_idpatient": "off",
    "title": "off",
    "descr": "off",
    "categ": "off",
    "idevent_status": "off",
    "idevent_priority": "off",
    "event_color": "off",
    "start_date": "off",
    "end_date": "off",
    "start_time": "off",
