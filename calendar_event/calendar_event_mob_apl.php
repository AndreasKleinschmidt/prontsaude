...
class calendar_event_mob_apl
{
   ...
   var $reminder;
   var $doctor_iddoctor;
   var $doctor_iddoctor_1;
   var $patients_idpatient;
   var $event_period;
   var $idevent_status;
   var $idevent_status_1;
   var $idevent_priority;
   var $idevent_priority_1;
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['categ']))
          {
              $this->categ = $this->NM_ajax_info['param']['categ'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['event_period']))
          {
              $this->event_period = $this->NM_ajax_info['param']['event_period'];
          }
          if (isset($this->NM_ajax_info['param']['idevent']))
          {
              $this->idevent = $this->NM_ajax_info['param']['idevent'];
          }
          if (isset($this->NM_ajax_info['param']['idevent_priority']))
          {
              $this->idevent_priority = $this->NM_ajax_info['param']['idevent_priority'];
          }
          if (isset($this->NM_ajax_info['param']['idevent_status']))
          {
              $this->idevent_status = $this->NM_ajax_info['param']['idevent_status'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['patients_idpatient']))
          {
              $this->patients_idpatient = $this->NM_ajax_info['param']['patients_idpatient'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['recurr']))
          {
              $this->recurr = $this->NM_ajax_info['param']['recurr'];
          }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_calendar_event_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->var_doctor)) 
          {
              $_SESSION['var_doctor'] = $this->var_doctor;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['nm_run_menu'] = 1;
      } 
      if (isset($this->nmgp_opcao) && 'igual_calendar' == $this->nmgp_opcao) {
          $this->nmgp_opcao = 'igual';
          $this->idevent = $this->__orig_idevent;
      }
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new calendar_event_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_event'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['calendar_event_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_event_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_event_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_event_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_event_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('calendar_event_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_event_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - event";
      ...
      $_SESSION['scriptcase']['error_icon']['calendar_event_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['calendar_event_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_orig'] = " where (doctor_iddoctor = " . $_SESSION['var_doctor'] . ")";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_pesq'] = " where (doctor_iddoctor = " . $_SESSION['var_doctor'] . ")";
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_event_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_event_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_event_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['dados_form'];
          if (!isset($this->idevent)){$this->idevent = $this->nmgp_dados_form['idevent'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("calendar_event_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'calendar_event/calendar_event_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'calendar_event_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'calendar_event_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'calendar_event_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'calendar_event/calendar_event_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "calendar_event_mob_erro.class.php"); 
      }
      $this->Erro      = new calendar_event_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event_mob']['start']);
          unset($_SESSION['scriptcase']['sc_apl_conf']['calendar_event']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      {
          $_SESSION['scriptcase']['calendar_event_mob']['contr_erro'] = 'on';
if (!isset($this->sc_temp_var_doctor)) {$this->sc_temp_var_doctor = (isset($_SESSION['var_doctor'])) ? $_SESSION['var_doctor'] : "";}
  $check_sql = "SELECT namedoctor FROM doctors WHERE iddoctor = " . $this->sc_temp_var_doctor;
...
{
    $disp_name = $this->rs[0][0];
}
else{
	$disp_name = "";
}

echo "<span style='font-size: 18px;font-weight: bold;'>". $this->Ini->Nm_lang['lang_tbl_event'] .": ".$disp_name."</span>";
if (isset($this->sc_temp_var_doctor)) { $_SESSION['var_doctor'] = $this->sc_temp_var_doctor;}
$_SESSION['scriptcase']['calendar_event_mob']['contr_erro'] = 'off'; 
      }
            ...
            $out1_img_cache = $_SESSION['scriptcase']['calendar_event_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['calendar_event_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      if (isset($this->recurr)) { $this->nm_limpa_alfa($this->recurr); }
      if (isset($this->period)) { $this->nm_limpa_alfa($this->period); }
      if (isset($this->categ)) { $this->nm_limpa_alfa($this->categ); }
      if (isset($this->recur_info)) { $this->nm_limpa_alfa($this->recur_info); }
      if (isset($this->event_color)) { $this->nm_limpa_alfa($this->event_color); }
      if (isset($this->patients_idpatient)) { $this->nm_limpa_alfa($this->patients_idpatient); }
      if (isset($this->event_period)) { $this->nm_limpa_alfa($this->event_period); }
      if (isset($this->idevent_status)) { $this->nm_limpa_alfa($this->idevent_status); }
      if (isset($this->idevent_priority)) { $this->nm_limpa_alfa($this->idevent_priority); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- event_period
      $this->field_config['event_period']               = array();
      $this->field_config['event_period']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['event_period']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['event_period']['symbol_dec'] = '';
      $this->field_config['event_period']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['event_period']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- idevent
      $this->field_config['idevent']               = array();
      $this->field_config['idevent']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['idevent']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['idevent']['symbol_dec'] = '';
      $this->field_config['idevent']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['idevent']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- doctor_iddoctor
...
//
      ...
      {
          if ('validate_patients_idpatient' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'patients_idpatient');
          }
          ...
          if ('validate_categ' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'categ');
          }
          if ('validate_idevent_status' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'idevent_status');
          }
          if ('validate_idevent_priority' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'idevent_priority');
          }
          ...
          if ('validate_recurr' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'recurr');
          }
          ...
          if ('validate_event_period' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'event_period');
          }
          calendar_event_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_patients_idpatient_onchange' == $this->NM_ajax_opcao)
          {
              $this->patients_idpatient_onChange();
          }
          calendar_event_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'autocomp_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          if ('autocomp_patients_idpatient' == $this->NM_ajax_opcao)
          {
              if (isset($_GET['term'])) {
                  $this->patients_idpatient = ($_SESSION['scriptcase']['charset'] != "UTF-8") ? NM_utf8_decode(sc_convert_encoding($_GET['term'], $_SESSION['scriptcase']['charset'], 'UTF-8')) : $_GET['term'];
              } else {
   ...
   {
       $nm_comando = "SELECT idpatient, idpatient + ' - ' + patient_name FROM patients WHERE idpatient + ' - ' + patient_name LIKE '%" . substr($this->Db->qstr($this->patients_idpatient), 1, -1) . "%' ORDER BY patient_name";
   }
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   {
       $nm_comando = "SELECT idpatient, concat(idpatient, ' - ', patient_name) FROM patients WHERE concat(idpatient, ' - ', patient_name) LIKE '%" . substr($this->Db->qstr($this->patients_idpatient), 1, -1) . "%' ORDER BY patient_name";
   }
   ...
   {
       $nm_comando = "SELECT idpatient, convert(char,idpatient) + ' - ' + patient_name FROM patients WHERE convert(char,idpatient) + ' - ' + patient_name LIKE '%" . substr($this->Db->qstr($this->patients_idpatient), 1, -1) . "%' ORDER BY patient_name";
   }
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_db2))
   {
       $nm_comando = "SELECT idpatient, char(idpatient)||' - '||patient_name FROM patients WHERE char(idpatient)||' - '||patient_name LIKE '%" . substr($this->Db->qstr($this->patients_idpatient), 1, -1) . "%' ORDER BY patient_name";
   }
   else
   {
       $nm_comando = "SELECT idpatient, idpatient||' - '||patient_name FROM patients WHERE idpatient||' - '||patient_name LIKE '%" . substr($this->Db->qstr($this->patients_idpatient), 1, -1) . "%' ORDER BY patient_name";
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(calendar_event_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', calendar_event_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "calendar_event_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - event") ?></TITLE>
...
<form name="Fdown" method="get" action="calendar_event_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="calendar_event_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="calendar_event_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           case 'patients_idpatient':
               return "" . $this->Ini->Nm_lang['lang_event_fld_patients_idpatient'] . "";
               break;
           case 'title':
               return "" . $this->Ini->Nm_lang['lang_event_fld_title'] . "";
               break;
           case 'descr':
               return "" . $this->Ini->Nm_lang['lang_event_fld_descr'] . "";
               break;
           case 'categ':
               return "" . $this->Ini->Nm_lang['lang_event_fld_categ'] . "";
               break;
           case 'idevent_status':
               return "" . $this->Ini->Nm_lang['lang_event_fld_idevent_status'] . "";
               break;
           case 'idevent_priority':
               return "" . $this->Ini->Nm_lang['lang_event_fld_idevent_priority'] . "";
               break;
           case 'event_color':
               return "" . $this->Ini->Nm_lang['lang_event_fld_event_color'] . "";
               break;
           case 'start_date':
               return "" . $this->Ini->Nm_lang['lang_event_fld_start_date'] . "";
               break;
           case 'end_date':
               return "" . $this->Ini->Nm_lang['lang_event_fld_end_date'] . "";
               break;
           case 'start_time':
               return "" . $this->Ini->Nm_lang['lang_event_fld_start_time'] . "";
               break;
           case 'end_time':
               return "" . $this->Ini->Nm_lang['lang_event_fld_end_time'] . "";
               break;
           case '__calend_all_day__':
               return "" . $this->Ini->Nm_lang['lang_per_allday'] . "";
               break;
           case 'recurr':
               return "" . $this->Ini->Nm_lang['lang_event_fld_recurr'] . "";
               break;
           case 'period':
               return "" . $this->Ini->Nm_lang['lang_event_fld_period'] . "";
               break;
           case 'recur_info':
               return "" . $this->Ini->Nm_lang['lang_event_fld_recur_info'] . "";
               break;
           case 'event_period':
               return "" . $this->Ini->Nm_lang['lang_event_fld_event_period'] . "";
               break;
           case 'idevent':
               return "" . $this->Ini->Nm_lang['lang_event_fld_idevent'] . "";
               break;
           case 'id_api':
               return "" . $this->Ini->Nm_lang['lang_event_fld_id_api'] . "";
               break;
           case 'id_event_google':
               return "" . $this->Ini->Nm_lang['lang_event_fld_id_event_google'] . "";
               break;
           case 'creator':
               return "" . $this->Ini->Nm_lang['lang_event_fld_creator'] . "";
               break;
           case 'reminder':
               return "" . $this->Ini->Nm_lang['lang_event_fld_reminder'] . "";
               break;
           case 'doctor_iddoctor':
               return "" . $this->Ini->Nm_lang['lang_event_fld_doctor_iddoctor'] . "";
               break;
       }
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_calendar_event_mob']) || !is_array($this->NM_ajax_info['errList']['geral_calendar_event_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_calendar_event_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_calendar_event_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if (isset($this->__calend_all_day__) && 'Y' == $this->__calend_all_day__)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['bypass_required_time']['start_time'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['bypass_required_time']['end_time'] = true;
      }
      if ((!is_array($filtro) && ('' == $filtro || 'patients_idpatient' == $filtro)) || (is_array($filtro) && in_array('patients_idpatient', $filtro)))
        $this->ValidateField_patients_idpatient($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "patients_idpatient";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "descr";

      if ((!is_array($filtro) && ('' == $filtro || 'categ' == $filtro)) || (is_array($filtro) && in_array('categ', $filtro)))
        $this->ValidateField_categ($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "categ";

      if ((!is_array($filtro) && ('' == $filtro || 'idevent_status' == $filtro)) || (is_array($filtro) && in_array('idevent_status', $filtro)))
        $this->ValidateField_idevent_status($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "idevent_status";

      if ((!is_array($filtro) && ('' == $filtro || 'idevent_priority' == $filtro)) || (is_array($filtro) && in_array('idevent_priority', $filtro)))
        $this->ValidateField_idevent_priority($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "idevent_priority";
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'recurr' == $filtro)) || (is_array($filtro) && in_array('recurr', $filtro)))
        $this->ValidateField_recurr($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "recurr";
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'event_period' == $filtro)) || (is_array($filtro) && in_array('event_period', $filtro)))
        $this->ValidateField_event_period($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "event_period";

      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['bypass_required_time']['start_time'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['bypass_required_time']['end_time'] = false;
...
{
    $original_event_period = $this->event_period;
}
  if ($this->event_period  > 0) {
	
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .=  $this->Ini->Nm_lang['lang_msg_error_event_exist'] ;
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_calendar_event_mob';
  } elseif ('submit_form' == $this->NM_ajax_opcao) {
   $sErrorIndex = 'geral_calendar_event_mob';
  } else {
   $sErrorIndex = substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
  }
  $this->NM_ajax_info['errList'][$sErrorIndex][] =  $this->Ini->Nm_lang['lang_msg_error_event_exist'] ;
 }
;	
}
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_event_period != $this->event_period || (isset($bFlagRead_event_period) && $bFlagRead_event_period)))
    {
        $this->ajax_return_values_event_period(true);
    }
}
$_SESSION['scriptcase']['calendar_event_mob']['contr_erro'] = 'off'; 
      }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_categ = $this->categ;
    $original_descr = $this->descr;
    $original_end_time = $this->end_time;
    $original_patients_idpatient = $this->patients_idpatient;
...
if (!isset($this->sc_temp_var_doctor)) {$this->sc_temp_var_doctor = (isset($_SESSION['var_doctor'])) ? $_SESSION['var_doctor'] : "";}
  $evento = $this->idevent ;
$hini = $this->start_time ;
$v_id_upd  = 0;

if( !empty($this->idevent ) ) { 
	$sql = "SELECT end_time FROM event WHERE idevent = ".$evento;
	...
	if ($this->ds[0][0] != "") {
	  $this->destroy_evt($evento);		
	}
}

if ($this->end_time  != 'null') {
	
	$sql = "SELECT idevent, start_time FROM event 
WHERE 
start_date = '$this->start_date' 
AND (start_time > '$this->start_time' AND start_time < '$this->end_time' ) 
AND doctor_iddoctor = $this->sc_temp_var_doctor 
ORDER BY start_time";
  ...
  for ($i = 0; $i < $qtd; $i++) {
	  ...
	  if ($this->ds2[$i][1] > $this->end_time ) {
		  break;
	  }	  
	  $parenttit = trim($this->title );
	  if ($parenttit == "") {
		  $parenttit = " ";
	  }
	   $parentdesc = trim($this->descr );
	   if ($parentdesc == "") {
		  $parentdesc = " ";
	  }
	  
	  $timeParts = explode(":", $this->ds2[$i][1]);
	  $etime =  date('H:i:s', mktime($timeParts[0], $timeParts[1], $timeParts[2])+(840));
	 
	  if( !empty($this->idevent ) ) { $peri = ", event_period = '".$this->idevent ."' "; }
		else{ $peri = " "; }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_categ != $this->categ || (isset($bFlagRead_categ) && $bFlagRead_categ)))
    {
        $this->ajax_return_values_categ(true);
    }
    if (($original_descr != $this->descr || (isset($bFlagRead_descr) && $bFlagRead_descr)))
    {
        $this->ajax_return_values_descr(true);
    }
    if (($original_end_time != $this->end_time || (isset($bFlagRead_end_time) && $bFlagRead_end_time)))
    {
        $this->ajax_return_values_end_time(true);
    }
    if (($original_patients_idpatient != $this->patients_idpatient || (isset($bFlagRead_patients_idpatient) && $bFlagRead_patients_idpatient)))
    {
        $this->ajax_return_values_patients_idpatient(true);
    }
...
$_SESSION['scriptcase']['calendar_event_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_patients_idpatient(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['patients_idpatient'])) {
      ...
      { 
          if ($this->patients_idpatient != '')  
          { 
              $iTestSize = 11;
              if (strlen($this->patients_idpatient) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_event_fld_patients_idpatient'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['patients_idpatient']))
                  {
                      $Campos_Erros['patients_idpatient'] = array();
                  }
                  $Campos_Erros['patients_idpatient'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['patients_idpatient']) || !is_array($this->NM_ajax_info['errList']['patients_idpatient']))
                  {
                      $this->NM_ajax_info['errList']['patients_idpatient'] = array();
                  }
                  $this->NM_ajax_info['errList']['patients_idpatient'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->patients_idpatient, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_event_fld_patients_idpatient'] . "; " ; 
                  if (!isset($Campos_Erros['patients_idpatient']))
                  {
                      $Campos_Erros['patients_idpatient'] = array();
                  }
                  $Campos_Erros['patients_idpatient'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['patients_idpatient']) || !is_array($this->NM_ajax_info['errList']['patients_idpatient']))
                  {
                      $this->NM_ajax_info['errList']['patients_idpatient'] = array();
                  }
                  $this->NM_ajax_info['errList']['patients_idpatient'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['php_cmp_required']['patients_idpatient']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['php_cmp_required']['patients_idpatient'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_event_fld_patients_idpatient'] . "" ; 
              if (!isset($Campos_Erros['patients_idpatient']))
              {
                  $Campos_Erros['patients_idpatient'] = array();
              }
              $Campos_Erros['patients_idpatient'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['patients_idpatient']) || !is_array($this->NM_ajax_info['errList']['patients_idpatient']))
                  {
                      $this->NM_ajax_info['errList']['patients_idpatient'] = array();
                  }
                  $this->NM_ajax_info['errList']['patients_idpatient'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
           } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'patients_idpatient';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_patients_idpatient
    ...
    function ValidateField_title(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['php_cmp_required']['title']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['php_cmp_required']['title'] == "on")) 
      { 
          if ($this->title == "")  
          { 
              $hasError = true;
              $Campos_Falta[] =  "" . $this->Ini->Nm_lang['lang_event_fld_title'] . "" ; 
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_event_fld_title'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['title']))
              {
                  $Campos_Erros['title'] = array();
              }
    ...
    function ValidateField_descr(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['descr'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->descr) > 32767) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_event_fld_descr'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 32767 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['descr']))
              {
                  $Campos_Erros['descr'] = array();
              }
              $Campos_Erros['descr'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 32767 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['descr']) || !is_array($this->NM_ajax_info['errList']['descr']))
              {
                  $this->NM_ajax_info['errList']['descr'] = array();
              }
              $this->NM_ajax_info['errList']['descr'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 32767 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_categ(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['categ'])) {
       return;
   }
               if (!empty($this->categ) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_categ']) && !in_array($this->categ, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_categ']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['categ']))
                   {
                       $Campos_Erros['categ'] = array();
                   }
                   $Campos_Erros['categ'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['categ']) || !is_array($this->NM_ajax_info['errList']['categ']))
                   {
                       $this->NM_ajax_info['errList']['categ'] = array();
                   }
                   $this->NM_ajax_info['errList']['categ'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'categ';
    ...
    function ValidateField_idevent_status(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['idevent_status'])) {
       return;
   }
               if (!empty($this->idevent_status) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_idevent_status']) && !in_array($this->idevent_status, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_idevent_status']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['idevent_status']))
                   {
                       $Campos_Erros['idevent_status'] = array();
                   }
                   $Campos_Erros['idevent_status'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['idevent_status']) || !is_array($this->NM_ajax_info['errList']['idevent_status']))
                   {
                       $this->NM_ajax_info['errList']['idevent_status'] = array();
                   }
                   $this->NM_ajax_info['errList']['idevent_status'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'idevent_status';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_idevent_status

    function ValidateField_idevent_priority(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['idevent_priority'])) {
       return;
   }
               if (!empty($this->idevent_priority) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_idevent_priority']) && !in_array($this->idevent_priority, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_idevent_priority']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['idevent_priority']))
                   {
                       $Campos_Erros['idevent_priority'] = array();
                   }
                   $Campos_Erros['idevent_priority'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['idevent_priority']) || !is_array($this->NM_ajax_info['errList']['idevent_priority']))
                   {
                       $this->NM_ajax_info['errList']['idevent_priority'] = array();
                   }
                   $this->NM_ajax_info['errList']['idevent_priority'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'idevent_priority';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_idevent_priority
    ...
    function ValidateField_start_date(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_event_fld_start_date'] . "; " ; 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['php_cmp_required']['start_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['php_cmp_required']['start_date'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_event_fld_start_date'] . "" ; 
              if (!isset($Campos_Erros['start_date']))
              {
                  $Campos_Erros['start_date'] = array();
              }
    ...
    function ValidateField_end_date(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_event_fld_end_date'] . "; " ; 
    ...
    function ValidateField_start_time(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_event_fld_start_time'] . "; " ; 
    ...
    function ValidateField_end_time(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_event_fld_end_time'] . "; " ; 
   ...
   if (isset($this->Field_no_validate['__calend_all_day__'])) {
    ...
    function ValidateField_recurr(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['recurr'])) {
       return;
   }
      if ($this->recurr == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
        if ($hasError) {
            global $sc_seq_vert;
   ...
   if (isset($this->Field_no_validate['period'])) {
      ...
      if ($this->nmgp_opcao != "excluir")
      {
          if (trim($this->recur_info) != "")
          {
              ...
              if ('' != trim($tmpRecurInfo['endin']))
              {
                  ...
                  {
                      $hasError = true;
                      $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_event_fld_recur_info'] . "; ";
    ...
    function ValidateField_event_period(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['event_period'])) {
          nm_limpa_numero($this->event_period, $this->field_config['event_period']['symbol_grp']) ; 
          return;
      }
      if ($this->event_period === "" || is_null($this->event_period))  
      { 
          $this->event_period = 0;
          $this->sc_force_zero[] = 'event_period';
      } 
      nm_limpa_numero($this->event_period, $this->field_config['event_period']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->event_period != '')  
          { 
              $iTestSize = 11;
              if (strlen($this->event_period) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_event_fld_event_period'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['event_period']))
                  {
                      $Campos_Erros['event_period'] = array();
                  }
                  $Campos_Erros['event_period'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['event_period']) || !is_array($this->NM_ajax_info['errList']['event_period']))
                  {
                      $this->NM_ajax_info['errList']['event_period'] = array();
                  }
                  $this->NM_ajax_info['errList']['event_period'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->event_period, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_event_fld_event_period'] . "; " ; 
                  if (!isset($Campos_Erros['event_period']))
                  {
                      $Campos_Erros['event_period'] = array();
                  }
                  $Campos_Erros['event_period'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['event_period']) || !is_array($this->NM_ajax_info['errList']['event_period']))
                  {
                      $this->NM_ajax_info['errList']['event_period'] = array();
                  }
                  $this->NM_ajax_info['errList']['event_period'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['categ'] = $this->categ;
    $this->nmgp_dados_form['idevent_status'] = $this->idevent_status;
    $this->nmgp_dados_form['idevent_priority'] = $this->idevent_priority;
    ...
    $this->nmgp_dados_form['recurr'] = $this->recurr;
    $this->nmgp_dados_form['period'] = $this->period;
    $this->nmgp_dados_form['recur_info'] = $this->recur_info;
    $this->nmgp_dados_form['event_period'] = $this->event_period;
    $this->nmgp_dados_form['idevent'] = $this->idevent;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_hora($this->end_time, $this->field_config['end_time']['time_sep']) ; 
      $this->Before_unformat['event_period'] = $this->event_period;
      nm_limpa_numero($this->event_period, $this->field_config['event_period']['symbol_grp']) ; 
      $this->Before_unformat['idevent'] = $this->idevent;
      nm_limpa_numero($this->idevent, $this->field_config['idevent']['symbol_grp']) ; 
   }
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "event_period")
      {
          nm_limpa_numero($this->event_period, $this->field_config['event_period']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "idevent")
      {
          nm_limpa_numero($this->idevent, $this->field_config['idevent']['symbol_grp']) ; 
      }
   }
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if ('' !== $this->patients_idpatient || (!empty($format_fields) && isset($format_fields['patients_idpatient'])))
      {
          nmgp_Form_Num_Val($this->patients_idpatient, $this->field_config['patients_idpatient']['symbol_grp'], $this->field_config['patients_idpatient']['symbol_dec'], "0", "S", $this->field_config['patients_idpatient']['format_neg'], "", "", "-", $this->field_config['patients_idpatient']['symbol_fmt']) ; 
      }
      ...
      if ('' !== $this->event_period || (!empty($format_fields) && isset($format_fields['event_period'])))
      {
          nmgp_Form_Num_Val($this->event_period, $this->field_config['event_period']['symbol_grp'], $this->field_config['event_period']['symbol_dec'], "0", "S", $this->field_config['event_period']['format_neg'], "", "", "-", $this->field_config['event_period']['symbol_fmt']) ; 
      }
      if ($this->recur_info != '')
      {
          $tmpRecurInfo = json_decode($this->recur_info, true);
...
//
   ...
   {
          $this->ajax_return_values_patients_idpatient();
          $this->ajax_return_values_title();
          $this->ajax_return_values_descr();
          $this->ajax_return_values_categ();
          $this->ajax_return_values_idevent_status();
          $this->ajax_return_values_idevent_priority();
          ...
          $this->ajax_return_values_recurr();
          $this->ajax_return_values_period();
          $this->ajax_return_values_recur_info();
          $this->ajax_return_values_event_period();
          $this->ajax_return_values_idevent();
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              $this->NM_ajax_info['clearUpload']      = 'S';
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['idevent']['keyVal'] = calendar_event_mob_pack_protect_string($this->nmgp_dados_form['idevent']);
          }
   } // ajax_return_values

          //----- patients_idpatient
   function ajax_return_values_patients_idpatient($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("patients_idpatient", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->patients_idpatient);
              $aLookup = array();
              $this->_tmp_lookup_patients_idpatient = $this->patients_idpatient;
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['patients_idpatient'] = array(
                       'row'    => '',
               'type'    => 'select2_ac',
               'valList' => array($unformatted_value_patients_idpatient),
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['patients_idpatient']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['patients_idpatient']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['patients_idpatient']['labList'] = $aLabel;
          $val_output = isset($aLookup[0][calendar_event_mob_pack_protect_string(NM_charset_to_utf8($unformatted_value_patients_idpatient))]) ? $aLookup[0][calendar_event_mob_pack_protect_string(NM_charset_to_utf8($unformatted_value_patients_idpatient))] : "";
          $this->NM_ajax_info['fldList']['patients_idpatient_autocomp'] = array(
               'type'    => 'text',
   ...
   function ajax_return_values_descr($bForce = false)
   {
          ...
          //----- categ
   function ajax_return_values_categ($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("categ", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->categ);
              $aLookup = array();
              $this->_tmp_lookup_categ = $this->categ;
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"categ\"";
          if (isset($this->NM_ajax_info['select_html']['categ']) && !empty($this->NM_ajax_info['select_html']['categ']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['categ']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->categ == $sValue)
                  {
                      $this->_tmp_lookup_categ = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['categ'] = array(
                       'row'    => '',
               'type'    => 'select',
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['categ']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['categ']['valList'][$i] = calendar_event_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['categ']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['categ']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['categ']['labList'] = $aLabel;
          }
   }

          //----- idevent_status
   function ajax_return_values_idevent_status($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("idevent_status", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->idevent_status);
              $aLookup = array();
              $this->_tmp_lookup_idevent_status = $this->idevent_status;
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"idevent_status\"";
          if (isset($this->NM_ajax_info['select_html']['idevent_status']) && !empty($this->NM_ajax_info['select_html']['idevent_status']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['idevent_status']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->idevent_status == $sValue)
                  {
                      $this->_tmp_lookup_idevent_status = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['idevent_status'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['idevent_status']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['idevent_status']['valList'][$i] = calendar_event_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['idevent_status']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['idevent_status']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['idevent_status']['labList'] = $aLabel;
          }
   }

          //----- idevent_priority
   function ajax_return_values_idevent_priority($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("idevent_priority", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->idevent_priority);
              $aLookup = array();
              $this->_tmp_lookup_idevent_priority = $this->idevent_priority;
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"idevent_priority\"";
          if (isset($this->NM_ajax_info['select_html']['idevent_priority']) && !empty($this->NM_ajax_info['select_html']['idevent_priority']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['idevent_priority']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->idevent_priority == $sValue)
                  {
                      $this->_tmp_lookup_idevent_priority = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['idevent_priority'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['idevent_priority']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['idevent_priority']['valList'][$i] = calendar_event_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['idevent_priority']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['idevent_priority']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['idevent_priority']['labList'] = $aLabel;
          }
   }
...
$aLookup[] = array(calendar_event_mob_pack_protect_string('Y') => str_replace('<', '&lt;',calendar_event_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_per_allday'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup___calend_all_day__'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['__calend_all_day__']['valList'][$i] = calendar_event_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          //----- recurr
   function ajax_return_values_recurr($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("recurr", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->recurr);
              $aLookup = array();
              $this->_tmp_lookup_recurr = $this->recurr;

$aLookup[] = array(calendar_event_mob_pack_protect_string('Y') => str_replace('<', '&lt;',calendar_event_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_peri_yes'] . "")));
$aLookup[] = array(calendar_event_mob_pack_protect_string('N') => str_replace('<', '&lt;',calendar_event_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_peri_no'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_recurr'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_recurr'][] = 'N';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"recurr\"";
          if (isset($this->NM_ajax_info['select_html']['recurr']) && !empty($this->NM_ajax_info['select_html']['recurr']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['recurr']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->recurr == $sValue)
                  {
                      $this->_tmp_lookup_recurr = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['recurr'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['recurr']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['recurr']['valList'][$i] = calendar_event_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['recurr']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['recurr']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['recurr']['labList'] = $aLabel;
          }
   }
...
$aLookup[] = array(calendar_event_mob_pack_protect_string('D') => str_replace('<', '&lt;',calendar_event_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_daily'] . "")));
$aLookup[] = array(calendar_event_mob_pack_protect_string('W') => str_replace('<', '&lt;',calendar_event_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_weekly'] . "")));
$aLookup[] = array(calendar_event_mob_pack_protect_string('M') => str_replace('<', '&lt;',calendar_event_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_monthly'] . "")));
$aLookup[] = array(calendar_event_mob_pack_protect_string('A') => str_replace('<', '&lt;',calendar_event_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_annual'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_period'][] = 'D';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_period'][] = 'W';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_period'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_period'][] = 'A';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['period']['valList'][$i] = calendar_event_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_recur_info($bForce = false)
   {
          ...
          //----- event_period
   function ajax_return_values_event_period($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("event_period", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->event_period);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['event_period'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
          ...
          //----- idevent
   function ajax_return_values_idevent($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("idevent", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->idevent);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['idevent'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
               'labList' => array($this->form_format_readonly("idevent", $this->form_encode_input($sTmpValue))),
              );
          }
   }
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
//----------- 
   ...
   { 
      ...
      if ('incluir' == $this->nmgp_opcao && empty($this->doctor_iddoctor)) {$this->doctor_iddoctor = "" . $_SESSION['var_doctor'] . ""; $NM_val_null[] = "doctor_iddoctor";}  
      if ('incluir' == $this->nmgp_opcao && $this->patients_idpatient == ""){$this->patients_idpatient = "null"; $NM_val_null[] = "patients_idpatient";}  
      if (('alterar' == $this->nmgp_opcao || 'igual' == $this->nmgp_opcao) && $this->patients_idpatient == ""){$this->patients_idpatient = "null"; $NM_val_null[] = "patients_idpatient";}  
      if ('incluir' == $this->nmgp_opcao && $this->event_period == ""){$this->event_period = "null"; $NM_val_null[] = "event_period";}  
      if (('alterar' == $this->nmgp_opcao || 'igual' == $this->nmgp_opcao) && $this->event_period == ""){$this->event_period = "null"; $NM_val_null[] = "event_period";}  
      $NM_val_form['patients_idpatient'] = $this->patients_idpatient;
      $NM_val_form['title'] = $this->title;
      $NM_val_form['descr'] = $this->descr;
      $NM_val_form['categ'] = $this->categ;
      $NM_val_form['idevent_status'] = $this->idevent_status;
      $NM_val_form['idevent_priority'] = $this->idevent_priority;
      ...
      $NM_val_form['recurr'] = $this->recurr;
      $NM_val_form['period'] = $this->period;
      $NM_val_form['recur_info'] = $this->recur_info;
      $NM_val_form['event_period'] = $this->event_period;
      $NM_val_form['idevent'] = $this->idevent;
      ...
      if ($this->idevent === "" || is_null($this->idevent))  
      { 
          $this->idevent = 0;
      } 
      if ($this->categ === "" || is_null($this->categ))  
      { 
          $this->categ = 0;
          $this->sc_force_zero[] = 'categ';
      } 
      ...
      if ($this->idevent_status === "" || is_null($this->idevent_status))  
      { 
          $this->idevent_status = 0;
          $this->sc_force_zero[] = 'idevent_status';
      } 
      if ($this->idevent_priority === "" || is_null($this->idevent_priority))  
      { 
          $this->idevent_priority = 0;
          $this->sc_force_zero[] = 'idevent_priority';
      } 
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          $this->recurr_before_qstr = $this->recurr;
          $this->recurr = substr($this->Db->qstr($this->recurr), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->recurr = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->recurr);
          }
          if ($this->recurr == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->recurr = "null"; 
              $NM_val_null[] = "recurr";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          {
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) AS countTest from " . $this->Ini->nm_tabela . " where idevent = $this->idevent ";
              $rs1 = $this->Db->Execute("select count(*) AS countTest from " . $this->Ini->nm_tabela . " where idevent = $this->idevent "); 
          }  
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          {
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) AS countTest from " . $this->Ini->nm_tabela . " where idevent = $this->idevent ";
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "title = '$this->title', descr = '$this->descr', start_date = #$this->start_date#, start_time = #$this->start_time#, end_date = #$this->end_date#, end_time = #$this->end_time#, recurr = '$this->recurr', period = '$this->period', categ = $this->categ, recur_info = '$this->recur_info', event_color = '$this->event_color', patients_idpatient = $this->patients_idpatient, event_period = $this->event_period, idevent_status = $this->idevent_status, idevent_priority = $this->idevent_priority"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "title = '$this->title', descr = '$this->descr', start_date = " . $this->Ini->date_delim . $this->start_date . $this->Ini->date_delim1 . ", start_time = " . $this->Ini->date_delim . $this->start_time . $this->Ini->date_delim1 . ", end_date = " . $this->Ini->date_delim . $this->end_date . $this->Ini->date_delim1 . ", end_time = " . $this->Ini->date_delim . $this->end_time . $this->Ini->date_delim1 . ", recurr = '$this->recurr', period = '$this->period', categ = $this->categ, recur_info = '$this->recur_info', event_color = '$this->event_color', patients_idpatient = $this->patients_idpatient, event_period = $this->event_period, idevent_status = $this->idevent_status, idevent_priority = $this->idevent_priority"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "title = '$this->title', descr = '$this->descr', start_date = EXTEND('$this->start_date', YEAR TO DAY), start_time = " . $this->Ini->date_delim . $this->start_time . $this->Ini->date_delim1 . ", end_date = EXTEND('$this->end_date', YEAR TO DAY), end_time = " . $this->Ini->date_delim . $this->end_time . $this->Ini->date_delim1 . ", recurr = '$this->recurr', period = '$this->period', categ = $this->categ, recur_info = '$this->recur_info', event_color = '$this->event_color', patients_idpatient = $this->patients_idpatient, event_period = $this->event_period, idevent_status = $this->idevent_status, idevent_priority = $this->idevent_priority"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $comando .= " WHERE idevent = $this->idevent ";  
              }  
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              {
                  $comando .= " WHERE idevent = $this->idevent ";  
              ...
              $this->recurr = $this->recurr_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['idevent'])) { $this->idevent = $NM_val_form['idevent']; }
              elseif (isset($this->idevent)) { $this->nm_limpa_alfa($this->idevent); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['recurr'])) { $this->recurr = $NM_val_form['recurr']; }
              elseif (isset($this->recurr)) { $this->nm_limpa_alfa($this->recurr); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['categ'])) { $this->categ = $NM_val_form['categ']; }
              elseif (isset($this->categ)) { $this->nm_limpa_alfa($this->categ); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['patients_idpatient'])) { $this->patients_idpatient = $NM_val_form['patients_idpatient']; }
              elseif (isset($this->patients_idpatient)) { $this->nm_limpa_alfa($this->patients_idpatient); }
              if     (isset($NM_val_form) && isset($NM_val_form['event_period'])) { $this->event_period = $NM_val_form['event_period']; }
              elseif (isset($this->event_period)) { $this->nm_limpa_alfa($this->event_period); }
              if     (isset($NM_val_form) && isset($NM_val_form['idevent_status'])) { $this->idevent_status = $NM_val_form['idevent_status']; }
              elseif (isset($this->idevent_status)) { $this->nm_limpa_alfa($this->idevent_status); }
              if     (isset($NM_val_form) && isset($NM_val_form['idevent_priority'])) { $this->idevent_priority = $NM_val_form['idevent_priority']; }
              elseif (isset($this->idevent_priority)) { $this->nm_limpa_alfa($this->idevent_priority); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('patients_idpatient', 'title', 'descr', 'categ', 'idevent_status', 'idevent_priority', 'event_color', 'start_date', 'end_date', 'start_time', 'end_time', '__calend_all_day__', 'recurr', 'period', 'recur_info', 'event_period'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (title, descr, start_date, start_time, end_date, end_time, recurr, period, categ, id_api, id_event_google, recur_info, event_color, creator, reminder, doctor_iddoctor, patients_idpatient, event_period, idevent_status, idevent_priority) VALUES ('$this->title', '$this->descr', #$this->start_date#, #$this->start_time#, #$this->end_date#, #$this->end_time#, '$this->recurr', '$this->period', $this->categ, '$this->id_api', '$this->id_event_google', '$this->recur_info', '$this->event_color', '$this->creator', '$this->reminder', $this->doctor_iddoctor, $this->patients_idpatient, $this->event_period, $this->idevent_status, $this->idevent_priority)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "title, descr, start_date, start_time, end_date, end_time, recurr, period, categ, id_api, id_event_google, recur_info, event_color, creator, reminder, doctor_iddoctor, patients_idpatient, event_period, idevent_status, idevent_priority) VALUES (" . $NM_seq_auto . "'$this->title', '$this->descr', " . $this->Ini->date_delim . $this->start_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->start_time . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->end_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->end_time . $this->Ini->date_delim1 . ", '$this->recurr', '$this->period', $this->categ, '$this->id_api', '$this->id_event_google', '$this->recur_info', '$this->event_color', '$this->creator', '$this->reminder', $this->doctor_iddoctor, $this->patients_idpatient, $this->event_period, $this->idevent_status, $this->idevent_priority)"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "title, descr, start_date, start_time, end_date, end_time, recurr, period, categ, id_api, id_event_google, recur_info, event_color, creator, reminder, doctor_iddoctor, patients_idpatient, event_period, idevent_status, idevent_priority) VALUES (" . $NM_seq_auto . "'$this->title', '$this->descr', EXTEND('$this->start_date', YEAR TO DAY), " . $this->Ini->date_delim . $this->start_time . $this->Ini->date_delim1 . ", EXTEND('$this->end_date', YEAR TO DAY), " . $this->Ini->date_delim . $this->end_time . $this->Ini->date_delim1 . ", '$this->recurr', '$this->period', $this->categ, '$this->id_api', '$this->id_event_google', '$this->recur_info', '$this->event_color', '$this->creator', '$this->reminder', $this->doctor_iddoctor, $this->patients_idpatient, $this->event_period, $this->idevent_status, $this->idevent_priority)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "title, descr, start_date, start_time, end_date, end_time, recurr, period, categ, id_api, id_event_google, recur_info, event_color, creator, reminder, doctor_iddoctor, patients_idpatient, event_period, idevent_status, idevent_priority) VALUES (" . $NM_seq_auto . "'$this->title', '$this->descr', " . $this->Ini->date_delim . $this->start_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->start_time . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->end_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->end_time . $this->Ini->date_delim1 . ", '$this->recurr', '$this->period', $this->categ, '$this->id_api', '$this->id_event_google', '$this->recur_info', '$this->event_color', '$this->creator', '$this->reminder', $this->doctor_iddoctor, $this->patients_idpatient, $this->event_period, $this->idevent_status, $this->idevent_priority)"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      if ($this->nmgp_opcao == "excluir") 
      { 
          $this->idevent = substr($this->Db->qstr($this->idevent), 1, -1); 
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where idevent = $this->idevent "; 
                  $rs = $this->Db->Execute("DELETE FROM " . $this->Ini->nm_tabela . " where idevent = $this->idevent "); 
              }  
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              {
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where idevent = $this->idevent "; 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['reg_start'] = 0; 
              }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_idevent_status = $this->idevent_status;
}
...
$sql = "INSERT INTO event_history (idevent, idevent_status, date_event, time_event, login) VALUES (".$this->idevent .", ".$this->idevent_status .", ".$this->Ini->sc_Sql_Protect($edate, "date").", ".$this->Ini->sc_Sql_Protect($etime, "date").",'".$this->sc_temp_usr_login."')";
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_idevent_status != $this->idevent_status || (isset($bFlagRead_idevent_status) && $bFlagRead_idevent_status)))
    {
        $this->ajax_return_values_idevent_status(true);
    }
}
$_SESSION['scriptcase']['calendar_event_mob']['contr_erro'] = 'off'; 
    }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['parms'] = "idevent?#?$this->idevent?@?"; 
      }
      $this->NM_commit_db(); 
      if (isset($this->google_calendar_insert) && $this->google_calendar_insert)
      {
      ...
      { 
          $this->idevent = null === $this->idevent ? null : substr($this->Db->qstr($this->idevent), 1, -1); 
      } 
      if (isset($this->NM_where_filter))
      {
          $this->NM_where_filter = str_replace("@percent@", "%", $this->NM_where_filter);
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
          { 
              $nmgp_select = "SELECT idevent, title, descr, str_replace (convert(char(10),start_date,102), '.', '-') + ' ' + convert(char(8),start_date,20), str_replace (convert(char(10),start_time,102), '.', '-') + ' ' + convert(char(8),start_time,20), str_replace (convert(char(10),end_date,102), '.', '-') + ' ' + convert(char(8),end_date,20), str_replace (convert(char(10),end_time,102), '.', '-') + ' ' + convert(char(8),end_time,20), recurr, period, categ, id_api, id_event_google, recur_info, event_color, creator, reminder, doctor_iddoctor, patients_idpatient, event_period, idevent_status, idevent_priority from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT idevent, title, descr, convert(char(23),start_date,121), convert(char(23),start_time,121), convert(char(23),end_date,121), convert(char(23),end_time,121), recurr, period, categ, id_api, id_event_google, recur_info, event_color, creator, reminder, doctor_iddoctor, patients_idpatient, event_period, idevent_status, idevent_priority from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT idevent, title, descr, start_date, start_time, end_date, end_time, recurr, period, categ, id_api, id_event_google, recur_info, event_color, creator, reminder, doctor_iddoctor, patients_idpatient, event_period, idevent_status, idevent_priority from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT idevent, title, descr, EXTEND(start_date, YEAR TO DAY), start_time, EXTEND(end_date, YEAR TO DAY), end_time, recurr, period, categ, id_api, id_event_google, recur_info, event_color, creator, reminder, doctor_iddoctor, patients_idpatient, event_period, idevent_status, idevent_priority from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT idevent, title, descr, start_date, start_time, end_date, end_time, recurr, period, categ, id_api, id_event_google, recur_info, event_color, creator, reminder, doctor_iddoctor, patients_idpatient, event_period, idevent_status, idevent_priority from " . $this->Ini->nm_tabela ; 
          ...
          $aWhere = array();
          $aWhere[] = "(doctor_iddoctor = " . $_SESSION['var_doctor'] . ")";
          $aWhere[] = $sc_where_filter;
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
                  {
                     $aWhere[] = "idevent = $this->idevent"; 
                  }  
                  elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
                  {
                     $aWhere[] = "idevent = $this->idevent"; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['reg_start']) ;  
              } 
          } 
          ...
          { 
              $this->idevent = $rs->fields[0] ; 
              $this->nmgp_dados_select['idevent'] = $this->idevent;
              ...
              $this->recurr = $rs->fields[7] ; 
              $this->nmgp_dados_select['recurr'] = $this->recurr;
              $this->period = $rs->fields[8] ; 
              $this->nmgp_dados_select['period'] = $this->period;
              $this->categ = $rs->fields[9] ; 
              $this->nmgp_dados_select['categ'] = $this->categ;
              ...
              $this->doctor_iddoctor = $rs->fields[16] ; 
              $this->nmgp_dados_select['doctor_iddoctor'] = $this->doctor_iddoctor;
              $this->patients_idpatient = $rs->fields[17] ; 
              $this->nmgp_dados_select['patients_idpatient'] = $this->patients_idpatient;
              $this->event_period = $rs->fields[18] ; 
              $this->nmgp_dados_select['event_period'] = $this->event_period;
              $this->idevent_status = $rs->fields[19] ; 
              $this->nmgp_dados_select['idevent_status'] = $this->idevent_status;
              $this->idevent_priority = $rs->fields[20] ; 
              $this->nmgp_dados_select['idevent_priority'] = $this->idevent_priority;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $this->event_period = (string)$this->event_period; 
              $this->idevent_status = (string)$this->idevent_status; 
              $this->idevent_priority = (string)$this->idevent_priority; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['parms'] = "idevent?#?$this->idevent?@?";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['reg_start'] < $qt_geral_reg_calendar_event_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }

//
function destroy_evt($ev)
{
$_SESSION['scriptcase']['calendar_event_mob']['contr_erro'] = 'on';
  
  $sql = "SELECT idevent, start_date FROM event WHERE event_period = $ev";
  ...
  for ($i = 0; $i < $qtd; $i++) {
	  ...
	  $sql = "UPDATE event SET categ = null, descr = null, title = null, patients_idpatient = null , event_period = null
			  WHERE idevent = ".$this->ds2[$i][0];
...
function patients_idpatient_onChange()
{
$_SESSION['scriptcase']['calendar_event_mob']['contr_erro'] = 'on';
...
$sql = "SELECT idpatient, patient_name FROM patients WHERE idpatient = ".$this->patients_idpatient ;
...
{
	$this->title  = $this->rs[0][0]. " - ".$this->rs[0][1];
}

$modificado_patients_idpatient = $this->patients_idpatient;
$modificado_title = $this->title;
$this->nm_formatar_campos('patients_idpatient', 'title');
if ($original_patients_idpatient !== $modificado_patients_idpatient || isset($this->nmgp_cmp_readonly['patients_idpatient']) || (isset($bFlagRead_patients_idpatient) && $bFlagRead_patients_idpatient))
{
    $this->ajax_return_values_patients_idpatient(true);
}
if ($original_title !== $modificado_title || isset($this->nmgp_cmp_readonly['title']) || (isset($bFlagRead_title) && $bFlagRead_title))
{
    $this->ajax_return_values_title(true);
}
$this->NM_ajax_info['event_field'] = 'patients';
calendar_event_mob_pack_ajax_response();
exit;
$_SESSION['scriptcase']['calendar_event_mob']['contr_erro'] = 'off';
}
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("calendar_event_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['sc_outra_jan'] != 'calendar_event_mob')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
<head>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 <title>calendar_event_mob</title>
<?php
...
function refreshFilterCategories()
{
    ...
    setCategory();
    scMainCalendar.addEventSource('calendar_event_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
}
...
{
    tb_show('', 'calendar_event_mob.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=600&width=800', '');
}
function editEvent_desktop(sEventId)
{
    tb_show('', 'calendar_event_mob.php?nmgp_opcao=igual_calendar&idevent=' + sEventId + '&__orig_idevent=' + sEventId + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=600&width=800', '');
}
<?php
...
{
    tb_show('', 'calendar_event_mob.php?nmgp_opcao=importGoogle&nmgp_outra_jan=true&script_case_init=". $this->form_encode_input($this->Ini->sc_page) ."&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=150&width=400', '');
}
function mobileMenuExportClick()
{
    tb_show('', 'calendar_event_mob.php?nmgp_opcao=exportGoogle&nmgp_outra_jan=true&script_case_init=". $this->form_encode_input($this->Ini->sc_page) ."&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=280&width=450', '');
}
...
?>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            scMainCalendar = new FullCalendar.Calendar(mainCalendarEl, {
                ...
                slotMinTime: "08:00",
                slotMaxTime: "18:15",
                events: 'calendar_event_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
...
<?php
    ...
    {
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['dashboard_info']['under_dashboard']) {
?>
<style type="text/css">
...
<?php
        $categoryLookup = $this->Form_lookup_categ();
...
<?php
    ...
    function calendarOutput_formMobile()
    {
        if (isset($_SESSION['scriptcase']['device_mobile']) && $_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile']) {
?>
<form name="F1" id="sc-ui-form" method="post" action="calendar_event.php" target="_self">
    ...
    <input type="hidden" name="idevent" id="sc-ui-event-id" value="" />
</form>
<?php
        }
...
<?php
   ...
   function calendarFetchSelect($googleInfo = false)
   {
       ...
       $aSelect['category'] = "categ";

       $aSelect['recurrence'] = "recurr";
   ...
   function calendarWhere($sId, $bRecur = false, $bPrintCalendar = false, $filter = null)
   {
           ...
           if ('' != $sCategory)
           {
               ...
               foreach ($categoryList as $categoryItem)
               {
                   if ('SCNULLCAT' == $categoryItem) {
                       $categoryRules[] = "(categ = 0 OR categ IS NULL)";
                   }
                   else {
                       $categoryRules[] = "categ = {$categoryItem}";
                   }
               }
       ...
       $cWhere[] = "(doctor_iddoctor = " . $_SESSION['var_doctor'] . ")";
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_idevent_status()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_idevent_status']))
{
...
else
{
   ...
   function Form_lookup_idevent_priority()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['Lookup_idevent_priority']))
{
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter_form'] . " and ((doctor_iddoctor = " . $_SESSION['var_doctor'] . ")) and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where (doctor_iddoctor = " . $_SESSION['var_doctor'] . ") and (" . $comando . ")";
      }
      ...
      $qt_geral_reg_calendar_event_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['total'] = $qt_geral_reg_calendar_event_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          calendar_event_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "idevent";$nm_numeric[] = "categ";$nm_numeric[] = "doctor_iddoctor";$nm_numeric[] = "patients_idpatient";$nm_numeric[] = "event_period";$nm_numeric[] = "idevent_status";$nm_numeric[] = "idevent_priority";
      if (in_array($campo_join, $nm_numeric))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "calendar_event_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "calendar_event_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['masterValue']))
{
  ...
  exit;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event_mob']['ordem_ord'] == " desc") {
