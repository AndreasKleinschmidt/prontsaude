...
$old_error_handler = set_error_handler("calendar_event_scriptcase_error_handler");

function calendar_event_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['calendar_event']['contr_erro']) && $_SESSION['scriptcase']['calendar_event']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_calendar_event->contr_calendar_event->Apl_com_erro = true;
            if ($inicial_calendar_event->contr_calendar_event->NM_ajax_flag)
            {
                $inicial_calendar_event->contr_calendar_event->NM_ajax_info['errList']['geral_calendar_event'][] = $msg;
                return;
            }
            calendar_event_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function calendar_event_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['calendar_event'])  && '' != $_SESSION['scriptcase']['error_icon']['calendar_event'])  ? $_SESSION['scriptcase']['error_icon']['calendar_event']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['calendar_event']) && '' != $_SESSION['scriptcase']['error_span_title']['calendar_event']) ? $_SESSION['scriptcase']['error_span_title']['calendar_event'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['calendar_event']) && '' != $_SESSION['scriptcase']['error_icon_title']['calendar_event']) ? $_SESSION['scriptcase']['error_icon_title']['calendar_event'] : '';
?>
