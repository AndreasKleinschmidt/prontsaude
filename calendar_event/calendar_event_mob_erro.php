...
$old_error_handler = set_error_handler("calendar_event_mob_scriptcase_error_handler");

function calendar_event_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['calendar_event_mob']['contr_erro']) && $_SESSION['scriptcase']['calendar_event_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_calendar_event_mob->contr_calendar_event_mob->Apl_com_erro = true;
            if ($inicial_calendar_event_mob->contr_calendar_event_mob->NM_ajax_flag)
            {
                $inicial_calendar_event_mob->contr_calendar_event_mob->NM_ajax_info['errList']['geral_calendar_event_mob'][] = $msg;
                return;
            }
            calendar_event_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function calendar_event_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['calendar_event_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['calendar_event_mob'])  ? $_SESSION['scriptcase']['error_icon']['calendar_event_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['calendar_event_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['calendar_event_mob']) ? $_SESSION['scriptcase']['error_span_title']['calendar_event_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['calendar_event_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['calendar_event_mob']) ? $_SESSION['scriptcase']['error_icon_title']['calendar_event_mob'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['calendar_event']['error_buffer'] .= ob_get_flush();
}
