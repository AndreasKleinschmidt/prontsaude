  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendar_event" == sTestField)
        {
...
?>
  ...
  function do_ajax_calendar_event_validate_patients_idpatient()
  {
  } // do_ajax_calendar_event_validate_patients_idpatient

  function do_ajax_calendar_event_validate_patients_idpatient_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_patients_idpatient_cb

  // ---------- Validate title
  function do_ajax_calendar_event_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldText(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate_title(var_title, var_script_case_init, do_ajax_calendar_event_validate_title_cb);
  } // do_ajax_calendar_event_validate_title

  function do_ajax_calendar_event_validate_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "title";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_title_cb

  // ---------- Validate descr
  function do_ajax_calendar_event_validate_descr()
  {
    var nomeCampo_descr = "descr";
    var var_descr = scAjaxGetFieldText(nomeCampo_descr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate_descr(var_descr, var_script_case_init, do_ajax_calendar_event_validate_descr_cb);
  } // do_ajax_calendar_event_validate_descr

  function do_ajax_calendar_event_validate_descr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_descr_cb

  // ---------- Validate categ
  function do_ajax_calendar_event_validate_categ()
  {
    var nomeCampo_categ = "categ";
    var var_categ = scAjaxGetFieldSelect(nomeCampo_categ);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate_categ(var_categ, var_script_case_init, do_ajax_calendar_event_validate_categ_cb);
  } // do_ajax_calendar_event_validate_categ

  function do_ajax_calendar_event_validate_categ_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "categ";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_categ_cb

  // ---------- Validate idevent_status
  function do_ajax_calendar_event_validate_idevent_status()
  {
    var nomeCampo_idevent_status = "idevent_status";
    var var_idevent_status = scAjaxGetFieldSelect(nomeCampo_idevent_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate_idevent_status(var_idevent_status, var_script_case_init, do_ajax_calendar_event_validate_idevent_status_cb);
  } // do_ajax_calendar_event_validate_idevent_status

  function do_ajax_calendar_event_validate_idevent_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_idevent_status_cb

  // ---------- Validate idevent_priority
  function do_ajax_calendar_event_validate_idevent_priority()
  {
    var nomeCampo_idevent_priority = "idevent_priority";
    var var_idevent_priority = scAjaxGetFieldSelect(nomeCampo_idevent_priority);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate_idevent_priority(var_idevent_priority, var_script_case_init, do_ajax_calendar_event_validate_idevent_priority_cb);
  } // do_ajax_calendar_event_validate_idevent_priority

  function do_ajax_calendar_event_validate_idevent_priority_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_idevent_priority_cb

  // ---------- Validate event_color
  function do_ajax_calendar_event_validate_event_color()
  {
    var nomeCampo_event_color = "event_color";
    var var_event_color = scAjaxGetFieldText(nomeCampo_event_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate_event_color(var_event_color, var_script_case_init, do_ajax_calendar_event_validate_event_color_cb);
  } // do_ajax_calendar_event_validate_event_color

  function do_ajax_calendar_event_validate_event_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_event_color_cb

  // ---------- Validate start_date
  function do_ajax_calendar_event_validate_start_date()
  {
    ...
    setTimeout(function() {
      var var_start_date = scAjaxGetFieldText(nomeCampo_start_date);
      x_ajax_calendar_event_validate_start_date(var_start_date, var_script_case_init, do_ajax_calendar_event_validate_start_date_cb);
    }, 200);
  } // do_ajax_calendar_event_validate_start_date

  function do_ajax_calendar_event_validate_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_start_date_cb

  // ---------- Validate end_date
  function do_ajax_calendar_event_validate_end_date()
  {
    var nomeCampo_end_date = "end_date";
    var var_end_date = scAjaxGetFieldText(nomeCampo_end_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate_end_date(var_end_date, var_script_case_init, do_ajax_calendar_event_validate_end_date_cb);
  } // do_ajax_calendar_event_validate_end_date

  function do_ajax_calendar_event_validate_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_end_date_cb

  // ---------- Validate start_time
  function do_ajax_calendar_event_validate_start_time()
  {
    var nomeCampo_start_time = "start_time";
    var var_start_time = scAjaxGetFieldText(nomeCampo_start_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate_start_time(var_start_time, var_script_case_init, do_ajax_calendar_event_validate_start_time_cb);
  } // do_ajax_calendar_event_validate_start_time

  function do_ajax_calendar_event_validate_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_start_time_cb

  // ---------- Validate end_time
  function do_ajax_calendar_event_validate_end_time()
  {
    var nomeCampo_end_time = "end_time";
    var var_end_time = scAjaxGetFieldText(nomeCampo_end_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate_end_time(var_end_time, var_script_case_init, do_ajax_calendar_event_validate_end_time_cb);
  } // do_ajax_calendar_event_validate_end_time

  function do_ajax_calendar_event_validate_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_end_time_cb

  // ---------- Validate __calend_all_day__
  function do_ajax_calendar_event_validate___calend_all_day__()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate___calend_all_day__(var___calend_all_day__, var_script_case_init, do_ajax_calendar_event_validate___calend_all_day___cb);
  } // do_ajax_calendar_event_validate___calend_all_day__

  function do_ajax_calendar_event_validate___calend_all_day___cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate___calend_all_day___cb

  // ---------- Validate recurr
  function do_ajax_calendar_event_validate_recurr()
  {
    var nomeCampo_recurr = "recurr";
    var var_recurr = scAjaxGetFieldSelect(nomeCampo_recurr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate_recurr(var_recurr, var_script_case_init, do_ajax_calendar_event_validate_recurr_cb);
  } // do_ajax_calendar_event_validate_recurr

  function do_ajax_calendar_event_validate_recurr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "recurr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_recurr_cb

  // ---------- Validate period
  function do_ajax_calendar_event_validate_period()
  {
    var nomeCampo_period = "period";
    var var_period = scAjaxGetFieldSelect(nomeCampo_period);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate_period(var_period, var_script_case_init, do_ajax_calendar_event_validate_period_cb);
  } // do_ajax_calendar_event_validate_period

  function do_ajax_calendar_event_validate_period_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "period";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_period_cb

  // ---------- Validate recur_info
  function do_ajax_calendar_event_validate_recur_info()
  {
    var nomeCampo_recur_info = "recur_info";
    var var_recur_info = scAjaxGetFieldRecurInfo(nomeCampo_recur_info);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate_recur_info(var_recur_info, var_script_case_init, do_ajax_calendar_event_validate_recur_info_cb);
  } // do_ajax_calendar_event_validate_recur_info

  function do_ajax_calendar_event_validate_recur_info_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_recur_info_cb

  // ---------- Validate event_period
  function do_ajax_calendar_event_validate_event_period()
  {
    var nomeCampo_event_period = "event_period";
    var var_event_period = scAjaxGetFieldHidden(nomeCampo_event_period);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_event_validate_event_period(var_event_period, var_script_case_init, do_ajax_calendar_event_validate_event_period_cb);
  } // do_ajax_calendar_event_validate_event_period

  function do_ajax_calendar_event_validate_event_period_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_event_validate_event_period_cb

  // ---------- Event onchange patients_idpatient
  function do_ajax_calendar_event_event_patients_idpatient_onchange()
  {
    var var_patients_idpatient = scAjaxGetFieldText("id_ac_patients_idpatient");
    var var_title = scAjaxGetFieldText("title");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_calendar_event_event_patients_idpatient_onchange(var_patients_idpatient, var_title, var_script_case_init, do_ajax_calendar_event_event_patients_idpatient_onchange_cb);
  } // do_ajax_calendar_event_event_patients_idpatient_onchange

  function do_ajax_calendar_event_event_patients_idpatient_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "patients_idpatient";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_calendar_event_event_patients_idpatient_onchange_cb_after_alert);
  } // do_ajax_calendar_event_event_patients_idpatient_onchange_cb
  function do_ajax_calendar_event_event_patients_idpatient_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_calendar_event_event_patients_idpatient_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_calendar_event_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendar_event_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_calendar_event_submit_form(var_patients_idpatient, var_title, var_descr, var_categ, var_idevent_status, var_idevent_priority, var_event_color, var_start_date, var_end_date, var_start_time, var_end_time, var___calend_all_day__, var_recurr, var_period, var_recur_info, var_event_period, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendar_event_submit_form_cb);
  } // do_ajax_calendar_event_submit_form

  function do_ajax_calendar_event_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_calendar_event_submit_form_cb_after_alert);
  } // do_ajax_calendar_event_submit_form_cb
  function do_ajax_calendar_event_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendar_event_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendar_event_navigate_form()
  {
    perform_ajax_calendar_event_navigate_form();
  }

  function perform_ajax_calendar_event_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_calendar_event_navigate_form(var_idevent, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendar_event_navigate_form_cb);
  } // do_ajax_calendar_event_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_event']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendar_event_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendar_event_navigate_form_cb_after_alert);
  } // do_ajax_calendar_event_navigate_form_cb
  function do_ajax_calendar_event_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendar_event_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_calendar_event_navigate_form_cb_after_alert

  function sc_hide_calendar_event_form()
  {
