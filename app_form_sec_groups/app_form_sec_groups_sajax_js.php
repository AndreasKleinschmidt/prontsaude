...
?>
  ...
  // ---------- Validate apps
  function do_ajax_app_form_sec_groups_validate_apps()
  {
    var nomeCampo_apps = "apps";
    nm_pack(nomeCampo_apps + '_dest', nomeCampo_apps);
    var var_apps = scAjaxGetFieldText(nomeCampo_apps);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_groups_validate_apps(var_apps, var_script_case_init, do_ajax_app_form_sec_groups_validate_apps_cb);
  } // do_ajax_app_form_sec_groups_validate_apps

  function do_ajax_app_form_sec_groups_validate_apps_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "apps";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_groups_validate_apps_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_sec_groups_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_sec_groups_submit_form(var_description, var_apps, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_sec_groups_submit_form_cb);
