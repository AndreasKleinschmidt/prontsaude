  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_speciality" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idspeciality_
  function do_ajax_form_speciality_validate_idspeciality_(iNumLinha)
  {
    var nomeCampo_idspeciality_ = "idspeciality_" + iNumLinha;
    var var_idspeciality_ = scAjaxGetFieldHidden(nomeCampo_idspeciality_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_speciality_validate_idspeciality_(var_idspeciality_, iNumLinha, var_script_case_init, do_ajax_form_speciality_validate_idspeciality__cb);
  } // do_ajax_form_speciality_validate_idspeciality_

  function do_ajax_form_speciality_validate_idspeciality__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idspeciality_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idspeciality_";
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_speciality_validate_idspeciality__cb

  // ---------- Validate speciality_desc_
  function do_ajax_form_speciality_validate_speciality_desc_(iNumLinha)
  {
    var nomeCampo_speciality_desc_ = "speciality_desc_" + iNumLinha;
    var var_speciality_desc_ = scAjaxGetFieldText(nomeCampo_speciality_desc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_speciality_validate_speciality_desc_(var_speciality_desc_, iNumLinha, var_script_case_init, do_ajax_form_speciality_validate_speciality_desc__cb);
  } // do_ajax_form_speciality_validate_speciality_desc_

  function do_ajax_form_speciality_validate_speciality_desc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "speciality_desc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "speciality_desc_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_speciality_validate_speciality_desc__cb

  // ---------- Validate speciality_desc_pt_
  function do_ajax_form_speciality_validate_speciality_desc_pt_(iNumLinha)
  {
    var nomeCampo_speciality_desc_pt_ = "speciality_desc_pt_" + iNumLinha;
    var var_speciality_desc_pt_ = scAjaxGetFieldText(nomeCampo_speciality_desc_pt_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_speciality_validate_speciality_desc_pt_(var_speciality_desc_pt_, iNumLinha, var_script_case_init, do_ajax_form_speciality_validate_speciality_desc_pt__cb);
  } // do_ajax_form_speciality_validate_speciality_desc_pt_

  function do_ajax_form_speciality_validate_speciality_desc_pt__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "speciality_desc_pt_" + iLineNumber;
    }
    else
    {
      sFieldValid = "speciality_desc_pt_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_speciality_validate_speciality_desc_pt__cb

  // ---------- Validate speciality_desc_es_
  function do_ajax_form_speciality_validate_speciality_desc_es_(iNumLinha)
  {
    var nomeCampo_speciality_desc_es_ = "speciality_desc_es_" + iNumLinha;
    var var_speciality_desc_es_ = scAjaxGetFieldText(nomeCampo_speciality_desc_es_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_speciality_validate_speciality_desc_es_(var_speciality_desc_es_, iNumLinha, var_script_case_init, do_ajax_form_speciality_validate_speciality_desc_es__cb);
  } // do_ajax_form_speciality_validate_speciality_desc_es_

  function do_ajax_form_speciality_validate_speciality_desc_es__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "speciality_desc_es_" + iLineNumber;
    }
    else
    {
      sFieldValid = "speciality_desc_es_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_speciality_validate_speciality_desc_es__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_speciality_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_speciality_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_speciality_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_speciality_add_new_line_cb);
  } // do_ajax_form_speciality_add_new_line

  function do_ajax_form_speciality_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_speciality_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_speciality_backup_line(iNumLinha)
  {
    var var_idspeciality_ = scAjaxGetFieldHidden("idspeciality_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_speciality_backup_line(var_idspeciality_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_speciality_backup_line_cb);
  } // do_ajax_form_speciality_backup_line

  function do_ajax_form_speciality_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_speciality_backup_line_cb

  function do_ajax_form_speciality_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_speciality_cancel_insert

  function do_ajax_form_speciality_cancel_update(iSeqVert)
  {
    do_ajax_form_speciality_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_speciality_cancel_update

  function do_ajax_form_speciality_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_speciality_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_speciality_table_refresh()
  {
    var var_idspeciality_ = document.F2.idspeciality_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_speciality_table_refresh(var_idspeciality_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_speciality_table_refresh_cb);
  } //  do_ajax_form_speciality_table_refresh

  function do_ajax_form_speciality_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idspeciality_.value = scAjaxGetKeyValue("idspeciality_");
    ...
    scAjaxAlert(do_ajax_form_speciality_table_refresh_cb_after_alert);
  } // do_ajax_form_speciality_table_refresh_cb
  function do_ajax_form_speciality_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_speciality_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_speciality_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_speciality_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idspeciality_ = scAjaxGetFieldHidden("idspeciality_" + iNumLinha);
    var var_speciality_desc_ = scAjaxGetFieldText("speciality_desc_" + iNumLinha);
    var var_speciality_desc_pt_ = scAjaxGetFieldText("speciality_desc_pt_" + iNumLinha);
    var var_speciality_desc_es_ = scAjaxGetFieldText("speciality_desc_es_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_speciality_submit_form(var_idspeciality_, var_speciality_desc_, var_speciality_desc_pt_, var_speciality_desc_es_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_speciality_submit_form_cb);
  } // do_ajax_form_speciality_submit_form

  function do_ajax_form_speciality_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_speciality_submit_form_cb_after_alert);
  } // do_ajax_form_speciality_submit_form_cb
  function do_ajax_form_speciality_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_speciality_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_speciality_navigate_form()
  {
    perform_ajax_form_speciality_navigate_form();
  }

  function perform_ajax_form_speciality_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_speciality_cancel_insert(sc_form_speciality_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_speciality_navigate_form(var_idspeciality_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_speciality_navigate_form_cb);
  } // do_ajax_form_speciality_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_speciality']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_speciality_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.idspeciality_.value = scAjaxGetKeyValue("idspeciality_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_speciality_navigate_form_cb_after_alert);
  } // do_ajax_form_speciality_navigate_form_cb
  function do_ajax_form_speciality_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_speciality_navigate_form_cb_after_alert

    function sc_form_speciality_get_last_line_number()
    {
    ...
    } //sc_form_speciality_get_last_line_number

  function sc_hide_form_speciality_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idspeciality_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "speciality_desc_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "speciality_desc_pt_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "speciality_desc_es_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idspeciality_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_speciality_fld_idspeciality'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["speciality_desc_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_speciality_fld_speciality_desc'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["speciality_desc_pt_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_speciality_fld_speciality_desc'] ?> pt<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["speciality_desc_es_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_speciality_fld_speciality_desc'] ?> es<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["idspeciality_"][iNumLinha] = "idspeciality_" + iNumLinha;
    ajax_field_mult["speciality_desc_"][iNumLinha] = "speciality_desc_" + iNumLinha;
    ajax_field_mult["speciality_desc_pt_"][iNumLinha] = "speciality_desc_pt_" + iNumLinha;
    ajax_field_mult["speciality_desc_es_"][iNumLinha] = "speciality_desc_es_" + iNumLinha;
    ajax_field_id["idspeciality_" + iNumLinha] = new Array("hidden_field_label_idspeciality_", "hidden_field_data_idspeciality_" + iNumLinha);
    ajax_field_id["speciality_desc_" + iNumLinha] = new Array("hidden_field_label_speciality_desc_", "hidden_field_data_speciality_desc_" + iNumLinha);
    ajax_field_id["speciality_desc_pt_" + iNumLinha] = new Array("hidden_field_label_speciality_desc_pt_", "hidden_field_data_speciality_desc_pt_" + iNumLinha);
    ajax_field_id["speciality_desc_es_" + iNumLinha] = new Array("hidden_field_label_speciality_desc_es_", "hidden_field_data_speciality_desc_es_" + iNumLinha);
    ajax_error_count["idspeciality_" + iNumLinha] = "off";
    ajax_error_count["speciality_desc_" + iNumLinha] = "off";
    ajax_error_count["speciality_desc_pt_" + iNumLinha] = "off";
    ajax_error_count["speciality_desc_es_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idspeciality_" + iNumLinha] = "on";
    ajax_read_only["speciality_desc_" + iNumLinha] = "off";
    ajax_read_only["speciality_desc_pt_" + iNumLinha] = "off";
    ajax_read_only["speciality_desc_es_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idspeciality_" + iNumLinha] = "on";
    ajax_read_only["speciality_desc_" + iNumLinha] = "on";
    ajax_read_only["speciality_desc_pt_" + iNumLinha] = "on";
    ajax_read_only["speciality_desc_es_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idspeciality_" + iNumLinha] = null;
    ajax_error_list["speciality_desc_" + iNumLinha] = null;
    ajax_error_list["speciality_desc_pt_" + iNumLinha] = null;
    ajax_error_list["speciality_desc_es_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idspeciality_": new Array(),
    "speciality_desc_": new Array(),
    "speciality_desc_pt_": new Array(),
    "speciality_desc_es_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idspeciality_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idspeciality_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idspeciality_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idspeciality_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idspeciality_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["speciality_desc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["speciality_desc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["speciality_desc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["speciality_desc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["speciality_desc_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["speciality_desc_pt_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["speciality_desc_pt_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["speciality_desc_pt_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["speciality_desc_pt_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["speciality_desc_pt_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["speciality_desc_es_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["speciality_desc_es_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["speciality_desc_es_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["speciality_desc_es_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["speciality_desc_es_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idspeciality_'])) ? $this->nmgp_cmp_readonly['idspeciality_'] : 'on';
?>
    scAjaxFieldRead("idspeciality_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['speciality_desc_'])) ? $this->nmgp_cmp_readonly['speciality_desc_'] : 'off';
?>
    scAjaxFieldRead("speciality_desc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['speciality_desc_pt_'])) ? $this->nmgp_cmp_readonly['speciality_desc_pt_'] : 'off';
?>
    scAjaxFieldRead("speciality_desc_pt_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['speciality_desc_es_'])) ? $this->nmgp_cmp_readonly['speciality_desc_es_'] : 'off';
?>
    scAjaxFieldRead("speciality_desc_es_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idspeciality_" + iSeq, "on");
    scAjaxFieldRead("speciality_desc_" + iSeq, "on");
    scAjaxFieldRead("speciality_desc_pt_" + iSeq, "on");
    scAjaxFieldRead("speciality_desc_es_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idspeciality_" + iRow] || "on" == ajax_error_count["speciality_desc_" + iRow] || "on" == ajax_error_count["speciality_desc_pt_" + iRow] || "on" == ajax_error_count["speciality_desc_es_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idspeciality_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_speciality_desc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_speciality_desc_pt_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_speciality_desc_es_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idspeciality_" + iRow] && "off" == ajax_error_count["speciality_desc_" + iRow] && "off" == ajax_error_count["speciality_desc_pt_" + iRow] && "off" == ajax_error_count["speciality_desc_es_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idspeciality_" + iRow] = "off";
        ajax_error_count["speciality_desc_" + iRow] = "off";
        ajax_error_count["speciality_desc_pt_" + iRow] = "off";
        ajax_error_count["speciality_desc_es_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idspeciality_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_speciality_desc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_speciality_desc_pt_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_speciality_desc_es_" + iRow).removeClass("scFormErrorLine");
    }
  }
