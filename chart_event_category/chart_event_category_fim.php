...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["ProntSaude_____chart_event_category"]))
   {
      unset($_SESSION['session_sec_aplicacao']["ProntSaude_____chart_event_category"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_event_category']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_event_category']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_event_category']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_event_category']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_event_category']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_event_category</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_event_category']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_event_category']['embutida_filho'] as $ind => $sc_init)
          {
