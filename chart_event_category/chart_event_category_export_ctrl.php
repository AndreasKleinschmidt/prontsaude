<?php
@session_start() ;
$_SESSION['scriptcase']['chart_event_category']['sc_process_barr'] = true;
require_once('../chart_event_category/index.php');
unset($_SESSION['scriptcase']['chart_event_category']['sc_process_barr']);
$ExportCtrl = new chart_event_category_export_control;
$ExportCtrl->Export_barr();

class chart_event_category_export_control
{
