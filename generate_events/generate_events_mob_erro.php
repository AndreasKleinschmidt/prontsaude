...
$old_error_handler = set_error_handler("generate_events_mob_scriptcase_error_handler");

function generate_events_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['generate_events_mob']['contr_erro']) && $_SESSION['scriptcase']['generate_events_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_generate_events_mob->contr_generate_events_mob->Apl_com_erro = true;
            if ($inicial_generate_events_mob->contr_generate_events_mob->NM_ajax_flag)
            {
                $inicial_generate_events_mob->contr_generate_events_mob->NM_ajax_info['errList']['geral_generate_events_mob'][] = $msg;
                return;
            }
            generate_events_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function generate_events_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['generate_events_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['generate_events_mob'])  ? $_SESSION['scriptcase']['error_icon']['generate_events_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['generate_events_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['generate_events_mob']) ? $_SESSION['scriptcase']['error_span_title']['generate_events_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['generate_events_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['generate_events_mob']) ? $_SESSION['scriptcase']['error_icon_title']['generate_events_mob'] : '';
?>
