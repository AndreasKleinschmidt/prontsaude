...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="generate_events"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events']['where_detal']))
  {
?>  
...
function scForm_packMultiSelect_multi() {
        ...
        for (var Nm_x = 1; Nm_x < NM_count_mult; Nm_x++) {
                nm_pack('doctors' + Nm_x + '_dest', 'doctors' + Nm_x);
        }
...
function nm_saida_glo()
{
  ...
  document.F4.action = "generate_events_fim.php";
  document.F4.submit();
}
