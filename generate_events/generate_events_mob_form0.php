...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>generate_events/generate_events_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("generate_events_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('generate_events_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['generate_events']['error_buffer']) && '' != $_SESSION['scriptcase']['generate_events']['error_buffer'])
{
    echo $_SESSION['scriptcase']['generate_events']['error_buffer'];
}
...
<?php
 include_once("generate_events_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="generate_events_mob.php" 
               target="_self">
...
<?php
$_SESSION['scriptcase']['error_span_title']['generate_events_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['generate_events_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_doctors_line" id="hidden_field_data_doctors" style="<?php echo $sStyleHidden_doctors; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_doctors_label" style=""><span id="id_label_doctors"><?php echo $this->nm_new_label['doctors']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['php_cmp_required']['doctors']) || $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['php_cmp_required']['doctors'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></span><br>
...
<?php
   ...
   echo " <span id=\"idAjaxSelect_doctors\" class=\"" . $this->classes_100perc_fields['span_select'] . "\"><select class=\"sc-js-input scFormObjectOdd css_doctors_obj" . $this->classes_100perc_fields['input'] . "\" style=\"\" id=\"id_sc_field_doctors\" name=\"doctors\" size=\"7\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          ...
          if (trim($this->doctors) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_startdt_line" id="hidden_field_data_startdt" style="<?php echo $sStyleHidden_startdt; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_startdt_label" style=""><span id="id_label_startdt"><?php echo $this->nm_new_label['startdt']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['php_cmp_required']['startdt']) || $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['php_cmp_required']['startdt'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></span><br>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_label']['ok'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("generate_events_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("generate_events_mob");
 parent.scAjaxDetailHeight("generate_events_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
