  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_generate_events_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_generate_events_mob_form();
        }
...
?>
  ...
  // ---------- Validate doctors
  function do_ajax_generate_events_mob_validate_doctors()
  {
    var nomeCampo_doctors = "doctors";
    var var_doctors = scAjaxGetFieldSelect(nomeCampo_doctors);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_generate_events_mob_validate_doctors(var_doctors, var_script_case_init, do_ajax_generate_events_mob_validate_doctors_cb);
  } // do_ajax_generate_events_mob_validate_doctors

  function do_ajax_generate_events_mob_validate_doctors_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_generate_events_mob_validate_doctors_cb

  // ---------- Validate startdt
  function do_ajax_generate_events_mob_validate_startdt()
  {
    var nomeCampo_startdt = "startdt";
    var var_startdt = scAjaxGetFieldText(nomeCampo_startdt);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_startdt = scAjaxGetFieldText(nomeCampo_startdt);
      x_ajax_generate_events_mob_validate_startdt(var_startdt, var_script_case_init, do_ajax_generate_events_mob_validate_startdt_cb);
    }, 200);
  } // do_ajax_generate_events_mob_validate_startdt

  function do_ajax_generate_events_mob_validate_startdt_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "startdt";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_generate_events_mob_validate_startdt_cb

  // ---------- Validate enddt
  function do_ajax_generate_events_mob_validate_enddt()
  {
    var nomeCampo_enddt = "enddt";
    var var_enddt = scAjaxGetFieldText(nomeCampo_enddt);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_enddt = scAjaxGetFieldText(nomeCampo_enddt);
      x_ajax_generate_events_mob_validate_enddt(var_enddt, var_script_case_init, do_ajax_generate_events_mob_validate_enddt_cb);
    }, 200);
  } // do_ajax_generate_events_mob_validate_enddt

  function do_ajax_generate_events_mob_validate_enddt_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "enddt";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_generate_events_mob_validate_enddt_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_generate_events_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_generate_events_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_doctors = scAjaxGetFieldSelect("doctors");
    var var_startdt = scAjaxGetFieldText("startdt");
    var var_enddt = scAjaxGetFieldText("enddt");
    ...
    scAjaxProcOn();
    x_ajax_generate_events_mob_submit_form(var_doctors, var_startdt, var_enddt, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_generate_events_mob_submit_form_cb);
  } // do_ajax_generate_events_mob_submit_form

  function do_ajax_generate_events_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_generate_events_mob_submit_form_cb_after_alert);
  } // do_ajax_generate_events_mob_submit_form_cb
  function do_ajax_generate_events_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_generate_events_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_generate_events_mob_navigate_form()
  {
    perform_ajax_generate_events_mob_navigate_form();
  }

  function perform_ajax_generate_events_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_generate_events_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_generate_events_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_generate_events_mob_navigate_form_cb_after_alert);
  } // do_ajax_generate_events_mob_navigate_form_cb
  function do_ajax_generate_events_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_generate_events_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_generate_events_mob_navigate_form_cb_after_alert

  function sc_hide_generate_events_mob_form()
  {
  ...
  ajax_field_list[0] = "doctors";
  ajax_field_list[1] = "startdt";
  ajax_field_list[2] = "enddt";
  ...
  var ajax_error_list = {
    "doctors": {"label": "<?php echo $this->Ini->Nm_lang['lang_tbl_doctors'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "startdt": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_start_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "enddt": {"label": "<?php echo $this->Ini->Nm_lang['lang_event_fld_end_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["doctors"][1] = "doctors";
  ajax_field_mult["startdt"][1] = "startdt";
  ajax_field_mult["enddt"][1] = "enddt";

  var ajax_field_id = {
    "doctors": new Array("hidden_field_label_doctors", "hidden_field_data_doctors"),
    "startdt": new Array("hidden_field_label_startdt", "hidden_field_data_startdt"),
    "enddt": new Array("hidden_field_label_enddt", "hidden_field_data_enddt")
  };
