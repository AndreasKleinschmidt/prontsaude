  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_generate_events" == sTestField)
        {
...
?>
  ...
  // ---------- Validate doctors
  function do_ajax_generate_events_validate_doctors()
  {
    var nomeCampo_doctors = "doctors";
    nm_pack(nomeCampo_doctors + '_dest', nomeCampo_doctors);
    var var_doctors = scAjaxGetFieldText(nomeCampo_doctors);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_generate_events_validate_doctors(var_doctors, var_script_case_init, do_ajax_generate_events_validate_doctors_cb);
  } // do_ajax_generate_events_validate_doctors

  function do_ajax_generate_events_validate_doctors_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_generate_events_validate_doctors_cb

  // ---------- Validate startdt
  function do_ajax_generate_events_validate_startdt()
  {
    ...
    setTimeout(function() {
      var var_startdt = scAjaxGetFieldText(nomeCampo_startdt);
      x_ajax_generate_events_validate_startdt(var_startdt, var_script_case_init, do_ajax_generate_events_validate_startdt_cb);
    }, 200);
  } // do_ajax_generate_events_validate_startdt

  function do_ajax_generate_events_validate_startdt_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "startdt";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_generate_events_validate_startdt_cb

  // ---------- Validate enddt
  function do_ajax_generate_events_validate_enddt()
  {
    ...
    setTimeout(function() {
      var var_enddt = scAjaxGetFieldText(nomeCampo_enddt);
      x_ajax_generate_events_validate_enddt(var_enddt, var_script_case_init, do_ajax_generate_events_validate_enddt_cb);
    }, 200);
  } // do_ajax_generate_events_validate_enddt

  function do_ajax_generate_events_validate_enddt_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "enddt";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_generate_events_validate_enddt_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_generate_events_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_generate_events_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    nm_pack("doctors_dest", "doctors");
    var var_doctors = scAjaxGetFieldText("doctors");
    ...
    scAjaxProcOn();
    x_ajax_generate_events_submit_form(var_doctors, var_startdt, var_enddt, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_generate_events_submit_form_cb);
  } // do_ajax_generate_events_submit_form

  function do_ajax_generate_events_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_generate_events_submit_form_cb_after_alert);
  } // do_ajax_generate_events_submit_form_cb
  function do_ajax_generate_events_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_generate_events_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_generate_events_navigate_form()
  {
    perform_ajax_generate_events_navigate_form();
  }

  function perform_ajax_generate_events_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_generate_events_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['generate_events']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_generate_events_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_generate_events_navigate_form_cb_after_alert);
  } // do_ajax_generate_events_navigate_form_cb
  function do_ajax_generate_events_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_generate_events_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_generate_events_navigate_form_cb_after_alert

  function sc_hide_generate_events_form()
  {
