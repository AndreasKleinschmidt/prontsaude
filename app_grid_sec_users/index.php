...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_conexao'], $this->root . $this->path_prod, 'ProntSaude', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle($linhas = 0)
   {
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_grid_sec_users']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_grid_sec_users']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_sec_users'] . "lang_btns_grid_hint";
      ...
      { 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['field_order'][] = "usrname";
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_sec_users'] ?>lang_btns_grid_hint :: Doc</TITLE>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_ProntSaude'])) {
               $_SESSION['scriptcase']['app_grid_sec_users']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_ProntSaude'];
           }
       }
   }
