...
class grid_medical_history_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_medical_history.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['grid_medical_history']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medical_history']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medical_history']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medical_history']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medical_history']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medical_history']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medical_history']['rtf_name']);
      }
   ...
   {
         $this->look_tonursery = html_entity_decode($this->look_tonursery, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_tonursery = strip_tags($this->look_tonursery);
         $this->look_tonursery = NM_charset_to_utf8($this->look_tonursery);
         $this->look_tonursery = str_replace('<', '&lt;', $this->look_tonursery);
         $this->look_tonursery = str_replace('>', '&gt;', $this->look_tonursery);
         $this->Texto_tag .= "<td>" . $this->look_tonursery . "</td>\r\n";
   }
   //----- nursery_datetime
   ...
   function NM_export_patients_idpatient()
   {
         ...
         $this->patients_idpatient = NM_charset_to_utf8($this->patients_idpatient);
         $this->patients_idpatient = str_replace('<', '&lt;', $this->patients_idpatient);
         $this->patients_idpatient = str_replace('>', '&gt;', $this->patients_idpatient);
         $this->Texto_tag .= "<td>" . $this->patients_idpatient . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medical_history']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medical_history']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - medical_history :: RTF</TITLE>
