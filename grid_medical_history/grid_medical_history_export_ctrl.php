<?php
@session_start() ;
$_SESSION['scriptcase']['grid_medical_history']['sc_process_barr'] = true;
require_once('../grid_medical_history/index.php');
unset($_SESSION['scriptcase']['grid_medical_history']['sc_process_barr']);
$ExportCtrl = new grid_medical_history_export_control;
$ExportCtrl->Export_barr();

class grid_medical_history_export_control
{
