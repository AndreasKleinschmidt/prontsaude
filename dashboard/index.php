...
$_SESSION['scriptcase']['dashboard']['glo_nm_perfil']          = "conn_example";
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_ProntSaude'])) {
            $_SESSION['scriptcase']['dashboard']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_ProntSaude'];
        }
    }
}
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'ProntSaude', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dashboard']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'ProntSaude', 1, $this->force_db_utf8);
    }
    else {
...
class dashboard_control {
    ...
    function init()
    {
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_event_date'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_event_category'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_event_doctors'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_medical_history'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
...
<div class='grid-stack'>
                <div  class="grid-stack-item" data-gs-x="2" data-gs-y="0" data-gs-width="10" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-0">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-0">
                        <div class="widget-head" style="display:">
                            <h3 class="scContainerTitle"><?php echo $this->Ini->Nm_lang['lang_chart_event_period'] ?></h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-0"><iframe id="id-iframe-0" name="dbifrm_widget1" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_event_date'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget1"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget1&compact_mode=1&remove_margin=0&remove_border=0"></iframe></div>
                    </div>
                </div>
                ...
                <div  class="grid-stack-item" data-gs-x="2" data-gs-y="4" data-gs-width="6" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-5">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-5">
                        <div class="widget-head" style="display:">
                            <h3 class="scContainerTitle"><?php echo $this->Ini->Nm_lang['lang_chart_event_categories'] ?></h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-5"><iframe id="id-iframe-5" name="dbifrm_widget6" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_event_category'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget6"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget6&compact_mode=1&remove_margin=0&remove_border=0"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="8" data-gs-width="8" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-6">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-6">
                        <div class="widget-head" style="display:">
                            <h3 class="scContainerTitle"><?php echo $this->Ini->Nm_lang['lang_chart_event_doctors'] ?></h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-6"><iframe id="id-iframe-6" name="dbifrm_widget7" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_event_doctors'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget7"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget7&compact_mode=1&remove_margin=0&remove_border=0"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="8" data-gs-y="4" data-gs-width="4" data-gs-height="8"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-7">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-7">
                        <div class="widget-head" style="display:">
                            <h3 class="scContainerTitle"><?php echo $this->Ini->Nm_lang['lang_chart_top_diagnosis'] ?></h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-7"><iframe id="id-iframe-7" name="dbifrm_widget8" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_medical_history'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget8"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget8&compact_mode=1&remove_margin=0&remove_border=0"></iframe></div>
                    </div>
                </div></div>
...
<?php
    ...
    function getIndexContentData_widget2() {
        ...
        {
            $sSql = "SELECT COUNT(idpatient) FROM patients";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget2">{$this->Ini->Nm_lang['lang_dash_total_patients']}</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget3() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT COUNT(idevent), YEAR(start_date) & '-' & FORMAT(MONTH(start_date), '00') FROM event GROUP BY YEAR(start_date) & '-' & FORMAT(MONTH(start_date), '00') ORDER BY YEAR(start_date) & '-' & FORMAT(MONTH(start_date), '00') DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT COUNT(\"idevent\"), CAST(YEAR(\"start_date\") AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(\"start_date\") AS VARCHAR(2)), 2) FROM event GROUP BY CAST(YEAR(\"start_date\") AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(\"start_date\") AS VARCHAR(2)), 2) ORDER BY CAST(YEAR(\"start_date\") AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(\"start_date\") AS VARCHAR(2)), 2) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
        {
            $sSql = "SELECT COUNT(\"idevent\"), CONCAT(CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-'), LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0')) FROM event GROUP BY CONCAT(CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-'), LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0')) ORDER BY CONCAT(CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-'), LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT COUNT(\"idevent\"), CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-', TO_CHAR(EXTRACT(MONTH FROM \"start_date\"), 'FM00')) FROM event GROUP BY 2 ORDER BY CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-', TO_CHAR(EXTRACT(MONTH FROM \"start_date\"), 'FM00')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT COUNT(`idevent`), CONCAT(YEAR(`start_date`), '-', LPAD(MONTH(`start_date`), 2, '0')) FROM event GROUP BY 2 ORDER BY CONCAT(YEAR(`start_date`), '-', LPAD(MONTH(`start_date`), 2, '0')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT COUNT(`idevent`), strftime('%Y', `start_date`) || '-' || strftime('%m', `start_date`) FROM event GROUP BY 2 ORDER BY strftime('%Y', `start_date`) || '-' || strftime('%m', `start_date`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
        {
            $sSql = "SELECT COUNT(\"idevent\"), EXTRACT(YEAR FROM \"start_date\") || '-' || LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0') FROM event GROUP BY 2 ORDER BY EXTRACT(YEAR FROM \"start_date\") || '-' || LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0') DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_db2))
        {
            $sSql = "SELECT COUNT(idevent), CONCAT(CONCAT(YEAR(start_date), '-'), LPAD(MONTH(start_date), 2, '0')) FROM event GROUP BY CONCAT(CONCAT(YEAR(start_date), '-'), LPAD(MONTH(start_date), 2, '0')) ORDER BY CONCAT(CONCAT(YEAR(start_date), '-'), LPAD(MONTH(start_date), 2, '0')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
        {
            $sSql = "SELECT COUNT(idevent), CAST(YEAR(start_date) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(start_date) AS VARCHAR(2)), 2) FROM event GROUP BY CAST(YEAR(start_date) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(start_date) AS VARCHAR(2)), 2) ORDER BY CAST(YEAR(start_date) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(start_date) AS VARCHAR(2)), 2) DESC";
        ...
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
        {
            $sSql = "SELECT COUNT(idevent), YEAR(start_date) || '-' || LPAD(MONTH(start_date), 2, '0') FROM event GROUP BY 2 ORDER BY YEAR(start_date) || '-' || LPAD(MONTH(start_date), 2, '0') DESC";
        }
        else 
        {
            $sSql = "SELECT COUNT(idevent), YYYYMM(start_date) FROM event GROUP BY 2 ORDER BY YYYYMM(start_date) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget3">{$this->Ini->Nm_lang['lang_dash_total_events']}</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget4() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT COUNT(tmp.sc_metric_field), tmp.sc_period_field FROM (SELECT idevent AS sc_metric_field, YEAR(start_date) & '-' & FORMAT(MONTH(start_date), '00') AS sc_period_field FROM event WHERE (idevent_status = 8) GROUP BY sc_metric_field, sc_period_field) as tmp GROUP BY tmp.sc_period_field ORDER BY tmp.sc_period_field DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT COUNT(DISTINCT \"idevent\"), CAST(YEAR(\"start_date\") AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(\"start_date\") AS VARCHAR(2)), 2) FROM event WHERE (\"idevent_status\" = 8) GROUP BY CAST(YEAR(\"start_date\") AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(\"start_date\") AS VARCHAR(2)), 2) ORDER BY CAST(YEAR(\"start_date\") AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(\"start_date\") AS VARCHAR(2)), 2) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
        {
            $sSql = "SELECT COUNT(DISTINCT \"idevent\"), CONCAT(CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-'), LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0')) FROM event WHERE (\"idevent_status\" = 8) GROUP BY CONCAT(CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-'), LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0')) ORDER BY CONCAT(CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-'), LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT COUNT(DISTINCT \"idevent\"), CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-', TO_CHAR(EXTRACT(MONTH FROM \"start_date\"), 'FM00')) FROM event WHERE (\"idevent_status\" = 8) GROUP BY 2 ORDER BY CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-', TO_CHAR(EXTRACT(MONTH FROM \"start_date\"), 'FM00')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT COUNT(DISTINCT `idevent`), CONCAT(YEAR(`start_date`), '-', LPAD(MONTH(`start_date`), 2, '0')) FROM event WHERE (`idevent_status` = 8) GROUP BY 2 ORDER BY CONCAT(YEAR(`start_date`), '-', LPAD(MONTH(`start_date`), 2, '0')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT COUNT(DISTINCT `idevent`), strftime('%Y', `start_date`) || '-' || strftime('%m', `start_date`) FROM event WHERE (`idevent_status` = 8) GROUP BY 2 ORDER BY strftime('%Y', `start_date`) || '-' || strftime('%m', `start_date`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
        {
            $sSql = "SELECT COUNT(DISTINCT \"idevent\"), EXTRACT(YEAR FROM \"start_date\") || '-' || LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0') FROM event WHERE (\"idevent_status\" = 8) GROUP BY 2 ORDER BY EXTRACT(YEAR FROM \"start_date\") || '-' || LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0') DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_db2))
        {
            $sSql = "SELECT COUNT(DISTINCT idevent), CONCAT(CONCAT(YEAR(start_date), '-'), LPAD(MONTH(start_date), 2, '0')) FROM event WHERE (idevent_status = 8) GROUP BY CONCAT(CONCAT(YEAR(start_date), '-'), LPAD(MONTH(start_date), 2, '0')) ORDER BY CONCAT(CONCAT(YEAR(start_date), '-'), LPAD(MONTH(start_date), 2, '0')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
        {
            $sSql = "SELECT COUNT(DISTINCT idevent), CAST(YEAR(start_date) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(start_date) AS VARCHAR(2)), 2) FROM event WHERE (idevent_status = 8) GROUP BY CAST(YEAR(start_date) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(start_date) AS VARCHAR(2)), 2) ORDER BY CAST(YEAR(start_date) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(start_date) AS VARCHAR(2)), 2) DESC";
        ...
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
        {
            $sSql = "SELECT COUNT(DISTINCT idevent), YEAR(start_date) || '-' || LPAD(MONTH(start_date), 2, '0') FROM event WHERE (idevent_status = 8) GROUP BY 2 ORDER BY YEAR(start_date) || '-' || LPAD(MONTH(start_date), 2, '0') DESC";
        }
        else 
        {
            $sSql = "SELECT DISTINCT(idevent), YYYYMM(start_date) FROM event WHERE (idevent_status = 8) GROUP BY 2 ORDER BY YYYYMM(start_date) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget4">{$this->Ini->Nm_lang['lang_dash_events_done']}</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget5() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT COUNT(idevent), YEAR(start_date) & '-' & FORMAT(MONTH(start_date), '00') FROM event WHERE (idevent_priority > 1) GROUP BY YEAR(start_date) & '-' & FORMAT(MONTH(start_date), '00') ORDER BY YEAR(start_date) & '-' & FORMAT(MONTH(start_date), '00') DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT COUNT(\"idevent\"), CAST(YEAR(\"start_date\") AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(\"start_date\") AS VARCHAR(2)), 2) FROM event WHERE (\"idevent_priority\" > 1) GROUP BY CAST(YEAR(\"start_date\") AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(\"start_date\") AS VARCHAR(2)), 2) ORDER BY CAST(YEAR(\"start_date\") AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(\"start_date\") AS VARCHAR(2)), 2) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
        {
            $sSql = "SELECT COUNT(\"idevent\"), CONCAT(CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-'), LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0')) FROM event WHERE (\"idevent_priority\" > 1) GROUP BY CONCAT(CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-'), LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0')) ORDER BY CONCAT(CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-'), LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT COUNT(\"idevent\"), CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-', TO_CHAR(EXTRACT(MONTH FROM \"start_date\"), 'FM00')) FROM event WHERE (\"idevent_priority\" > 1) GROUP BY 2 ORDER BY CONCAT(EXTRACT(YEAR FROM \"start_date\"), '-', TO_CHAR(EXTRACT(MONTH FROM \"start_date\"), 'FM00')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT COUNT(`idevent`), CONCAT(YEAR(`start_date`), '-', LPAD(MONTH(`start_date`), 2, '0')) FROM event WHERE (`idevent_priority` > 1) GROUP BY 2 ORDER BY CONCAT(YEAR(`start_date`), '-', LPAD(MONTH(`start_date`), 2, '0')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT COUNT(`idevent`), strftime('%Y', `start_date`) || '-' || strftime('%m', `start_date`) FROM event WHERE (`idevent_priority` > 1) GROUP BY 2 ORDER BY strftime('%Y', `start_date`) || '-' || strftime('%m', `start_date`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
        {
            $sSql = "SELECT COUNT(\"idevent\"), EXTRACT(YEAR FROM \"start_date\") || '-' || LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0') FROM event WHERE (\"idevent_priority\" > 1) GROUP BY 2 ORDER BY EXTRACT(YEAR FROM \"start_date\") || '-' || LPAD(EXTRACT(MONTH FROM \"start_date\"), 2, '0') DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_db2))
        {
            $sSql = "SELECT COUNT(idevent), CONCAT(CONCAT(YEAR(start_date), '-'), LPAD(MONTH(start_date), 2, '0')) FROM event WHERE (idevent_priority > 1) GROUP BY CONCAT(CONCAT(YEAR(start_date), '-'), LPAD(MONTH(start_date), 2, '0')) ORDER BY CONCAT(CONCAT(YEAR(start_date), '-'), LPAD(MONTH(start_date), 2, '0')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
        {
            $sSql = "SELECT COUNT(idevent), CAST(YEAR(start_date) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(start_date) AS VARCHAR(2)), 2) FROM event WHERE (idevent_priority > 1) GROUP BY CAST(YEAR(start_date) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(start_date) AS VARCHAR(2)), 2) ORDER BY CAST(YEAR(start_date) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(start_date) AS VARCHAR(2)), 2) DESC";
        ...
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
        {
            $sSql = "SELECT COUNT(idevent), YEAR(start_date) || '-' || LPAD(MONTH(start_date), 2, '0') FROM event WHERE (idevent_priority > 1) GROUP BY 2 ORDER BY YEAR(start_date) || '-' || LPAD(MONTH(start_date), 2, '0') DESC";
        }
        else 
        {
            $sSql = "SELECT COUNT(idevent), YYYYMM(start_date) FROM event WHERE (idevent_priority > 1) GROUP BY 2 ORDER BY YYYYMM(start_date) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget5">{$this->Ini->Nm_lang['lang_dash_events_critical']}</span></div>
