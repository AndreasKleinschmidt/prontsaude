...
{
    db_conect_devel($_SESSION['scriptcase']['menu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu']['glo_nm_path_prod'], 'ProntSaude', 2); 
}
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
...
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['menu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu']['glo_nm_path_prod'], 'ProntSaude'); 
} 
else 
{ 
...
if(is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/blank_start_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] . '_lib/_app_data/blank_start_ini.php');
    ...
    {
      if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_start']))
      {
...
if (!isset($this->sc_temp_usr_login)) {$this->sc_temp_usr_login = (isset($_SESSION['usr_login'])) ? $_SESSION['usr_login'] : "";}
 unset($_SESSION['scriptcase']['sc_def_menu']["menu"]);
...
{
    $_SESSION['scriptcase']['sc_def_menu']["menu"] = array();
}
?>
...
$sufix = "";
$my_language = $this->sc_get_language();
...
$groupDoctor = ($this->sc_temp_usr_group_id == 2) ? "WHERE m.namedoctor = '" . $this->sc_temp_usr_name . "'" : "";
...
ORDER BY 2,5";
      ...
      { 
          ...
          { 
                 ...
                 { 
                        $this->m1[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->m2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->m2 = false;
          $this->m2_erro = $this->Db->ErrorMsg();
      } 


$dsmenu = array_merge($this->m1 , $this->m2 );
...
if (isset($_SESSION['scriptcase']['sc_def_menu']["menu"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]                   = array();
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['pai']            = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['label']          = "Dashboard";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['link']           = "dashboard";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['parm']           = "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['icon']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['hint']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['target']         = "_self";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['name']           = "dashboard";
    $Temp_url = "dashboard";
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['lnk_url'] = true;
    }
    else
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['lnk_url'] = false;
        if (!empty($Temp_url))
        {
            $Temp_url = SC_dir_app_name($Temp_url) . "/";
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['target']) == '_blank')
            {
                $Temp_url .= "?nmgp_outra_jan=true&nm_apl_menu=" . "menu";
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['target']) == '_self')
            {
                $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['sc_init'] = $this->Gera_sc_init('dashboard');
                $Temp_url .= "?nm_run_menu=1&nm_apl_menu=" . "menu" . "&script_case_init=" . $this->Gera_sc_init('dashboard');
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['target']) == '_parent')
            {
                $Temp_url .= "?nm_run_menu=1&script_case_init=" . $_SESSION['sc_session'][1]["menu"]['init'];
            }
        }
    }
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_0"]['url'] = $Temp_url;
}
foreach ($dsmenu as $arr_menu) {
	...
	$sql2 = "SELECT priv_access FROM sec_groups_apps WHERE group_id = ".$this->sc_temp_usr_group_id." AND app_name = '".$arr_menu[3]."'";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->dsgrant[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->dsgrant = false;
          $this->dsgrant_erro = $this->Db->ErrorMsg();
      } 

	
	if ( empty($arr_menu[3]) || ($this->dsgrant[0][0] == 'Y') ){
		
		if ($arr_menu[3] == 'calendar_event') {	
			if (isset($_SESSION['scriptcase']['sc_def_menu']["menu"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]                   = array();
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['pai']            = $id_parent;
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['label']          = $arr_menu[2];
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['link']           = $arr_menu[3];
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['parm']           = "var_doctor*scin" . $param . "*scout" . "usr_login*scin" . $this->sc_temp_usr_login . "*scout" . "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['icon']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['hint']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['target']         = "_blank";
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['name']           = $arr_menu[3];
    $Temp_url = $arr_menu[3];
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['lnk_url'] = true;
    }
    else
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['lnk_url'] = false;
        if (!empty($Temp_url))
        {
            $Temp_url = SC_dir_app_name($Temp_url) . "/";
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['target']) == '_blank')
            {
                $Temp_url .= "?nmgp_outra_jan=true&nm_apl_menu=" . "menu";
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['target']) == '_self')
            {
                $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['sc_init'] = $this->Gera_sc_init($arr_menu[3]);
                $Temp_url .= "?nm_run_menu=1&nm_apl_menu=" . "menu" . "&script_case_init=" . $this->Gera_sc_init($arr_menu[3]);
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['target']) == '_parent')
            {
                $Temp_url .= "?nm_run_menu=1&script_case_init=" . $_SESSION['sc_session'][1]["menu"]['init'];
            }
        }
    }
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['url'] = $Temp_url;
}
			...
			if (isset($_SESSION['scriptcase']['sc_def_menu']["menu"]))
{
    ...
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['label']          = $arr_menu[2];
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['link']           = $arr_menu[3];
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['parm']           = "var_doctor*scin" . $this->sc_temp_var_doctor . "*scout" . "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['icon']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['hint']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['target']         = "_self";
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['name']           = $arr_menu[3];
    $Temp_url = $arr_menu[3];
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
			...
			if (isset($_SESSION['scriptcase']['sc_def_menu']["menu"]))
{
    ...
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['label']          = $arr_menu[2];
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['link']           = $arr_menu[3];
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['parm']           = "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['icon']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['hint']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['target']         = "_self";
    $_SESSION['scriptcase']['sc_def_menu']["menu"][$id_item]['name']           = $arr_menu[3];
...
if  ($this->sc_temp_usr_group_id != 1) {
	sc_appmenu_remove_item("menu", "item_1");
}	

if (isset($_SESSION['scriptcase']['sc_def_menu']["menu"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]                   = array();
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['pai']            = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['label']          = "" . $this->Nm_lang['lang_btns_exit'] . "";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['link']           = "login";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['parm']           = "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['icon']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['hint']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['target']         = "_parent";
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['name']           = "login";
    $Temp_url = "login";
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['lnk_url'] = true;
    }
    else
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['lnk_url'] = false;
        if (!empty($Temp_url))
        {
            $Temp_url = SC_dir_app_name($Temp_url) . "/";
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['target']) == '_blank')
            {
                $Temp_url .= "?nmgp_outra_jan=true&nm_apl_menu=" . "menu";
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['target']) == '_self')
            {
                $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['sc_init'] = $this->Gera_sc_init('login');
                $Temp_url .= "?nm_run_menu=1&nm_apl_menu=" . "menu" . "&script_case_init=" . $this->Gera_sc_init('login');
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['target']) == '_parent')
            {
                $Temp_url .= "?nm_run_menu=1&script_case_init=" . $_SESSION['sc_session'][1]["menu"]['init'];
            }
        }
    }
    $_SESSION['scriptcase']['sc_def_menu']["menu"]["item_99"]['url'] = $Temp_url;
}
...
<head>
 <title><?php echo $this->Nm_lang['lang_healthcare'] ?></title>
...
?> 
        ...
        <script  type="text/javascript">
                        ...
                        $(document).ready(function () {
                                ...
                                $('#css3menut').jstree({
                                        'state' : { 'key' : 'menu', 'filter' : function (k) { delete k.core.selected; return k; } },
...
while ($flag == 1)
{
    ...
    foreach ($menu_menuData['data'] as $chave => $cada_menu)
    {
        if (!empty($cada_menu))
        {
            if ($menu_menuData['data'][$chave]['disabled'] == 'Y')
            {
                    unset($menu_menuData['data'][$chave]['disabled']);
                    foreach ($menu_menuData['data'] as $_key => $_val)
                    {
                            if($_key > $chave)
                            {
                                    if($menu_menuData['data'][$_key]['level'] > $menu_menuData['data'][$chave]['level'])
                                    {
                                            unset($menu_menuData['data'][$_key]);
                                    }
                                    else
                                    {
                                            break;
...
<div class="scMenuTHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scMenuTHeaderFont" style="float: left; text-transform: uppercase;"></div>
    <div class="scMenuTHeaderFont" style="float: right;"><?php echo "<span style='font-size:12pt;font-weight:bold;'>" . $this->Nm_lang['lang_healthcare'] . "</span><br/><b>" . $this->Nm_lang['lang_log_user'] . ":</b> " . $_SESSION['usr_name'] . " ( " . $_SESSION['usr_group_desc'] . " )" ?></div>
</div></div>
<?php
    $link_default = "";
    ...
    $link_default = " onclick=\"openMenuItem('iframe_menu');\" item-href=\"menu_form_php.php?sc_item_menu=menu&sc_apl_menu=blank_start&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_iframe\"";
    } 
    else
    { 
...
<div class="ui-layout-center">
  <table cellspacing=0 cellpadding=0 style="height: 100%; width: 100%" cellpadding=0 cellspacing=0>
    ...
    $(document).ready(function () {
        ...
        <iframe name="menu_iframe" id="iframe_menu" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;" src="<?php echo $_SESSION['scriptcase']['menu']['apl_inicial']?>"<?php echo $link_default ?>></iframe>
<?php
?>
        </td>
      </tr>
            ...
            <?php
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    ?>
                    <li <?php echo $iconHtml; ?> class="scMenuTItems scMenuTItem" style="<?php echo $li_style; ?>"><a href="javascript:" onclick="openMenuItem('menu_<?php echo $aMenuItemList[$i]['id']; ?>'); <?php echo $focusFrame; ?>" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>"<?php echo $aMenuItemList[$i]['target']; ?> class="scMenuTItem"><?php echo $aMenuItemList[$i]['label']; ?></a>
                    <?php
                  }
                }
                if ($aMenuItemList[$i + 1] && $aMenuItemList[$i]['level'] == $aMenuItemList[$i + 1]['level']) {
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProntSaude.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu") {
        ...
        if (isset($_COOKIE['sc_actual_lang_ProntSaude'])) {
            $_SESSION['scriptcase']['menu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_ProntSaude'];
        }
    }
}
