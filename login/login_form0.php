...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['login']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['login']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
else
{
    ...
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['login']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['login']['link_info']['remove_background']) {
