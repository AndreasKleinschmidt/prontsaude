...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_login' + iSeqRow).bind('blur', function() { sc_login_login_onblur('#id_sc_field_login' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_login_login_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_login_login_onfocus(this, iSeqRow) });
  $('#id_sc_field_pswd' + iSeqRow).bind('blur', function() { sc_login_pswd_onblur('#id_sc_field_pswd' + iSeqRow, iSeqRow) })
