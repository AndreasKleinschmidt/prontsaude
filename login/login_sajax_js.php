...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_login_submit_form()
  {
    ...
    x_ajax_login_submit_form(var_login, var_pswd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, var_bok, do_ajax_login_submit_form_cb);
...
?>
  ...
  var ajax_error_list = {
    "login": {"label": "Login", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pswd": {"label": "Pswd", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
