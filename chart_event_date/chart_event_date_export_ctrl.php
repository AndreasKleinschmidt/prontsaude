<?php
@session_start() ;
$_SESSION['scriptcase']['chart_event_date']['sc_process_barr'] = true;
require_once('../chart_event_date/index.php');
unset($_SESSION['scriptcase']['chart_event_date']['sc_process_barr']);
$ExportCtrl = new chart_event_date_export_control;
$ExportCtrl->Export_barr();

class chart_event_date_export_control
{
