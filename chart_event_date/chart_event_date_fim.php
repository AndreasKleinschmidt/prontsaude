...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["ProntSaude_____chart_event_date"]))
   {
      unset($_SESSION['session_sec_aplicacao']["ProntSaude_____chart_event_date"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_event_date']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_event_date']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_event_date']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_event_date']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_event_date']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_event_date']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_event_date']['embutida_filho'] as $ind => $sc_init)
          {
