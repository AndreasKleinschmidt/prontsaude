...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["ProntSaude_____grid_doctors"]))
   {
      unset($_SESSION['session_sec_aplicacao']["ProntSaude_____grid_doctors"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_doctors'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_doctors']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_doctors']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_doctors']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_doctors']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_doctors']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_doctors']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_doctors']['embutida_filho'] as $ind => $sc_init)
          {
