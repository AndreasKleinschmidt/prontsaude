...
$_SESSION['scriptcase']['grid_doctors']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['rtf_name']);
      }
   ...
   function NM_export_iddoctor()
   {
         ...
         $this->iddoctor = str_replace('<', '&lt;', $this->iddoctor);
         $this->iddoctor = str_replace('>', '&gt;', $this->iddoctor);
         $this->Texto_tag .= "<td>" . $this->iddoctor . "</td>\r\n";
   }
   //----- namedoctor
   function NM_export_namedoctor()
   {
         ...
         $this->namedoctor = str_replace('<', '&lt;', $this->namedoctor);
         $this->namedoctor = str_replace('>', '&gt;', $this->namedoctor);
         $this->Texto_tag .= "<td>" . $this->namedoctor . "</td>\r\n";
   }
   ...
   function NM_export_speciality_idspeciality()
   {
         ...
         $this->look_speciality_idspeciality = str_replace('<', '&lt;', $this->look_speciality_idspeciality);
         $this->look_speciality_idspeciality = str_replace('>', '&gt;', $this->look_speciality_idspeciality);
         $this->Texto_tag .= "<td>" . $this->look_speciality_idspeciality . "</td>\r\n";
   }
   //----- day1
   function NM_export_day1()
   {
         ...
         $this->day1 = str_replace('<', '&lt;', $this->day1);
         $this->day1 = str_replace('>', '&gt;', $this->day1);
         $this->Texto_tag .= "<td>" . $this->day1 . "</td>\r\n";
   }
   //----- day2
   function NM_export_day2()
   {
         ...
         $this->day2 = str_replace('<', '&lt;', $this->day2);
         $this->day2 = str_replace('>', '&gt;', $this->day2);
         $this->Texto_tag .= "<td>" . $this->day2 . "</td>\r\n";
   }
   //----- day3
   function NM_export_day3()
   {
         ...
         $this->day3 = str_replace('<', '&lt;', $this->day3);
         $this->day3 = str_replace('>', '&gt;', $this->day3);
         $this->Texto_tag .= "<td>" . $this->day3 . "</td>\r\n";
   }
   //----- day4
   function NM_export_day4()
   {
         ...
         $this->day4 = str_replace('<', '&lt;', $this->day4);
         $this->day4 = str_replace('>', '&gt;', $this->day4);
         $this->Texto_tag .= "<td>" . $this->day4 . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_tbl_doctors'] ?> :: RTF</TITLE>
