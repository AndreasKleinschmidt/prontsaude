...
class grid_doctors_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_doctors_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_doctors_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_doctors_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_tbl_doctors'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_doctors/grid_doctors_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_doctors_ajax_search.js"></script>
 <script type="text/javascript" src="grid_doctors_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_doctors_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_doctors']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_doctors']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_namedoctor_cond#NMF#' + search_get_sel_txt('SC_namedoctor_cond') + '@NMF@';
  str_out += 'SC_namedoctor#NMF#' + search_get_Dselelect('SC_namedoctor_dest') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_tbl_doctors'] ?></div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $namedoctor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca']['namedoctor']; 
          $namedoctor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca']['namedoctor_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca']['NM_operador']; 
      } 
      if (!isset($namedoctor_cond) || empty($namedoctor_cond))
      {
         $namedoctor_cond = "qp";
      }
      ...
      $str_hide_namedoctor = (in_array($namedoctor_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      // namedoctor
      if (is_array($namedoctor) && !empty($namedoctor))
      {
         $tmp_array = array();
         $namedoctor_val_str = "";
         foreach ($namedoctor as $tmp_val_cmp)
         {
            if ("" != $namedoctor_val_str)
            {
               $namedoctor_val_str .= ",";
            }
            ...
            $namedoctor_val_str .= "'$tmp_val_cmp'";
         }
         $namedoctor = $tmp_array;
      }
      else
      {
         $namedoctor_val_str = "''";
      }
      if (!isset($namedoctor) || $namedoctor == "")
      {
          $namedoctor = array();
      }
?>
...
?>
<?php
   if (is_file("grid_doctors_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_doctors']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_doctors']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_namedoctor_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['namedoctor'])) ? $this->New_label['namedoctor'] : "" . $this->Ini->Nm_lang['lang_doctors_fld_namedoctor'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_namedoctor_cond" name="namedoctor_cond" onChange="nm_campos_between(document.getElementById('id_vis_namedoctor'), this, 'namedoctor')">
       <OPTION value="qp" <?php if ("qp" == $namedoctor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $namedoctor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_namedoctor" <?php echo $str_hide_namedoctor?> valign="top">
 ...
 $nmgp_tab_label .= "namedoctor?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      $namedoctor_look = (is_string($namedoctor) ? substr($this->Db->qstr($namedoctor), 1, -1) : $namedoctor); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT namedoctor, namedoctor  FROM doctors  ORDER BY namedoctor"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['psq_check_ret']['namedoctor'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['psq_check_ret']['namedoctor'][] = trim($rs->fields[0]);
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px; border-spacing: 0px;"><tr><td style='vertical-align: top;padding: 0px;'>
    <SELECT class="scFilterObjectOdd" id="SC_namedoctor_orig" name="namedoctor_orig" size=7 multiple onDblClick="nm_add_sel('namedoctor_orig', 'namedoctor_dest', 'N' , '')">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $namedoctor_sel = "";
               foreach ($namedoctor as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $namedoctor_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                       break;
                   }
               }
            }
            ...
            {
               $namedoctor_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $namedoctor_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('namedoctor_orig', 'namedoctor_dest', 'N', '');", "nm_add_all('namedoctor_orig', 'namedoctor_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('namedoctor_orig', 'namedoctor_dest', 'N', '');", "nm_add_sel('namedoctor_orig', 'namedoctor_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('namedoctor_dest', 'namedoctor_orig', 'N', '');", "nm_del_sel('namedoctor_dest', 'namedoctor_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('namedoctor_dest', 'namedoctor_orig', 'N', '');", "nm_del_all('namedoctor_dest', 'namedoctor_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td style='vertical-align: top;padding: 0px;'>
    <SELECT class="scFilterObjectOdd" id="SC_namedoctor_dest" name="namedoctor_dest" size=7 multiple  onDblClick="nm_del_sel('namedoctor_dest', 'namedoctor_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_namedoctor" name="namedoctor" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.namedoctor_dest.selectedIndex = -1;</script>
<?php
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
   nm_pack('namedoctor_dest', 'namedoctor');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   document.F1.namedoctor_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_namedoctor'), document.F1.namedoctor_cond, 'namedoctor');
   nm_del_all('namedoctor_dest', 'namedoctor_orig', 'N', '');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "ProntSaude/grid_doctors";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_namedoctor_cond'] = 'cond';
      $tp_fields['SC_namedoctor'] = 'dselect';
   ...
   {
      global $namedoctor_cond, $namedoctor, $nmgp_tab_label;
      ...
      $namedoctor_cond_salva = $namedoctor_cond; 
      if (!isset($namedoctor_input_2) || $namedoctor_input_2 == "")
      {
          $namedoctor_input_2 = $namedoctor;
      }
      if (is_array($namedoctor)) {
          foreach ($namedoctor as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['psq_check_ret']['namedoctor'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_doctors_fld_namedoctor'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca']['namedoctor'] = $namedoctor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca']['namedoctor_cond'] = $namedoctor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['namedoctor'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca']['namedoctor'];
      $this->cmp_formatado['namedoctor_input_2'] = $namedoctor_input_2;
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      $nm_aspas = "'";
      if ($namedoctor_cond == "nu" || $namedoctor_cond == "nn" || $namedoctor_cond == "ep" || $namedoctor_cond == "ne")
      {
          $namedoctor = array();
      }
      if (is_array($namedoctor) && count($namedoctor) != 0)
      {
         foreach ($namedoctor as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($namedoctor_cond == "df" || $namedoctor_cond == "np")
         {
             $this->comando        .= " namedoctor not in (";
             $this->comando_sum    .= " doctors.namedoctor not in (";
             $this->comando_filtro .= " namedoctor not in (";
         }
         else
         {
             $this->comando        .= " namedoctor in (";
             $this->comando_sum    .= " doctors.namedoctor in (";
             $this->comando_filtro .= " namedoctor in (";
         }
         $x                     = count($namedoctor);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr_final = isset($Lang_descr[$namedoctor_cond]) ? $Lang_descr[$namedoctor_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $nmgp_tab_label['namedoctor'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($namedoctor) && ($namedoctor_cond == "nu" || $namedoctor_cond == "nn" || $namedoctor_cond == "ep" || $namedoctor_cond == "ne"))
      {
         $this->monta_condicao("namedoctor", $namedoctor_cond, "", "", "namedoctor", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_doctors']['cond_pesq'] .= $this->NM_operador;
