<?php
@session_start() ;
$_SESSION['scriptcase']['grid_doctors']['sc_process_barr'] = true;
require_once('../grid_doctors/index.php');
unset($_SESSION['scriptcase']['grid_doctors']['sc_process_barr']);
$ExportCtrl = new grid_doctors_export_control;
$ExportCtrl->Export_barr();

class grid_doctors_export_control
{
