...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "iddoctor";$Nm_numeric[] = "speciality_idspeciality";$Nm_numeric[] = "node_order";$Nm_numeric[] = "treatments_idtreatments";$Nm_numeric[] = "iddoctor";$Nm_numeric[] = "speciality_idspeciality";$Nm_numeric[] = "node_order";$Nm_numeric[] = "treatments_idtreatments";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_namedoctor_cond" name="namedoctor_cond" onChange="nm_campos_between(document.getElementById('id_vis_namedoctor'), this, 'namedoctor')">
      ...
      <br><span id="id_hide_namedoctor"  <?php echo $str_hide_namedoctor?>>
<?php
...
?>
   <span id="idAjaxSelect_namedoctor">
      <SELECT class="scFilterObjectOdd" id="SC_namedoctor" name="namedoctor[]"  size="7" multiple>
<?php
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'namedoctor[]')
      {
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "namedoctor" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
