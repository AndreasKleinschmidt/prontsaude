...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_usrname_label" id="hidden_field_label_usrname" style="<?php echo $sStyleHidden_usrname; ?>"><span id="id_label_usrname"><?php echo $this->nm_new_label['usrname']; ?></span></TD>
    <TD class="scFormDataOdd css_usrname_line" id="hidden_field_data_usrname" style="<?php echo $sStyleHidden_usrname; ?>">
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_usractive_label" id="hidden_field_label_usractive" style="<?php echo $sStyleHidden_usractive; ?>"><span id="id_label_usractive"><?php echo $this->nm_new_label['usractive']; ?></span></TD>
    <TD class="scFormDataOdd css_usractive_line" id="hidden_field_data_usractive" style="<?php echo $sStyleHidden_usractive; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['Lookup_usractive'][] = 'Y'; ?>
