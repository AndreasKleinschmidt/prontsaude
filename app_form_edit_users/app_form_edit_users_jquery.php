...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["usrname" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  ...
  scEventControl_data["usractive" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["usrname" + iSeqRow] && scEventControl_data["usrname" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["usrname" + iSeqRow] && scEventControl_data["usrname" + iSeqRow]["change"]) {
    return true;
  }
  ...
  if (scEventControl_data["usractive" + iSeqRow] && scEventControl_data["usractive" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["usractive" + iSeqRow] && scEventControl_data["usractive" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_usrname' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_usrname_onblur('#id_sc_field_usrname' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_app_form_edit_users_usrname_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_app_form_edit_users_usrname_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_usractive' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_usractive_onblur('#id_sc_field_usractive' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_app_form_edit_users_usractive_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_app_form_edit_users_usractive_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_usrperfil' + iSeqRow).bind('change', function() { sc_app_form_edit_users_usrperfil_onchange(this, iSeqRow) });
  ...
  $('.sc-ui-checkbox-usractive' + iSeqRow).on('click', function() { scMarkFormAsChanged(); });
} // scJQEventsAdd
...
function sc_app_form_edit_users_usrname_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_usrname();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_usrname_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_usrname_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_app_form_edit_users_usractive_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_usractive();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_usractive_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_usractive_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_app_form_edit_users_usrperfil_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_block_0(status) {
        ...
        displayChange_field("usrname", "", status);
        ...
        displayChange_field("usractive", "", status);
}

function displayChange_row(row, status) {
        displayChange_field_login(row, status);
        displayChange_field_usrname(row, status);
        ...
        displayChange_field_usractive(row, status);
}
...
function displayChange_field_usrname(row, status) {
    var fieldId;
}
...
function displayChange_field_usractive(row, status) {
    var fieldId;
}
