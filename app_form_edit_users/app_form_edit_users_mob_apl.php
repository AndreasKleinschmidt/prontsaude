   ...
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_edit_users_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_edit_users_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_sec_users'] . "";
...
else
{
   ...
   $nmgp_def_dados = "" ; 
   $usractive_val_str = "''";
   if (!empty($this->usractive))
   {
       if (is_array($this->usractive))
       {
           $Tmp_array = $this->usractive;
       }
       else
       {
           $Tmp_array = explode(";", $this->usractive);
       }
       $usractive_val_str = "";
       foreach ($Tmp_array as $Tmp_val_cmp)
       {
          if ("" != $usractive_val_str)
          {
             $usractive_val_str .= ", ";
          }
          $usractive_val_str .= "'$Tmp_val_cmp'";
       }
   }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_usractive'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['usractive']['valList'][$i] = app_form_edit_users_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['scriptcase']['app_form_edit_users_mob']['contr_erro'] = 'off'; 
      ...
      if ('incluir' == $this->nmgp_opcao && empty($this->priv_admin)) {$this->priv_admin = "Y"; $NM_val_null[] = "priv_admin";}  
      if ('incluir' == $this->nmgp_opcao && empty($this->usrperfil)) {$this->usrperfil = "10"; $this->sc_force_zero[] = "usrperfil";}  
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "usrname = '$this->usrname', email = '$this->email', usractive = '$this->usractive'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
             ...
             { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('login', 'usrname', 'pswd', 'confirm_pswd', 'email', 'groups', 'usractive'), $aDoNotUpdate);
              $this->ajax_return_values();
