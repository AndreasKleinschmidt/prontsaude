  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_medical_history" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_medical_history_form();
        }
...
?>
  ...
  function do_ajax_form_medical_history_validate_history_datetime()
  {
    ...
    x_ajax_form_medical_history_validate_history_datetime(var_history_datetime, var_script_case_init, do_ajax_form_medical_history_validate_history_datetime_cb);
  } // do_ajax_form_medical_history_validate_history_datetime

  function do_ajax_form_medical_history_validate_history_datetime_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_validate_history_datetime_cb

  // ---------- Validate complaints
  function do_ajax_form_medical_history_validate_complaints()
  {
    var nomeCampo_complaints = "complaints";
    var var_complaints = scAjaxGetFieldText(nomeCampo_complaints);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_history_validate_complaints(var_complaints, var_script_case_init, do_ajax_form_medical_history_validate_complaints_cb);
  } // do_ajax_form_medical_history_validate_complaints

  function do_ajax_form_medical_history_validate_complaints_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_validate_complaints_cb

  // ---------- Validate diagnosis
  function do_ajax_form_medical_history_validate_diagnosis()
  {
    var nomeCampo_diagnosis = "diagnosis";
    var var_diagnosis = scAjaxGetFieldText(nomeCampo_diagnosis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_history_validate_diagnosis(var_diagnosis, var_script_case_init, do_ajax_form_medical_history_validate_diagnosis_cb);
  } // do_ajax_form_medical_history_validate_diagnosis

  function do_ajax_form_medical_history_validate_diagnosis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_validate_diagnosis_cb

  // ---------- Validate prescription
  function do_ajax_form_medical_history_validate_prescription()
  {
    var nomeCampo_prescription = "prescription";
    var var_prescription = scAjaxGetFieldText(nomeCampo_prescription);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_history_validate_prescription(var_prescription, var_script_case_init, do_ajax_form_medical_history_validate_prescription_cb);
  } // do_ajax_form_medical_history_validate_prescription

  function do_ajax_form_medical_history_validate_prescription_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_validate_prescription_cb

  // ---------- Validate tonursery
  function do_ajax_form_medical_history_validate_tonursery()
  {
    var nomeCampo_tonursery = "tonursery";
    var var_tonursery = scAjaxGetFieldCheckbox(nomeCampo_tonursery, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_history_validate_tonursery(var_tonursery, var_script_case_init, do_ajax_form_medical_history_validate_tonursery_cb);
  } // do_ajax_form_medical_history_validate_tonursery

  function do_ajax_form_medical_history_validate_tonursery_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_validate_tonursery_cb

  // ---------- Validate nursery_datetime
  function do_ajax_form_medical_history_validate_nursery_datetime()
  {
    var nomeCampo_nursery_datetime = "nursery_datetime";
    var var_nursery_datetime = scAjaxGetFieldText(nomeCampo_nursery_datetime);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_history_validate_nursery_datetime(var_nursery_datetime, var_script_case_init, do_ajax_form_medical_history_validate_nursery_datetime_cb);
  } // do_ajax_form_medical_history_validate_nursery_datetime

  function do_ajax_form_medical_history_validate_nursery_datetime_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_validate_nursery_datetime_cb

  // ---------- Validate next_status
  function do_ajax_form_medical_history_validate_next_status()
  {
    var nomeCampo_next_status = "next_status";
    var var_next_status = scAjaxGetFieldSelect(nomeCampo_next_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_history_validate_next_status(var_next_status, var_script_case_init, do_ajax_form_medical_history_validate_next_status_cb);
  } // do_ajax_form_medical_history_validate_next_status

  function do_ajax_form_medical_history_validate_next_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_validate_next_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_medical_history_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_medical_history_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_medical_history_submit_form(var_history_datetime, var_complaints, var_diagnosis, var_prescription, var_tonursery, var_nursery_datetime, var_next_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_medical_history_submit_form_cb);
  } // do_ajax_form_medical_history_submit_form

  function do_ajax_form_medical_history_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_medical_history_submit_form_cb_after_alert);
  } // do_ajax_form_medical_history_submit_form_cb
  function do_ajax_form_medical_history_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_medical_history_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_medical_history_navigate_form()
  {
    perform_ajax_form_medical_history_navigate_form();
  }

  function perform_ajax_form_medical_history_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_medical_history_navigate_form(var_idhistory, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_medical_history_navigate_form_cb);
  } // do_ajax_form_medical_history_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_medical_history']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_medical_history_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_medical_history_navigate_form_cb_after_alert);
  } // do_ajax_form_medical_history_navigate_form_cb
  function do_ajax_form_medical_history_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_medical_history_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_medical_history_navigate_form_cb_after_alert

  function sc_hide_form_medical_history_form()
  {
