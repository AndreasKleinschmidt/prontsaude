  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_medical_history_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_medical_history_mob_form();
        }
...
?>
  ...
  // ---------- Validate history_datetime
  function do_ajax_form_medical_history_mob_validate_history_datetime()
  {
    var nomeCampo_history_datetime = "history_datetime";
    var var_history_datetime = scAjaxGetFieldHidden(nomeCampo_history_datetime);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_history_mob_validate_history_datetime(var_history_datetime, var_script_case_init, do_ajax_form_medical_history_mob_validate_history_datetime_cb);
  } // do_ajax_form_medical_history_mob_validate_history_datetime

  function do_ajax_form_medical_history_mob_validate_history_datetime_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "history_datetime";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_mob_validate_history_datetime_cb

  // ---------- Validate complaints
  function do_ajax_form_medical_history_mob_validate_complaints()
  {
    var nomeCampo_complaints = "complaints";
    var var_complaints = scAjaxGetFieldText(nomeCampo_complaints);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_history_mob_validate_complaints(var_complaints, var_script_case_init, do_ajax_form_medical_history_mob_validate_complaints_cb);
  } // do_ajax_form_medical_history_mob_validate_complaints

  function do_ajax_form_medical_history_mob_validate_complaints_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "complaints";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_mob_validate_complaints_cb

  // ---------- Validate diagnosis
  function do_ajax_form_medical_history_mob_validate_diagnosis()
  {
    var nomeCampo_diagnosis = "diagnosis";
    var var_diagnosis = scAjaxGetFieldText(nomeCampo_diagnosis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_history_mob_validate_diagnosis(var_diagnosis, var_script_case_init, do_ajax_form_medical_history_mob_validate_diagnosis_cb);
  } // do_ajax_form_medical_history_mob_validate_diagnosis

  function do_ajax_form_medical_history_mob_validate_diagnosis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "diagnosis";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_mob_validate_diagnosis_cb

  // ---------- Validate prescription
  function do_ajax_form_medical_history_mob_validate_prescription()
  {
    var nomeCampo_prescription = "prescription";
    var var_prescription = scAjaxGetFieldText(nomeCampo_prescription);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_history_mob_validate_prescription(var_prescription, var_script_case_init, do_ajax_form_medical_history_mob_validate_prescription_cb);
  } // do_ajax_form_medical_history_mob_validate_prescription

  function do_ajax_form_medical_history_mob_validate_prescription_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prescription";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_mob_validate_prescription_cb

  // ---------- Validate tonursery
  function do_ajax_form_medical_history_mob_validate_tonursery()
  {
    var nomeCampo_tonursery = "tonursery";
    var var_tonursery = scAjaxGetFieldCheckbox(nomeCampo_tonursery, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_history_mob_validate_tonursery(var_tonursery, var_script_case_init, do_ajax_form_medical_history_mob_validate_tonursery_cb);
  } // do_ajax_form_medical_history_mob_validate_tonursery

  function do_ajax_form_medical_history_mob_validate_tonursery_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tonursery";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_mob_validate_tonursery_cb

  // ---------- Validate nursery_datetime
  function do_ajax_form_medical_history_mob_validate_nursery_datetime()
  {
    var nomeCampo_nursery_datetime = "nursery_datetime";
    var var_nursery_datetime = scAjaxGetFieldText(nomeCampo_nursery_datetime);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_history_mob_validate_nursery_datetime(var_nursery_datetime, var_script_case_init, do_ajax_form_medical_history_mob_validate_nursery_datetime_cb);
  } // do_ajax_form_medical_history_mob_validate_nursery_datetime

  function do_ajax_form_medical_history_mob_validate_nursery_datetime_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nursery_datetime";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_mob_validate_nursery_datetime_cb

  // ---------- Validate next_status
  function do_ajax_form_medical_history_mob_validate_next_status()
  {
    var nomeCampo_next_status = "next_status";
    var var_next_status = scAjaxGetFieldSelect(nomeCampo_next_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_history_mob_validate_next_status(var_next_status, var_script_case_init, do_ajax_form_medical_history_mob_validate_next_status_cb);
  } // do_ajax_form_medical_history_mob_validate_next_status

  function do_ajax_form_medical_history_mob_validate_next_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "next_status";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_history_mob_validate_next_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_medical_history_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_medical_history_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_history_datetime = scAjaxGetFieldHidden("history_datetime");
    var var_complaints = scAjaxGetFieldText("complaints");
    var var_diagnosis = scAjaxGetFieldText("diagnosis");
    var var_prescription = scAjaxGetFieldText("prescription");
    var var_tonursery = scAjaxGetFieldCheckbox("tonursery", ";");
    var var_nursery_datetime = scAjaxGetFieldText("nursery_datetime");
    var var_next_status = scAjaxGetFieldSelect("next_status");
    var var_idhistory = scAjaxGetFieldText("idhistory");
    ...
    scAjaxProcOn();
    x_ajax_form_medical_history_mob_submit_form(var_history_datetime, var_complaints, var_diagnosis, var_prescription, var_tonursery, var_nursery_datetime, var_next_status, var_idhistory, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_medical_history_mob_submit_form_cb);
  } // do_ajax_form_medical_history_mob_submit_form

  function do_ajax_form_medical_history_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_medical_history_mob_submit_form_cb_after_alert);
  } // do_ajax_form_medical_history_mob_submit_form_cb
  function do_ajax_form_medical_history_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_medical_history_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_medical_history_mob_navigate_form()
  {
    perform_ajax_form_medical_history_mob_navigate_form();
  }

  function perform_ajax_form_medical_history_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_idhistory = document.F2.idhistory.value;
    ...
    scAjaxProcOn();
    x_ajax_form_medical_history_mob_navigate_form(var_idhistory, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_medical_history_mob_navigate_form_cb);
  } // do_ajax_form_medical_history_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_medical_history_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_medical_history_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.idhistory.value = scAjaxGetKeyValue("idhistory");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_medical_history_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_medical_history_mob_navigate_form_cb
  function do_ajax_form_medical_history_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_medical_history_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_medical_history_mob_navigate_form_cb_after_alert

  function sc_hide_form_medical_history_mob_form()
  {
  ...
  ajax_field_list[0] = "history_datetime";
  ajax_field_list[1] = "complaints";
  ajax_field_list[2] = "diagnosis";
  ajax_field_list[3] = "prescription";
  ajax_field_list[4] = "tonursery";
  ajax_field_list[5] = "nursery_datetime";
  ajax_field_list[6] = "next_status";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "history_datetime": {"label": "<?php echo $this->Ini->Nm_lang['lang_medical_history_fld_history_datetime'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "complaints": {"label": "<?php echo $this->Ini->Nm_lang['lang_medical_history_fld_complaints'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "diagnosis": {"label": "<?php echo $this->Ini->Nm_lang['lang_medical_history_fld_diagnosis'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "prescription": {"label": "<?php echo $this->Ini->Nm_lang['lang_medical_history_fld_prescription'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "tonursery": {"label": "<?php echo $this->Ini->Nm_lang['lang_medical_history_fld_tonursery'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "nursery_datetime": {"label": "<?php echo $this->Ini->Nm_lang['lang_medical_history_fld_nursery_datetime'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "next_status": {"label": "<?php echo $this->Ini->Nm_lang['lang_next_status'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "history_datetime": new Array(),
    "complaints": new Array(),
    "diagnosis": new Array(),
    "prescription": new Array(),
    "tonursery": new Array(),
    "nursery_datetime": new Array(),
    "next_status": new Array()
  };
  ajax_field_mult["history_datetime"][1] = "history_datetime";
  ajax_field_mult["complaints"][1] = "complaints";
  ajax_field_mult["diagnosis"][1] = "diagnosis";
  ajax_field_mult["prescription"][1] = "prescription";
  ajax_field_mult["tonursery"][1] = "tonursery";
  ajax_field_mult["nursery_datetime"][1] = "nursery_datetime";
  ajax_field_mult["next_status"][1] = "next_status";

  var ajax_field_id = {
    "history_datetime": new Array("hidden_field_label_history_datetime", "hidden_field_data_history_datetime"),
    "complaints": new Array("hidden_field_label_complaints", "hidden_field_data_complaints"),
    "diagnosis": new Array("hidden_field_label_diagnosis", "hidden_field_data_diagnosis"),
    "prescription": new Array("hidden_field_label_prescription", "hidden_field_data_prescription"),
    "tonursery": new Array("hidden_field_label_tonursery", "hidden_field_data_tonursery"),
    "nursery_datetime": new Array("hidden_field_label_nursery_datetime", "hidden_field_data_nursery_datetime"),
    "next_status": new Array("hidden_field_label_next_status", "hidden_field_data_next_status")
  };

  var ajax_read_only = {
    "history_datetime": "off",
    "complaints": "off",
    "diagnosis": "off",
    "prescription": "off",
    "tonursery": "off",
    "nursery_datetime": "off",
    "next_status": "off"
  };
