<?php
@session_start() ;
$_SESSION['scriptcase']['grid_events_patiente']['sc_process_barr'] = true;
require_once('../grid_events_patiente/index.php');
unset($_SESSION['scriptcase']['grid_events_patiente']['sc_process_barr']);
$ExportCtrl = new grid_events_patiente_export_control;
$ExportCtrl->Export_barr();

class grid_events_patiente_export_control
{
