...
<?php
   ...
   $Ord_Cmp = new grid_events_patiente_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_events_patiente_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idevent_status'] = "idevent_status";
   $tab_labels["idevent_status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['labels']["idevent_status"])) ? $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['labels']["idevent_status"] : "" . $this->Nm_lang['lang_event_fld_idevent_status'] . "";
   $tab_ger_campos['start_date'] = "on";
   $tab_def_campos['start_date'] = "start_date";
   $tab_labels["start_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['labels']["start_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['labels']["start_date"] : "" . $this->Nm_lang['lang_event_fld_start_date'] . "";
   $tab_ger_campos['start_time'] = "on";
   $tab_def_campos['start_time'] = "start_time";
   $tab_labels["start_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['labels']["start_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['labels']["start_time"] : "" . $this->Nm_lang['lang_event_fld_start_time'] . "";
   $tab_ger_campos['doctor_iddoctor'] = "on";
   $tab_def_campos['doctor_iddoctor'] = "doctor_iddoctor";
   $tab_labels["doctor_iddoctor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['labels']["doctor_iddoctor"])) ? $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['labels']["doctor_iddoctor"] : "" . $this->Nm_lang['lang_event_fld_doctor_iddoctor'] . "";
   $tab_ger_campos['categ'] = "on";
   $tab_def_campos['categ'] = "categ";
   $tab_labels["categ"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['labels']["categ"])) ? $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['labels']["categ"] : "" . $this->Nm_lang['lang_event_fld_categ'] . "";
   $tab_ger_campos['bt_add'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bt_add'] = "bt_add";
   }
   else
   {
       $tab_def_campos['bt_add'] = "";
   }
   $tab_labels["bt_add"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['labels']["bt_add"])) ? $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['labels']["bt_add"] : "";
   $tab_ger_campos['bt_add'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_events_patiente_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_events_patiente']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
