...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["ProntSaude_____grid_events_patiente"]))
   {
      unset($_SESSION['session_sec_aplicacao']["ProntSaude_____grid_events_patiente"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_events_patiente']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_events_patiente']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_events_patiente']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_events_patiente']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_events_patiente']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_events_patiente</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_events_patiente']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_events_patiente']['embutida_filho'] as $ind => $sc_init)
          {
