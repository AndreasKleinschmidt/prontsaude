...
class grid_events_patiente_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_events_patiente/grid_events_patiente_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_events_patiente_res_xls.class.php");
              $this->Res_xls = new grid_events_patiente_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_events_patiente.zip";
          $this->Arquivo   .= "_grid_events_patiente" . $this->Xls_tp;
          $this->Tit_doc    = "grid_events_patiente" . $this->Xls_tp;
          $this->Tit_zip    = "grid_events_patiente.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['grid_events_patiente']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['medical_history'])) ? $this->New_label['medical_history'] : "medical_history"; 
          if ((!isset($this->NM_cmp_hidden['medical_history']) || $this->NM_cmp_hidden['medical_history'] != "off") && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->arr_span['medical_history'] = $this->count_span;
              $this->Emb_label_cols_medical_history = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medical_history']['embutida'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medical_history']['embutida_label'] = true;
                  ...
                  if (isset($_SESSION['scriptcase']['export_return']))
                  {
                     foreach ($_SESSION['scriptcase']['export_return']['label'] as $col => $dados)
                     {
                         if (isset($dados['col_span_i'])) {
                             $this->Emb_label_cols_medical_history += $dados['col_span_i'];
                         }
                         elseif (isset($dados['col_span_f'])) {
                             $this->Emb_label_cols_medical_history += $dados['col_span_f'];
                         }
                         else {
                             $this->Emb_label_cols_medical_history++;
                         }
                     }
                  }
              }
      ...
      { 
          ...
          {
              while ($this->count_span < $this->Emb_label_cols_medical_history)
              {
   ...
   function NM_export_idevent_status()
   {
         ...
         if (is_numeric($this->look_idevent_status))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_idevent_status);
         $this->Xls_col++;
   }
   //----- start_date
   ...
   function NM_export_categ()
   {
         ...
         if (is_numeric($this->look_categ))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_categ);
         $this->Xls_col++;
   }
   //----- bt_add
   function NM_export_bt_add()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->bt_add, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->bt_add, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- idevent
   function NM_export_idevent()
   {
         ...
         if (is_numeric($this->idevent))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->idevent);
         $this->Xls_col++;
   }
   //----- title
   ...
   //----- idevent_status
   function NM_sub_cons_idevent_status()
   {
         $this->look_idevent_status = NM_charset_to_utf8($this->look_idevent_status);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_idevent_status;
   ...
   //----- categ
   function NM_sub_cons_categ()
   {
         $this->look_categ = NM_charset_to_utf8($this->look_categ);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_categ;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- medical_history
   function NM_sub_cons_medical_history()
   {
         $this->Rows_sub_medical_history = array();
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?var_patiente?#?" . str_replace("'", "@aspass@", $this->Orig_patients_idpatient) . "?@?var_event?#?" . str_replace("'", "@aspass@", $this->Orig_idevent) . "?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medical_history']['embutida'] = true;
         if (method_exists($this->grid_medical_history, "controle"))
         {
             $this->grid_medical_history->controle();
             ...
             {
                 $this->row_sub = 1;
             $this->Rows_sub_medical_history = $_SESSION['scriptcase']['export_return'];
             return;
             }
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medical_history']['embutida'] = false;
   ...
   //----- bt_add
   function NM_sub_cons_bt_add()
   {
         $this->bt_add = NM_charset_to_utf8($this->bt_add);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->bt_add;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- idevent
   function NM_sub_cons_idevent()
   {
         $this->idevent = NM_charset_to_utf8($this->idevent);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->idevent;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - event :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_events_patiente']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
